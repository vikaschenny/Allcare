...
//var url = a.split("?");
//var gurl = url[0]+"?url=Sencha.pdf";


//var DEFAULT_URL = 'Regular.pdf';
var DEFAULT_URL = gUrl;
...
function getFileName(url) {
  //alert('url of the file: '+url);
  /**if the file url contains jpeg, jpg, png, or any image file format
   * do not proceed to open the file
  */
