                                                ...
                                                <table>
                                                    <tr><td> <span class='bold'><?php echo htmlspecialchars( xl('Patient Name'), ENT_NOQUOTES); ?>:</span>
                                                            <?php
                                                                ...
                                                                echo "   <select name='form_patient'   id='form_patient' onchange='javascript:this.form.submit();'>\n";
...
//                                                                echo  "selected"; echo" >-- " . xl('Select') . " --\n";
                                            ...
                                            function auto_submit(){
                                                var pid='<?php echo $_REQUEST['form_patient']; ?>';
                                                var form_patient='';
                                                if(pid!=''){
                                                      form_patient =pid;
                                                }else {
                                                     form_patient =jQuery('#form_patient').val();
                                                }
                                               
                                                 
//                                                       $("#uca").load("chartoutput/add_chartoutput.php?form_patient="+form_patient+ "&provider=" +'<?php echo $provider; ?>'+"&group=" +'<?php echo $grp; ?>' ,function(){ 
                                                        $.ajax({
                                                        type: 'POST',
                                                        url: "chartoutput/add_chartoutput.php",	
                                                        data:{form_patient:form_patient,provider:'<?php echo $provider; ?>',group:'<?php echo $grp; ?>',refer:'<?php echo $refer; ?>'},
