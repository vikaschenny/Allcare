                                    ...
                                    <div id="contents">
                                        <div id="sidenave" class="col-sm-3">                                           
                                            <ul class="nav nav-list bs-docs-sidenav affix">
                                                ...
                                                <li class=""><a  href='javascript:;' onclick=DoPost_patient('<?php echo $base_url ?>patient_data.php?order=<?php echo $order; ?>&provider=<?php echo $provider; ?>&id=my_patients')>My Patients</a></li>
