<section class= "navs">
  <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div style="background-color:#e7e7e7 !important; height:39px; padding-top:4px; padding-right:20px;"><div style="float:right !important;" ><?php echo $id['fname']." ".$id['lname']; echo "&nbsp;&nbsp;" ?><a  class="btn btn-default btn-sm" data-toggle="modal" data-target="#logout" style="color:black; "><span class="glyphicon glyphicon-lock"></span>  Logout</a></div></div>
                                                ...
                                                while($row_lis=sqlFetchArray($sql_lis)){
                                                    if(in_array($row_lis['option_id'], $avail3)){
                                                     ...
                                                     if(sqlNumRows($sql_li) != 0 ){ ?>
                                                         <li class="dropdown <?php if($row11['option_id']==$pagename){ ?>active <?php }else{ ?>underline<?php } ?>"><a class="dropdown-toggle" data-toggle="dropdown" href="javascript:DoPost('<?php echo $base_url3."/providers/".$row_lis['notes']; ?>','<?php echo $provider;  ?>')"><?php echo $row_lis['title']; ?> <b class="caret"></b></a>
                                                                  ...
                                                                  $ex=explode("_",$row_li['option_id']); 
                                                                    if(count($ex)==2){
                                                                       ...
                                                                       $row_sub=sqlFetchArray($sql_sub); ?>
                                                                         <li><a href="javascript:DoPost('<?php echo $base_url3."/providers/".$row_sub['notes']; ?>','<?php echo $provider;  ?>')"><span><?php  echo $row_sub['title']; ?></span></a> 
                                                                                   </li>    
                                                                <?php }
                                                                  }  } ?>
                                                        </ul></li>
                                                    <?php }else{
                                                          if($row11['option_id']==$pagename){?>
                                                              <li class="active"><a href="javascript:DoPost('<?php echo $base_url3."/providers/".$row11['notes']; ?>','<?php echo $provider;  ?>')"><span><?php echo $row11['title']; ?></span></a></li>
                                                    <?php   }else { ?>
                                                              <li class="underline"><a href="javascript:DoPost('<?php echo $base_url3."/providers/".$row11['notes']; ?>','<?php echo $provider;  ?>')"><span><?php echo $row11['title']; ?></span></a></li>
                                                   <?php   }
        ...
        <div class="modal fade" id="logout" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-sm">
              <div class="modal-content">
                ...
                <div class="modal-footer"><a href="<?php echo $base_url3; ?>/providers/logout_page.php" class="btn btn-primary btn-block" >Logout</a><a href="javascript:void" class="btn btn-primary btn-block" data-dismiss="modal">Cancel</a></div>
              </div>
            </div>
         </div>
