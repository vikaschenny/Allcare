...
#menu ul li.active > a {
  ...
  color: #000000;
/*  background-color: rgba(76, 214, 245, 0.62);
  border-top:6px ridge rgb(5, 207, 252);*/
...
//           function DoPost1(page_name,provider){
//                var facilities=jQuery('#provider').val(); 
//                alert(facilities);
//               alert(page_name+"====="+provider);
////              $.post(page_name, { provider: provider } );  //Your values here..
////              $.post( page_name, { provider: provider })
////              .done(function( data ) {
...
////                     window.location = '../providers/'+page_name+'?provider='+provider;
//                       alert(response);
//                    }
//                 });
//           }
...
//                     }
        ...
        /*example  for muliple parameters
          DoPost('url', {name: 'Johnny Bravo'});*/
        </script>       
	</head>
                                             ...
                                             if(false == $pos) {
                                                ...
                                                while($row_lis=sqlFetchArray($sql_lis)){
                                                     ...
                                                     if(sqlNumRows($sql_li) != 0 ){ ?>
                                                         <li><a href="javascript:DoPost('<?php echo $row_lis['notes']; ?>','<?php echo $provider;  ?>')"><span><?php echo $row_lis['title']; ?></span></a>
                                                         <ul>
