               ...
               function DoPost(page_name, provider) {
                ...
                $(function(){
                    $( ".row > #readmore" ).click(function() {
                        var visibleitem = $(this).parents('.day-event').children('.appointment:visible').length
                        var nonevisibleitem = $(this).parents('.day-event').children('.appointment:not(:visible)').length
                        if(nonevisibleitem <=3){$(this).children('a').addClass("disabled")};
                        $(this).parents('.day-event').children('.appointment:not(:visible)').each(function(index){
                            if(index<3){
                                $(this).show();
                                $(this).next().show();
                            }
                   ...
                   $('.day-event').each(function(){
                       ...
                       if($(this).children('.appointment').length <= 3){
                           $(this).children('.row').hide();
                       }else{
                           $(this).children('.appointment').hide()
                           $(this).children('.appointment').next().hide();
                           $(this).children('.appointment').each(function(index,elm){
                               if(index<3){
                                   $(this).show();
                                   $(this).next().show();
                               }
                    ...
                    <div class="row">
                     <div class= "col-lg-4 col-sm-6 col-xs-12">
                        <div class="calendar hidden-print">
                          <header style="width:300px!important">
                            <h4 class="month"></h4>
                          ...
                          <table style="width:280px !important; margin-left:33px !important;">
                                 ...
                                 $sql_apppatients3=sqlStatement("SELECT visit_categories FROM tbl_allcare_facuservisit WHERE  `users`  REGEXP ('".":\"".$id."\"')");
                                  ...
                                  $sql12=sqlStatement("SELECT ope.*
                                   ...
                                   while($row_app3=sqlFetchArray($sql12)){
                                           ...
                                           <p><?php $sql_pdata=sqlStatement("SELECT  ope.*,pc_startTime,p.fname,p.lname ,lo.title
                                            ...
                                            while($row=sqlFetchArray($sql_pdata)){
                                                $eid=$row['pc_eid'];
                                                 ...
                                                 echo "<div class='appointment' style='border: 2px solid #cbd1d2;'>";
                                           ...
                                           <div class="row">
                                                <div class="text-center" id="readmore">
