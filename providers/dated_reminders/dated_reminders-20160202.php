         ...
         $(document).ready(function (){ 
           ...
           function openAddScreen(id){
             if(id == 0){
               ...
               window.open('<?php echo $GLOBALS['webroot']; ?>/providers/dated_reminders/dated_reminders_add.php', '_drAdd', 700, 500);
             }else{
               
               window.open('<?php echo $GLOBALS['webroot']; ?>/providers/dated_reminders/dated_reminders_add.php?mID='+id, '_drAdd', 700, 500);
             }
           }
           ...
           function updateme(id){ 
             ...
             $.post("<?php echo $GLOBALS['webroot']; ?>/providers/dated_reminders/dated_reminders.php",
            ...
            function openLogScreen(){
               ...
               window.open('<?php echo $GLOBALS['webroot']; ?>/providers/dated_reminders/dated_reminders_log.php', '_drLog', 700, 500);
            }
...
//             
//              <?php 
                //echo "<a class='various' data-fancybox-type='iframe' href='providers_patient_edit.php?set_pid=pid&provider=$provider'></a>";
              ?>//
//}
      </script>
