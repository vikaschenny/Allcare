...
//                                                            htmlspecialchars( xl($title1), ENT_NOQUOTES)."</span></a>,";
                                                  $fname.="<a href='javascript:;' onclick=win1('../interface/reports/allcare_enc_forms.php?groupname=$gname&form_id1=$resid1&enc3=$resenc1&pid1=$respid1&inmode1=edit&file_name1=Incomplete_charts&provider=$provider&location=provider_portal&fname1=$resfname3') ><span>".htmlspecialchars( xl($title1), ENT_NOQUOTES)."</span></a>,";
                                               }else {
...
//                                                          'onclick='top.restoreSession()' ><span>".
//                                                            htmlspecialchars( xl($title1), ENT_NOQUOTES)."</span></a>,";
                                                   $fname_comp.="<a href='javascript:;' onclick=win1('../interface/reports/allcare_enc_forms.php?groupname=$gname&form_id1=$resid1&enc3=$resenc1&pid1=$respid1&inmode1=edit&file_name1=Incomplete_charts&provider=$provider&location=provider_portal&fname1=$resfname3') ><span>".htmlspecialchars( xl($title1), ENT_NOQUOTES)."</span></a>,";
                                               }
...
//                                                          'onclick='top.restoreSession()' ><span>".
//                                                            htmlspecialchars( xl($title1), ENT_NOQUOTES)."</span></a>,";
                                                     $fname_opt.="<a href='javascript:;' onclick=win1('../interface/reports/allcare_enc_forms.php?groupname=$gname&form_id1=$resid1&enc3=$resenc1&pid1=$respid1&inmode1=edit&file_name1=Incomplete_charts&provider=$provider&location=provider_portal&fname1=$resfname3') ><span>".htmlspecialchars( xl($title1), ENT_NOQUOTES)."</span></a>,";                                        
                                               }else {
//                                                   $fname_opt.="<a href='../interface/reports/allcare_enc_forms.php?groupname=$gname&form_id1=".$resid1."&enc3=".$resenc1."&pid1=".$respid1."&inmode1=edit&file_name1=Incomplete_charts&fname1=".$resfname1."
//                                                          'onclick='top.restoreSession()' ><span>".
//                                                            htmlspecialchars( xl($title1), ENT_NOQUOTES)."</span></a>,";
...
//                                                          'onclick='top.restoreSession()' ><span>".
//                                                            htmlspecialchars( xl($title1), ENT_NOQUOTES)."</span></a>,";
                                                 $fname.="<a href='javascript:;' onclick=win1('../interface/reports/allcare_enc_forms.php?groupname=$gname&enc3=$resenc1&pid1=$respid1&inmode1=edit&file_name1=Incomplete_charts&fname1=$resfname2&form_id1=0&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl($title1), ENT_NOQUOTES)."</span></a>,";
                                            } else if($priority=='Optional'){
...
//                                                            htmlspecialchars( xl($title1), ENT_NOQUOTES)."</span></a>,";
                                                 ...
                                                 $fname_opt.="<a href='javascript:;' onclick=win1('../interface/reports/allcare_enc_forms.php?groupname=$gname&enc3=$resenc1&pid1=$respid1&inmode1=edit&file_name1=Incomplete_charts&fname1=$resfname2&provider=$provider&location=provider_portal&form_id1=0')><span>".htmlspecialchars( xl($title1), ENT_NOQUOTES)."</span></a>,";
                                            } 
                                        }
                                  }
                                       if($field_id=='ros'){
...
//                                                                htmlspecialchars( xl('Allcare Ros'), ENT_NOQUOTES)."</span></a>,";
                                                 ...
                                                 $fname.="<a href='javascript:;' onclick=win1('../interface/forms/allcare_ros/new_custom.php?formname=allcare_ros&encounter=$resenc1&pid=$respid1&location=provider_portal&provider=$provider') ><span>".htmlspecialchars( xl('Allcare Ros'), ENT_NOQUOTES)."</span></a>,";
                                                } else {
...
//                                                                htmlspecialchars( xl('Allcare Ros'), ENT_NOQUOTES)."</span></a>,";
                                                     ...
                                                     $fname_comp.="<a href='javascript:;' onclick=win1('../interface/forms/allcare_ros/view_custom.php?formname=allcare_ros&encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&provider=$provider') ><span>".htmlspecialchars( xl('Allcare Ros'), ENT_NOQUOTES)."</span></a>,";
                                                }
                                             }else if($priority=='Optional'){
                                                 if($ros=='NO'){
                                                 //$fname='<a href="/interface/reports/form_load.php?formname=allcare_ros&edit=custom">Allcare_ros</a>'.",";
...
//                                                                htmlspecialchars( xl('Allcare Ros'), ENT_NOQUOTES)."</span></a>,";
                                                 ...
                                                 $fname_opt.="<a href='javascript:;' onclick=win1('../interface/forms/allcare_ros/new_custom.php?formname=allcare_ros&encounter=$resenc1&pid=$respid1&location=provider_portal&provider=$provider') ><span>".htmlspecialchars( xl('Allcare Ros'), ENT_NOQUOTES)."</span></a>,";
                                                } else {
...
//                                                               ><span>".
//                                                                htmlspecialchars( xl('Allcare Ros'), ENT_NOQUOTES)."</span></a>,";
                                                     $fname_opt.="<a href='javascript:;' onclick=win1('../interface/forms/allcare_ros/view_custom.php?formname=allcare_ros&encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&provider=$provider') ><span>".htmlspecialchars( xl('Allcare Ros'), ENT_NOQUOTES)."</span></a>,";
                                                }
                                             }  
...
//                                                                    htmlspecialchars( xl('Allcare Physical_exam'), ENT_NOQUOTES)."</span></a>,";
                ...
                //                                     $fname.= "<a href='javascript:win1('/interface/patient_file/encounter/load_form.php?formname=allcare_physical_exam&edit=custom_pe');' onmouseover='self.status='Open A Window'; return true;'>Chief Complaint</a>".",";
                                                     ...
                                                     $fname.="<a href='javascript:;' onclick=win1('../interface/forms/allcare_physical_exam/new_custom.php?formname=allcare_physical_exam&edit=custom_pe&encounter=$resenc1&pid=$respid1&location=provider_portal&provider=$provider&menu_val=$menu') ><span>".htmlspecialchars( xl('Allcare Physical_exam'), ENT_NOQUOTES)."</span></a>,";
...
//                                                                   ><span>".
//                                                                    htmlspecialchars( xl('Allcare Physical_exam'), ENT_NOQUOTES)."</span></a>,";
                                                     $fname_comp.="<a href='javascript:;' onclick=win1('../interface/forms/allcare_physical_exam/new_custom.php?formname=allcare_physical_exam&edit=custom_pe&encounter=$resenc1&pid=$respid1&id=$fid&location=provider_portal&provider=$provider&menu_val=$menu') ><span>".htmlspecialchars( xl('Allcare Physical_exam'), ENT_NOQUOTES)."</span></a>,";
                                                }
                                            }else if($priority=='Optional'){
                                                 if($pe=='NO'){
...
//                                                                   ><span>".
//                                                                    htmlspecialchars( xl('Allcare Physical_exam'), ENT_NOQUOTES)."</span></a>,";
                                                     $fname_opt.="<a href='javascript:;' onclick=win1('../interface/forms/allcare_physical_exam/new_custom.php?formname=allcare_physical_exam&edit=custom_pe&encounter=$resenc1&pid=$respid1&location=provider_portal&provider=$provider&menu_val=$menu') ><span>".htmlspecialchars( xl('Allcare Physical_exam'), ENT_NOQUOTES)."</span></a>,";
                                                }else {
...
//                                                                   ><span>".
//                                                                    htmlspecialchars( xl('Allcare Physical_exam'), ENT_NOQUOTES)."</span></a>,";
                                                    $fname_opt.="<a href='javascript:;' onclick=win1('../interface/forms/allcare_physical_exam/new_custom.php?formname=allcare_physical_exam&edit=custom_pe&encounter=$resenc1&pid=$respid1&id=$fid&location=provider_portal&provider=$provider&menu_val=$menu') ><span>".htmlspecialchars( xl('Allcare Physical_exam'), ENT_NOQUOTES)."</span></a>,";
                                                }
                                            }
                                        }
                                     //vitals 
                                          ...
                                          $resid_vt=sqlStatement("select *  from forms where form_name  ='Vitals' AND encounter=$resenc1 AND pid=$respid1  AND deleted=0 ORDER BY id DESC");  
                                             ...
                                             if($priority=='Required'){ 
                                                if($fid1==''){
//                                                     $fname.="<a href='../interface/forms/vitals/new_custom.php?formname=Vitals&encounter=$resenc1&pid=$respid1&provider=$provider&location=provider_portal'
//                                                                   ><span>".
//                                                                    htmlspecialchars( xl('Vitals'), ENT_NOQUOTES)."</span></a>,";
                                                      $fname.="<a href='javascript:;' onclick=win1('../interface/forms/vitals/new_custom.php?formname=Vitals&encounter=$resenc1&pid=$respid1&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl('Vitals'), ENT_NOQUOTES)."</span></a>,";
                                                     
                                                }else {
//                                                    $fname_comp.="<a href='../interface/forms/vitals/view_custom.php?formname=Vitals&encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal'
//                                                                   ><span>".
//                                                                    htmlspecialchars( xl('Vitals'), ENT_NOQUOTES)."</span></a>,";
                                                    
                                                    $fname_comp.="<a href='javascript:;' onclick=win1('../interface/forms/vitals/view_custom.php?formname=Vitals&encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl('Vitals'), ENT_NOQUOTES)."</span></a>,";
                                                }
                                            }else if($priority=='Optional'){
                                                 if($fid1==''){
//                                                     $fname_opt.="<a href='../interface/forms/vitals/new_custom.php?formname=Vitals&encounter=$resenc1&pid=$respid1&provider=$provider&location=provider_portal'
//                                                                   ><span>".
//                                                                    htmlspecialchars( xl('Vitals'), ENT_NOQUOTES)."</span></a>,";
                                                      $fname_opt.="<a href='javascript:;' onclick=win1('../interface/forms/vitals/new_custom.php?formname=Vitals&encounter=$resenc1&pid=$respid1&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl('Vitals'), ENT_NOQUOTES)."</span></a>,";
                                                     
                                                }else {
//                                                    $fname_opt.="<a href='../interface/forms/vitals/view_custom.php?formname=Vitals&encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal'
//                                                                   ><span>".
//                                                                    htmlspecialchars( xl('Vitals'), ENT_NOQUOTES)."</span></a>,";
                                                     $fname_opt.="<a href='javascript:;' onclick=win1('../interface/forms/vitals/view_custom.php?formname=Vitals&encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl('Vitals'), ENT_NOQUOTES)."</span></a>,";
                                                }
                                            }
                                      } 
                                       //issues
...
//                                                                    htmlspecialchars( xl($title), ENT_NOQUOTES)."</span></a>,";
                                                      $fname_comp.="<a href='javascript:;' onclick=win1('../interface/patient_file/summary/stats_full_custom.php?active=all&category=$type&encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&provider=$provider') ><span>".htmlspecialchars( xl($title), ENT_NOQUOTES)."</span></a>,";
...
//                                                                   ><span>".
//                                                                    htmlspecialchars( xl($title), ENT_NOQUOTES)."</span></a>,";
                                                     $fname.="<a href='javascript:;' onclick=win1('../interface/patient_file/summary/stats_full_custom.php?active=all&category=$type&encounter=$resenc1&pid=$respid1&location=provider_portal&provider=$provider') ><span>".htmlspecialchars( xl($title), ENT_NOQUOTES)."</span></a>,";
                                                }
                                            }else if($priority=='Optional'){
                                                 if(!empty($frow_med)){
...
//                                                                   ><span>".
//                                                                    htmlspecialchars( xl($title), ENT_NOQUOTES)."</span></a>,";
                                                      $fname_opt.="<a href='javascript:;' onclick=win1('../interface/patient_file/summary/stats_full_custom.php?active=all&category=$type&encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&provider=$provider') ><span>".htmlspecialchars( xl($title), ENT_NOQUOTES)."</span></a>,"; 
                                                }else {
...
//                                                                   ><span>".
//                                                                    htmlspecialchars( xl($title), ENT_NOQUOTES)."</span></a>,";
                                                     $fname_opt.="<a href='javascript:;' onclick=win1('../interface/patient_file/summary/stats_full_custom.php?active=all&category=$type&encounter=$resenc1&pid=$respid1&location=provider_portal&provider=$provider') ><span>".htmlspecialchars( xl($title), ENT_NOQUOTES)."</span></a>,";
                                                }
                                            }
                                      }
                                      //Immunizations
...
//                                                                    htmlspecialchars( xl('Immunizations'), ENT_NOQUOTES)."</span></a>,";
                                                     $fname_comp.="<a href='javascript:;' onclick=win1('../interface/patient_file/summary/immunizations_custom.php?pid=$respid1&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl('Immunizations'), ENT_NOQUOTES)."</span></a>,";
                                                 }else {
//                                                    $fname.="<a href='../interface/patient_file/summary/immunizations_custom.php?pid=$respid1'
//                                                                   ><span>".
//                                                                    htmlspecialchars( xl('Immunizations'), ENT_NOQUOTES)."</span></a>,";
                                                    $fname.="<a href='javascript:;' onclick=win1('../interface/patient_file/summary/immunizations_custom.php?pid=$respid1&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl('Immunizations'), ENT_NOQUOTES)."</span></a>,";
                                                }
                                            }else if($priority=='Optional'){
                                                 if(!empty($frow_im)){
...
//                                                                   ><span>".
//                                                                    htmlspecialchars( xl('Immunizations'), ENT_NOQUOTES)."</span></a>,";
                                                      $fname_opt.="<a href='javascript:;' onclick=win1('../interface/patient_file/summary/immunizations_custom.php?pid=$respid1&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl('Immunizations'), ENT_NOQUOTES)."</span></a>,";
                                                }else {
//                                                    $fname_opt.="<a href='../interface/patient_file/summary/immunizations_custom.php?pid=$respid1'
//                                                                   ><span>".
//                                                                    htmlspecialchars( xl('Immunizations'), ENT_NOQUOTES)."</span></a>,";
...
//                                                                    htmlspecialchars( xl('History'), ENT_NOQUOTES)."</span></a>,";
                                                      ...
                                                      $fname_comp.="<a href='javascript:;' onclick=win1('../interface/patient_file/history/history_custom.php?pid=$respid1&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl('History'), ENT_NOQUOTES)."</span></a>,";
                                                 }else {
//                                                    $fname.="<a href='../interface/patient_file/history/history_custom.php?pid=$respid1'
//                                                                   ><span>".
//                                                                    htmlspecialchars( xl('History'), ENT_NOQUOTES)."</span></a>,";
                                                     $fname.="<a href='javascript:;' onclick=win1('../interface/patient_file/history/history_custom.php?pid=$respid1&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl('History'), ENT_NOQUOTES)."</span></a>,";
                                                }
                                            }else if($priority=='Optional'){
                                                 if(!empty($frow_his)){
...
//                                                                    htmlspecialchars( xl('History'), ENT_NOQUOTES)."</span></a>,";
                                                      ...
                                                      $fname_opt.="<a href='javascript:;' onclick=win1('../interface/patient_file/history/history_custom.php?pid=$respid1&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl('History'), ENT_NOQUOTES)."</span></a>,";
                                                }else {
//                                                    $fname_opt.="<a href='../interface/patient_file/history/history_custom.php?pid=$respid1'
//                                                                   ><span>".
//                                                                    htmlspecialchars( xl('History'), ENT_NOQUOTES)."</span></a>,";
                                         ...
                                         $orders=explode(",",$rowres['order_of_columns']);
                                           $field1='';  $fields=array();
                                            foreach($orders as $value2){
                                             ...
                                             $query="select ".$field_val1.", DATE_FORMAT(f.date, '%Y-%m-%d') as date1,f.elec_signedby,f.elec_signed_on,f.pid,e.pc_facility,e.pc_aid,e.pc_catid,f.provider_id from form_encounter f  INNER JOIN patient_data p ON p.pid=f.pid LEFT JOIN openemr_postcalendar_events e ON e.pc_pid=f.pid and e.pc_eventDate=DATE_FORMAT(f.date, '%Y-%m-%d') AND e.pc_catid=f.pc_catid  where  f.encounter=$resenc1 AND f.pid=$respid1 ";
  ...
  var datastring='<?php echo $res; ?>'+'patientid'+'='+pid+'&'+'encounter_id'+'='+enc+'&'+'dos'+'='+date1+'&'+'chartgroupshidden'+'='+'1Mobile';
   //alert(datastring);
      ...
      // location.href = '../patient_file/summary/preview_chartoutput.php?'+datastring;
       ...
       window.open('../interface/reports/preview_charts.php?'+datastring,'popup','width=900,height=900,scrollbars=no,resizable=yes');
}
...
<!--                                 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                 ...
                                 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                   <?php $sql_vis=sqlStatement("SELECT provider_menus from tbl_user_custom_attr_1to1 where userid=".$id['id']."");
                                                ...
                                                if(!empty($diff)){
                                                    foreach($diff as $diffval){
                                                        if(in_array($diffval, $available1)){ ?>
                                                          <li class='order' style="color:red;" ><?php echo $diffval; ?></li>
                                                        <?php }
                                           ...
                                           foreach($orders as $value21){
                                                 ...
                                                 $row=sqlFetchArray($sql);
                                                   if($row['option_id']=='patient_name' && in_array($row['option_id'], $available6)){
                                                           echo "<th  data-class='expand'>".htmlspecialchars( xl($field12[1]), ENT_NOQUOTES)."</th>";
                                                   }elseif(in_array($row['option_id'], $available6)){
                                                           echo "<th data-hide='phone' data-name='$field12[1]'>".htmlspecialchars( xl($field12[1]), ENT_NOQUOTES)."</th>";
                                                   }
                                            }
...
//                                                                echo "<td>";if($result1['Facility_Name']!='')  $pro_id2=sqlStatement("select name from facility where id='".$result1['Facility_Name']."' ");
//                                                                                    $id_row5=sqlFetchArray($pro_id2);
//                                                                                    $proid23=$id_row5['name'];{ echo $proid23; }echo"</td>";
