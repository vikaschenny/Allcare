...
function allcare_ros_report( $pid, $encounter, $cols, $id) {

    $count = 0;
    
    $data = formFetch("tbl_form_allcare_ros", $id);

    if ($data) {
        print "<div id='form_allcareros_values'><table class='report_results'><tr>";
        ...
        foreach($data as $key => $value) {
            ...
            if ($value == "N/A" || $value == "Not Examined" || $value == "Normal"  || $value == "Select Details") { continue; }
