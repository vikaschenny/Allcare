...
class allcare_C_FormROS1 extends Controller {
 ...
 //           $this->assign("id1",$id1);
	...
	function default_action_process1() {
		...
		$this->allcareros = new allcare_FormROS($_POST['id1'],$_POST['pid2']);
               // print_r($_POST);
...
//		}
		...
		{      $_SESSION['authUser']=$_POST['provider'];
			...
			addForm($_POST['encounter'], "Allcare Review Of Systems", $this->allcareros->id, "allcare_ros", $_POST['pid2'], $userauthorized);
			$_POST['process'] = "";
