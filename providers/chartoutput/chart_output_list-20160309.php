...
<table  id='chart_data' cellpadding='0' class='table table-striped table-bordered dt-responsive nowrap'  width='100%'>
    <thead>
        <tr><th data-class='expand'>Print</th><th>Edit</th><th>Delete</th><th>Type</th><th>Date</th>
                    ...
                    <tr>
                        <td>
                           <?php if($transaction==2) { 
                                      $tr_name='f2f';    
                                     print "<a href='javascript:;' onclick=win1('f2f/print_f2f.php?f2fid=$id&encounter_id=$encounter&patient_id=$pid&date_of_service=".$iter['date_of_service']."') class='welcome-btn1' >            
                                    <span>".htmlspecialchars( xl('Print'), ENT_NOQUOTES)."</span></a>";

                                 } else { 
                                     $tr_name='med';
                                     echo "<a href='javascript:;' onclick=win1('chartoutput/print_charts.php?coid=$id&pid=$pid&group=$group_name1') class='welcome-btn1' >               
                                         <span>".htmlspecialchars( xl('Print'), ENT_NOQUOTES)."</span></a>"; 
                                 } ?>
                        </td>
                        <td>
                            <?php   
                                echo "<a class='various' data-fancybox-type='iframe' href='chartoutput/chart_output.php?coid=".htmlspecialchars( $iter{"id"}, ENT_NOQUOTES).
                                    "&inmode=edit&group_name2=$group_name2&group_name=$group_name1&location=provider_portal&provider=$provider&pid=$pid&refer=$refer&type=$trans_type2' style='background-color:#49C1DC;
...
<!--                transaction type-->
                ...
                <?php   //transaction date            
                        ...
                        if($iter1{'provider'}!='' && $iter1{'provider'}!='null'){
                        ...
                        if($iter1{'facility'}!='' && $iter1{'facility'}!='null'){
                        ...
                        if($iter1{'pharmacy'}!='' && $iter1{'pharmacy'}!='null'){
                        ...
                        if($iter1{'payer'}!='' && $iter1{'payer'}!='null'){
