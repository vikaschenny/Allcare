   ...
   if(template_save=='true' && type!='Patient Encounter Specific') {
       ...
       if($('#new_trans').val()!=''){
           ...
           success: function(response)
           {
              ...
              DoPostmed('../providers_medrecord.php','<?php echo $provider; ?>','<?php echo $pid; ?>','<?php echo $refer; ?>','<?php echo $group_name; ?>'); parent.$.fancybox.close();
           },
           failure: function(response)
           {
               alert("error"); 
        ...
        // window.parent.location.href = '../providers_medrecord.php?provider=<?php echo $provider; ?>&form_patient=<?php echo $pid; ?>'+'&refer='+'<?php echo $refer; ?>'; parent.$.fancybox.close();
         DoPostmed('../providers_medrecord.php','<?php echo $provider; ?>','<?php echo $pid; ?>','<?php echo $refer; ?>','<?php echo $group_name; ?>'); parent.$.fancybox.close();
    }
}
