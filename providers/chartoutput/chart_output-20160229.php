...
if ($mode) {   
 ...
 //$sqlBindArray = array($_POST['form_from_dos'], $_POST['form_to_dos'],$_POST['form_demographics'],$_POST['form_history'],$_POST['form_insurance'],$_POST['form_immunizations'],$_POST['form_vitals']);
  ...
  $provider1=$_REQUEST['form_provider'];
  ...
  if ($id) {       
    //use sql placemaker
    array_push($sqlBindArray,date("Y-m-d"),$dos,$group_name,$refer_to,$provider1,$facility,$pharmacy,$payer,$who_type, $notes, $id);
    ...
    array_push($sqlBindArray,$pid,date("Y-m-d"),date("Y-m-d"), $dos,$group_name,$refer_to,$provider1,$facility,$pharmacy,$payer,$who_type,$notes);
...
<link rel="stylesheet" type="text/css" href="../../interface/patient_file/popover/css/jquery.webui-popover.min.css" media="screen" />
...
<script src="../../interface/patient_file/popover/js/jquery.webui-popover.js"></script>
...
<div id='chartdiv'>
    ...
    <fieldset class="fsStyle">
        ...
        <label>Notes:</label>
        <div id="nots"><textarea name="form_notes" id="form_notes" title="" cols="30" rows="5"><?php echo $res21['notes']; ?></textarea><a href='#' class='show-pop-async addnots'  data-placement='right-bottom'><i class="glyphicon glyphicon-new-window"></i></a></div>  </fieldset><br><br> 
