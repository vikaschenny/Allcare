...
<script type="text/javascript">
    ...
    function group_selected(provider1,pid1){
     ...
     $(document).ready(function(){
        ...
        //alert($('#chartgroups option:selected').val()+$('#chartgroups option:selected').text());
         document.getElementById('data').style.display = 'block';
          ...
          <table>
            <tr>
                ...
                <td>
                    ...
                    <a class='various' data-fancybox-type='iframe' href='chartoutput/chart_output.php?pid=<?php echo  $patient ; ?>&location=provider_portal&provider=<?php echo $provider; ?>&refer=<?php echo $refer; ?>' style="background-color:#49C1DC;
