...
function DoPostmed(page_name, provider,patient,refer) {
...
<?php
 ...
 if ($_POST['form_submit']) {
  ...
  // if (!acl_check('admin', 'super')) die("Not authorized!");
   ...
   if($_REQUEST['nonenc']==1){
      
         row_delete("tbl_nonencounter_data",
  ...
  if($location=='provider_portal'){
      if($trans=='f2f'){
          echo "javascript:DoPostmed('../../../providers/providers_f2f.php','$provider','$patient1','$refer'); parent.$.fancybox.close(); "; 
      }else{
           echo "javascript:DoPostmed('../../../providers/providers_medrecord.php','$provider','$patient1','$refer'); parent.$.fancybox.close();";
      }
...
<!-- for patient specific-->
 <input type="hidden" id="nonenc" name="nonenc" value="<?php echo $_REQUEST['nonenc']; ?>"/>    
...
if($trans=='f2f'){ ?>
          ...
          <a href='#' class="css_button" onclick="javascript:DoPostmed('../../../providers/providers_f2f.php','<?php echo $provider; ?>','<?php echo $patient1; ?>','<?php echo $refer; ?>'); parent.$.fancybox.close();"><span><?php echo xl('No, Cancel');?></span></a>
     <?php  }else{ ?>
         
            <a href='#' class="css_button" onclick="javascript:DoPostmed('../../../providers/providers_medrecord.php','<?php echo $provider; ?>','<?php echo $patient1; ?>','<?php echo $refer; ?>'); parent.$.fancybox.close();"><span><?php echo xl('No, Cancel');?></span></a>
     <?php  }?>
