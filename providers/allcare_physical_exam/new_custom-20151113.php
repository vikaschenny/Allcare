...
//          echo '<script>  window.location.href = "../../../providers/provider_incomplete_charts.php"; </script>';
    ...
    window.opener.location.href = '../../../providers/provider_incomplete_charts.php';</script>";
       exit;
     }
...
<form method="post" action="new_custom.php?encounter=<?php echo $encounter; ?>&pid=<?php echo $pid1; ?>&id=<?php echo $formid; ?>&location=<?php echo $location; ?>&provider=<?php echo $provider; ?>&menu_val=<?php echo $menu; ?>"
