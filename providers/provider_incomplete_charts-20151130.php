                                                     ...
                                                     if($priority5=='Required'){
                                                        if(!empty($field_val[0])){    
                                                            if(in_array('pending',$field_val) && in_array('finalized',$field_val)){
                                                                 $fname_comp_his.=$order."<a href='javascript:;' onclick=win1('procedure_order/new.php?encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                            elseif(in_array('pending',$field_val) ){

                                                                  $fname_his.=$order."<a href='javascript:;' onclick=win1('procedure_order/new.php?encounter=$resenc1&pid=$respid1&provider=$provider&location=provider_portal&formid=$formid1&id=$fid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
                                                                ...
                                                                $req_not_started_his.=$order."<a href='javascript:;' onclick=win1('procedure_order/new.php?encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                        }else if($priority5=='Optional'){
                                                            if(!empty($field_val[0])){ 
                                                                 if(in_array('pending',$field_val) && in_array('finalized',$field_val) ){
                                                                      $fname_opt_his_comp.=$order."<a href='javascript:;' onclick=win1('procedure_order/new.php?encounter=$resenc1&pid=$respid1&provider=$provider&location=provider_portal&formid=$formid1&id=$fid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
                                                                 }
                                                                 elseif(in_array('pending',$field_val)){

                                                                      $fname_opt_his_comp.=$order."<a href='javascript:;' onclick=win1('procedure_order/new.php?encounter=$resenc1&pid=$respid1&provider=$provider&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";

                                                                }else if(in_array('finalized',$field_val)){

                                                                     $fname_opt_his.=$order."<a href='javascript:;' onclick=win1('procedure_order/new.php?encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
                                                                }
                                                            }else{
                                                                $opt_not_started_his.=$order."<a href='javascript:;' onclick=win1('procedure_order/new.php?encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                        }
                                                     }else {
                                                         if($priority5=='Required'){
                                                      
                                                                $req_not_started_his.=$order."<a href='javascript:;' onclick=win1('procedure_order/new.php?encounter=$resenc1&pid=$respid1&id=0&provider=$provider&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
                                                            
                                                        }else if($priority5=='Optional'){
                                                            
                                                                $opt_not_started_his.=$order."<a href='javascript:;' onclick=win1('procedure_order/new.php?encounter=$resenc1&pid=$respid1&id=0&provider=$provider&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
                                                ...
                                                if(!empty($frow_his)){
                                                   ...
                                                   if($priority5=='Required'){ 
                                                        if( strpos('finalized',$qa_stat_res['field_value']) !== false  ){
                                                            $fname_comp_his.=$order."<a href='javascript:;' onclick=win1('quality_of_care/new.php?pid=$respid1&encounter=$resenc1&provider=$provider&location=provider_portal&form_id=$qaform_id') ><span>".htmlspecialchars( xl('Quality Of Care'), ENT_NOQUOTES)."</span></a><br>";
                                                        }else if( strpos('pending',$qa_stat_res['field_value']) !== false  ) {

                                                            $fname_his.=$order."<a href='javascript:;' onclick=win1('quality_of_care/new.php?pid=$respid1&encounter=$resenc1&provider=$provider&location=provider_portal&form_id=$qaform_id') ><span>".htmlspecialchars( xl('Quality Of Care'), ENT_NOQUOTES)."</span></a><br>";
                                                        }else {
                                                            $req_not_started_his.=$order."<a href='javascript:;' onclick=win1('quality_of_care/new.php?groupname=$gname&pid=$respid1&encounter=$resenc1&provider=$provider&location=provider_portal&form_id=$qaform_id') ><span>".htmlspecialchars( xl('Quality Of Care'), ENT_NOQUOTES)."</span></a><br>";
                                                        }
                                                   }else if($priority5=='Optional'){
                                                        if(strpos('finalized',$qa_stat_res['field_value']) !== false){
                                                            $fname_opt_his_comp.=$order."<a href='javascript:;' onclick=win1('quality_of_care/new.php?groupname=$gname&pid=$respid1&encounter=$resenc1&provider=$provider&location=provider_portal&form_id=$qaform_id') ><span>".htmlspecialchars( xl('Quality Of Care'), ENT_NOQUOTES)."</span></a><br>";
                                                        }else if( strpos('pending',$qa_stat_res['field_value']) !== false  ){
                                                            $fname_opt_his.=$order."<a href='javascript:;' onclick=win1('quality_of_care/new.php?groupname=$gname&pid=$respid1&encounter=$resenc1&provider=$provider&location=provider_portal&form_id=$qaform_id') ><span>".htmlspecialchars( xl('Quality Of Care'), ENT_NOQUOTES)."</span></a><br>";
                                                        }else {
                                                            $opt_not_started_his.=$order."<a href='javascript:;' onclick=win1('quality_of_care/new.php?groupname=$gname&pid=$respid1&encounter=$resenc1&provider=$provider&location=provider_portal&form_id=$qaform_id') ><span>".htmlspecialchars( xl('Quality Of Care'), ENT_NOQUOTES)."</span></a><br>";
                                                        }
                                                   }
                                                }else{
                                                    if($priority5=='Required'){   
                                                        $req_not_started_his.=$order."<a href='javascript:;' onclick=win1('quality_of_care/new.php?groupname=$gname&pid=$respid1&encounter=$resenc1&provider=$provider&location=provider_portal&form_id=0') ><span>".htmlspecialchars( xl('Quality Of Care'), ENT_NOQUOTES)."</span></a><br>";

                                                    }else if($priority5=='Optional'){
                                                        $opt_not_started_his.=$order."<a href='javascript:;' onclick=win1('quality_of_care/new.php?groupname=$gname&pid=$respid1&encounter=$resenc1&provider=$provider&location=provider_portal&form_id=0') ><span>".htmlspecialchars( xl('Quality Of Care'), ENT_NOQUOTES)."</span></a><br>";
                                         ...
                                         foreach($sequence3 as $keys => $values){
                                             ...
                                             if($field_id5=='ros'){
                                                     ...
                                                     if($priority5=='Required'){
                                                         ...
                                                         if($priority5=='Required'){
                                                                    $req_not_started_pre.=$order."<a href='javascript:;' onclick=win1('allcare_ros/new_custom.php?formname=allcare_ros&encounter=$resenc1&pid=$respid1&location=provider_portal&provider=$provider') ><span>".htmlspecialchars( xl('Allcare Ros'), ENT_NOQUOTES)."</span></a><br>";


                                                        }else if($priority5=='Optional'){

                                                                    $opt_not_started_pre.=$order."<a href='javascript:;' onclick=win1('allcare_ros/new_custom.php?formname=allcare_ros&encounter=$resenc1&pid=$respid1&location=provider_portal&provider=$provider') ><span>".htmlspecialchars( xl('Allcare Ros'), ENT_NOQUOTES)."</span></a><br>";
                                                        }
                                                     }  
                                                     ...
                                                     if($fid!=''){
                                                          ...
                                                          if($priority5=='Required'){
                                                                    ...
                                                                    $req_not_started_pre.=$order."<a href='javascript:;' onclick=win1('allcare_physical_exam/new_custom.php?formname=allcare_physical_exam&edit=custom_pe&encounter=$resenc1&pid=$respid1&location=provider_portal&provider=$provider&menu_val=$menu') ><span>".htmlspecialchars( xl('Allcare Physical_exam'), ENT_NOQUOTES)."</span></a><br>";
                                                                
                                                            }else if($priority5=='Optional'){
                                                                
                                                                    $opt_not_started_pre.=$order."<a href='javascript:;' onclick=win1('allcare_physical_exam/new_custom.php?formname=allcare_physical_exam&edit=custom_pe&encounter=$resenc1&pid=$respid1&location=provider_portal&provider=$provider&menu_val=$menu') ><span>".htmlspecialchars( xl('Allcare Physical_exam'), ENT_NOQUOTES)."</span></a><br>";
                                                  ...
                                                  $resid_vt=sqlStatement("select *  from forms where form_name  ='Vitals' AND encounter=$resenc1 AND pid=$respid1  AND deleted=0 ORDER BY id DESC");  
                                                     ...
                                                     if($fid1!=''){
                                                        ...
                                                        if($priority5=='Required'){
                                                            ...
                                                            $req_not_started_pre.=$order."<a href='javascript:;' onclick=win1('vitals/new_custom.php?formname=Vitals&encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal&status=$status') ><span>".htmlspecialchars( xl('Vitals'), ENT_NOQUOTES)."</span></a><br>";
                                                            
                                                        }else if($priority5=='Optional'){
                                                            
                                                            $opt_not_started_pre.=$order."<a href='javascript:;' onclick=win1('vitals/new_custom.php?formname=Vitals&encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal&status=$status') ><span>".htmlspecialchars( xl('Vitals'), ENT_NOQUOTES)."</span></a><br>";
                                                     ...
                                                     if($fid1!=''){
                                                        if($priority5=='Required'){ 
                                                            if(($frow_enc['elec_signedby']!='' && $frow_enc['elec_signed_on']!='' ) && $frow_enc['audited_status'] == 'Completed' ){
                                                                $fname_comp_issue.=$order."<a href='javascript:;' onclick=win1('auditform/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl('Audit Form'), ENT_NOQUOTES)."</span></a><br>";
                                                            }else  {
                                                                  $fname_issue.=$order."<a href='javascript:;' onclick=win1('auditform/new_custom.php?encounter=$resenc1&pid=$respid1&provider=$provider&location=provider_portal&id=$fid1') ><span>".htmlspecialchars( xl('Audit Form'), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                        }else if($priority5=='Optional'){
                                                            if(($frow_enc['elec_signedby']!='' && $frow_enc['elec_signed_on']!='' ) && $frow_enc['audited_status'] == 'Completed' ){
                                                                $fname_opt_issue_comp.=$order."<a href='javascript:;' onclick=win1('auditform/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl('Audit Form'), ENT_NOQUOTES)."</span></a><br>";
                                                            }else {
                                                                $fname_opt_issue.=$order."<a href='javascript:;' onclick=win1('auditform/new_custom.php?encounter=$resenc1&pid=$respid1&provider=$provider&location=provider_portal&id=$fid1') ><span>".htmlspecialchars( xl('Audit Form'), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                        }
                                                     }else{
                                                         if($priority5=='Required'){ 
                                                                ...
                                                                $req_not_started_issue.=$order."<a href='javascript:;' onclick=win1('auditform/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl('Audit Form'), ENT_NOQUOTES)."</span></a><br>";
                                                            
                                                        }else if($priority5=='Optional'){
                                                                $fid1=0;
                                                                 
                                                                 $opt_not_started_issue.=$order."<a href='javascript:;' onclick=win1('auditform/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl('Audit Form'), ENT_NOQUOTES)."</span></a><br>";
                                                        ...
                                                        if($priority5=='Required'){
                                                            ...
                                                            if(!empty($field_val6[0])){
                                                                if(in_array('pending',$field_val6) && in_array('finalized',$field_val6)){
                                                                     $fname_comp_issue.=$order."<a href='javascript:;' onclick=win1('/providers/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a><br>";
                                                                }
                                                                elseif(in_array('pending',$field_val6) ){

                                                                      $fname_issue.=$order."<a href='javascript:;' onclick=win1('/providers/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a><br>";
                                                                ...
                                                                $req_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/providers/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                        }else if($priority5=='Optional'){
                                                            ...
                                                            if(!empty($field_val6[0])){
                                                                 ...
                                                                 if(in_array('finalized',$field_val6) && in_array('pending',$field_val6)){
                                                                      ...
                                                                      $fname_opt_issue_comp.=$order."<a href='javascript:;' onclick=win1('/providers/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a><br>"; 
                                                                }
                                                                 elseif(in_array('finalized',$field_val6)){
                                                                     ...
                                                                     $fname_opt_issue.=$order."<a href='javascript:;' onclick=win1('/providers/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a><br>";
                                                                }
                                                            }
                                                           else {
                                                               
                                                                $opt_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/providers/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                        }
                                                     }else {
                                                         if($priority5=='Required'){
                                                            
                                                             $req_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/providers/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=0&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a><br>";
                                                           
                                                        }else if($priority5=='Optional'){
                                                            $opt_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/providers/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=0&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a><br>";
                                                        ...
                                                        if($priority5=='Required'){
                                                            ...
                                                            if(!empty($field_val_ccm[0])){
                                                                if(in_array('pending',$field_val_ccm) && in_array('finalized',$field_val_ccm)){
                                                                     $fname_comp_issue.=$order."<a href='javascript:;' onclick=win1('/providers/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid_ccm&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a><br>";
                                                                }
                                                                elseif(in_array('pending',$field_val_ccm) ){

                                                                      $fname_issue.=$order."<a href='javascript:;' onclick=win1('/providers/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid_ccm&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a><br>";
                                                                ...
                                                                $req_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/providers/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid_ccm&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                        }else if($priority5=='Optional'){
                                                            ...
                                                            if(!empty($field_val_ccm[0])){
                                                                 ...
                                                                 if(in_array('finalized',$field_val_ccm) && in_array('pending',$field_val_ccm)){
                                                                      ...
                                                                      $fname_opt_issue_comp.=$order."<a href='javascript:;' onclick=win1('/providers/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid_ccm&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a><br>"; 
                                                                }
                                                                 elseif(in_array('finalized',$field_val_ccm)){
                                                                     ...
                                                                     $fname_opt_issue.=$order."<a href='javascript:;' onclick=win1('/providers/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid_ccm&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a><br>";
                                                                }
                                                            }
                                                           else {
                                                               
                                                                $opt_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/providers/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid_ccm&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                        }
                                                     }else {
                                                         if($priority5=='Required'){
                                                            
                                                             $req_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/providers/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=0&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a><br>";
                                                           
                                                        }else if($priority5=='Optional'){
                                                            $opt_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/providers/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=0&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a><br>";
                                          ...
                                          <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <label class="col-sm-2 control-label" for="form_provider"><?php xl('Fee Provider','e'); ?>:</label>
                                                ...
                                                <label class="col-sm-2 control-label" for="form_provider"><?php xl('Rendering Provider','e'); ?>:</label>
                                                <div class="col-sm-4 input-group-sm">
                                                  <?php
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4 input-group-sm">
                                                        <?php if(!empty($facility)){$facility1=implode("|",$facility); }  facility_list1(strip_escape_custom($facility1), 'form_facility1[]' ,'form_facility1',true); ?>
                                                    </div>
                                     ...
                                     if(!empty($row1_vis1)) {
                                      ...
                                      if(!empty($row12)){
                                           ...
                                           foreach($orders as $value21){
                                                 ...
                                                 $sql=sqlStatement("select * from list_options where list_id='AllCareProviderIncomplete' AND title='$title' order by seq"); 
                                                 $row=sqlFetchArray($sql);
                                                   if($row['option_id']=='patient_name' && in_array($row['option_id'], $available6) && $row['option_id']!='provider' && $row['option_id']!='rend_provider'){
                                                                        ...
                                                                        if(!empty($row13)){
                                                                               ...
                                                                               foreach($orders as $value22){
                                                                                     ...
                                                                                     while($rowId=sqlFetchArray($sqlId)){
                                                                                         ...
                                                                                         }elseif(in_array($field, $avail3) && $field!='provider' && $field!='rend_provider'){
