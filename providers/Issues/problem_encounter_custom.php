<?php
 ...
 $pid1=$_REQUEST['pid'];
 $patdata = getPatientData($pid1, "fname,lname,squad");
...
// }
 ...
 // get problems
 $pres = sqlStatement("SELECT * FROM lists WHERE pid = $pid1 " .
  "ORDER BY type, date");

 // get encounters
 $eres = sqlStatement("SELECT * FROM form_encounter WHERE pid = $pid1 " .
  "ORDER BY date DESC");

 // get problem/encounter relations
 $peres = sqlStatement("SELECT * FROM issue_encounter WHERE pid = $pid1");
?>
<html>
<head>
...
<script type="text/javascript" src="../../library/dialog_custom.js"></script>
...
function newIssue() {
 ...
 dlgopen('add_edit_issue_custom.php' + tmp, '_blank', 600, 475);
}
...
<form method='post' action='problem_encounter_custom.php' onsubmit='return top.restoreSession()'>
<?php
 echo "<input type='hidden' name='form_pid' value='$pid1' />\n";
...
<table border='0' cellpadding='5' cellspacing='0' width='100%'>
 ...
 <tr>
  <td colspan='2' align='center'>
   <b><?php xl('Issues and Encounters for','e'); ?> <?php echo $patdata['fname'] . " " . $patdata['lname'] . " ($pid1)</b>\n"; ?>
  </td>
 </tr>
