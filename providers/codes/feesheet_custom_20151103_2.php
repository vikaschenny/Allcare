...
echo "<form method='post' name='my_form' id='my_form'" .
  "action='save_codes.php?id=" . attr($formid) ."'>\n";
    $requested = $_REQUEST;
    ?>
    <button id="save_btnup" class="button-css button fa fa-floppy-o" onclick="my_form.submit()"> Save</button>
...
//    }
    ...
    <button id="save_btndown" class="button-css button fa fa-floppy-o" onclick="my_form.submit()"> Save</button>
