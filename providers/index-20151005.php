...
<center>
    ...
    <form method="POST" 
 action="home.php?auth=login&site=<?php echo attr($_SESSION['site_id']); ?>"
 target="_top" name="login_form1" onsubmit="return imsubmitted();">
...
<div class="table-right" style="padding-top:0px !important">
...
<td>
<input class="entryfield" type="text" size="10" name="authUser" id="authUser">
</td></tr><tr>
<td><span class="text"><?php echo xlt('Password:'); ?></span></td>
<td>
<input class="entryfield" type="password" size="10" name="clearPass" id="clearPass">
</td></tr>
