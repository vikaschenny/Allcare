                ...
                jQuery('div',"#"+group).each(function(){
                    if(jQuery(this).attr('id').substring(1).startsWith("_") === true){
                        ...
                        if(jQuery(this).attr('id') === 'd_risk'){
                            ...
                            jQuery("#d_acd").children("input:checked").map(function() {
   ...
   function showDiv (fieldname) { 
    ...
    function audit_form_check(){
        ...
        jQuery.ajax({
            ...
            data: {selected_data:selected_data,posted_title:title},
            dataType : "json",
            success: function(data) {
                var dataresult = data +' ';
                var res = dataresult.split(',');
...
<body class="body_top">
    ...
    <div id="history_unobtainable" name ="history_unobtainable"  style="display:none;" align="center">
        ...
        <div align = 'left'>
        <input type='radio' id='history_unobtainable_radio' name='history_unobtainable_radio' value= 'Problem_Focused' onclick='checkbox_selected("history_unobtainable_radio");' 
        <?php if($audit_data["history_unobtainable_radio"] == 'Problem_Focused' ) 
            echo " checked";  
        ?>
        > Problem Focused<br>
        <input type='radio' id='history_unobtainable_radio' name='history_unobtainable_radio' value= 'Expanded_Problem_Focused' onclick='checkbox_selected("history_unobtainable_radio");' 
        <?php if($audit_data["history_unobtainable_radio"] == 'Expanded_Problem_Focused' ) 
            echo " checked";  
        ?>
        > Expanded Problem Focused<br>
        <input type='radio' id='history_unobtainable_radio' name='history_unobtainable_radio' value= 'Detailed' onclick='checkbox_selected("history_unobtainable_radio");'
        <?php if($audit_data["history_unobtainable_radio"] == 'Detailed' ) 
            echo " checked";  
        ?>> Detailed<br>
        <input type='radio' id='history_unobtainable_radio' name='history_unobtainable_radio' value= 'Comprehensive' onclick='checkbox_selected("history_unobtainable_radio");' 
    ...
    <table border ="1" style="border-collapse: collapse;">
        ...
        while($set_group_names = sqlFetchArray($get_group_names)){
            ...
            ?><input type='checkbox' id='checkbox<?php echo $set_group_names["group_name"]; ?>' onclick= "showDiv('<?php echo $groupname_checkbox; ?>')" ><b> <?php echo substr($groupname_checkbox,1); ?> </b><?php
            ...
            if($groupname_checkbox == '1History' ){
                echo "<input type='hidden' name='hidden".$groupname_checkbox."4' id='hidden".$groupname_checkbox."4' value='".$audit_data['hidden'.$groupname_checkbox]."3'>";
            ...
            echo "<div id='".$groupname_checkbox."' name = '".$groupname_checkbox."' style='border:1px solid black;margin: 0px 20px 5px 20px;display:none;'>";
                ...
                while ($set_field_names = sqlFetchArray($get_field_names)){
                    ?><input type='checkbox' id='checkbox<?php echo $set_field_names["field_id"]; ?>'  onclick= "showDiv('<?php echo $set_field_names["field_id"]; ?>')" ><?php
                    echo "<b>".$set_field_names['title']."</b>";
                    echo "<input type='hidden' name='hidden".$set_field_names['field_id']."2' id='hidden".$set_field_names['field_id']."2' value='".$audit_data['hidden'.$set_field_names['field_id']]."' >";
                            ...
                            while($set_list_fields = sqlFetchArray($get_list_fields)){
                                ...
                                if( $list_id == 'Diagnosis_Management_Options'){
                                    ...
                                    if( $list_id == 'Audit_CC_Options'){
                                        if($option_id != '4'){
                                            ?><input type='radio' id='<?php echo $list_id.'radio'; ?>' name='<?php echo $list_id.'radio'; ?>' value= '<?php echo $option_id; ?>' onclick='checkbox_selected("<?php echo $field_id ?> ", "<?php echo $group_id; ?> " , "<?php echo $option_id; ?>");' <?php if($option_id == $audit_data[$groupname_checkbox]['Audit_CC_Optionsradio']) echo checked; ?> > <?php echo $list_title."</br>";
                                        }else{
                                            ?><input 
                                                type      = 'checkbox' 
                                        ...
                                        if($list_id == 'Audit_HPI_Options'){
                                            ...
                                            $data = $audit_data[$groupname_checkbox][$list_id.$option_id];
                                            ?><input type='checkbox' id='<?php echo $list_id.$option_id; ?>' 
