					...
					<div class= "col-lg-12 col-sm-12 col-xs-12" style='padding-top:100px !important;'>
                                           <form name="userid_dropdown"  action="" method="POST">
                                                            <?php 
                                                                ...
                                                                $query  = "SELECT pid, lname, fname FROM patient_data  ORDER BY fname, lname ";
                                             ...
                                             <script type="text/javascript">
                                                  function ajaxcall(target, url,data){
                                                    ...
                                                    $(document).ready( function () {
                                                        ...
                                                        var getobjval = function(val,htmlobject){
                                                            var element="";
                                                            htmlobject.each(function(index,value){
                                                                if($(value).data("opvalue") == val){
                                                                   element = value;
                                                                   return false
                                                                }
                                                        ...
                                                        //alert(getobjval("17",$('#patientlist > option')))
                                                        var getdefaultval = fromPatient !=""?getobjval(fromPatient,$('#patientlist > option')):$('#patientlist > option').first();
