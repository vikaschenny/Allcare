<?php /* Smarty version 2.6.2, created on 2016-02-22 07:24:35
         compiled from /mnt/stor10-wc2-dfw1/551939/551948/allcare.texashousecalls.com/web/content/interface/forms/allcare_ros/templates/allcare_ros/general_new_custom.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'xl', '/mnt/stor10-wc2-dfw1/551939/551948/allcare.texashousecalls.com/web/content/interface/forms/allcare_ros/templates/allcare_ros/general_new_custom.html', 351, false),array('function', 'html_radios', '/mnt/stor10-wc2-dfw1/551939/551948/allcare.texashousecalls.com/web/content/interface/forms/allcare_ros/templates/allcare_ros/general_new_custom.html', 356, false),array('modifier', 'escape', '/mnt/stor10-wc2-dfw1/551939/551948/allcare.texashousecalls.com/web/content/interface/forms/allcare_ros/templates/allcare_ros/general_new_custom.html', 391, false),)), $this); ?>
<html>
<head> 
   ...
   $(document).ready(function(){
    // constitutional
        $(\'input[type=radio][name=constitutional]\').change(function() {
            if ($(\'input[name=constitutional]:checked\').val() == \'Not Examined\' || $(\'input[name=constitutional]:checked\').val() == \'Select Details\') {
        ...
        // eyes
         $(\'input[type=radio][name=eyes]\').change(function() {
            if ($(\'input[name=eyes]:checked\').val() == \'Not Examined\' || $(\'input[name=eyes]:checked\').val() == \'Select Details\') {
                 $(\'#eyes\').show();
            }
        ...
        // ent 
         $(\'input[type=radio][name=ent]\').change(function() {
            if ($(\'input[name=ent]:checked\').val() == \'Not Examined\' || $(\'input[name=ent]:checked\').val() == \'Select Details\') {
                 $(\'#ent\').show();
            }
        ...
        // breast 
         $(\'input[type=radio][name=breast]\').change(function() {
            if ($(\'input[name=breast]:checked\').val() == \'Not Examined\' || $(\'input[name=breast]:checked\').val() == \'Select Details\') {
                 $(\'#breast\').show();
            }
         ...
         if($(\'input[name=breast]:checked\').val() == \'Not Examined\' || $(\'input[name=breast\').val() == \'Select Details\'){
            $(\'#breast\').show();
        }else{
            $(\'#breast\').hide();
        }
        ...
        $(\'input[type=radio][name=respiratory]\').change(function() {
            if ($(\'input[name=respiratory]:checked\').val() == \'Not Examined\' || $(\'input[name=respiratory]:checked\').val() == \'Select Details\') {
                 $(\'#respiratory\').show();
            }
        ...
        //cardiovascular
         $(\'input[type=radio][name=cardiovascular]\').change(function() {
            if ($(\'input[name=cardiovascular]:checked\').val() == \'Not Examined\' || $(\'input[name=cardiovascular]:checked\').val() == \'Select Details\') {
                 $(\'#cardiovascular\').show();
            }
        ...
        //gastrointestinal
         $(\'input[type=radio][name=gastrointestinal]\').change(function() {
            if ($(\'input[name=gastrointestinal]:checked\').val() == \'Not Examined\' || $(\'input[name=gastrointestinal]:checked\').val() == \'Select Details\') {
        ...
        //genitourinary
         $(\'input[type=radio][name=genitourinary]\').change(function() {
            if ($(\'input[name=genitourinary]:checked\').val() == \'Not Examined\' || $(\'input[name=genitourinary]:checked\').val() == \'Select Details\') {
                 $(\'#genitourinary\').show();
            }
        ...
        //genitourinarymale
         $(\'input[type=radio][name=genitourinarymale]\').change(function() {
            if ($(\'input[name=genitourinarymale]:checked\').val() == \'Not Examined\'|| $(\'input[name=genitourinarymale]:checked\').val() == \'Select Details\') {
        ...
        //genitourinaryfemale
         $(\'input[type=radio][name=genitourinaryfemale]\').change(function() {
            if ($(\'input[name=genitourinaryfemale]:checked\').val() == \'Not Examined\' || $(\'input[name=genitourinaryfemale]:checked\').val() == \'Select Details\') {
        ...
        //musculoskeletal
         $(\'input[type=radio][name=musculoskeletal]\').change(function() {
            if ($(\'input[name=musculoskeletal]:checked\').val() == \'Not Examined\' || $(\'input[name=musculoskeletal]:checked\').val() == \'Select Details\') {
        ...
        //extremities
         $(\'input[type=radio][name=extremities]\').change(function() {
            if ($(\'input[name=extremities]:checked\').val() == \'Not Examined\' || $(\'input[name=extremities]:checked\').val() == \'Select Details\') {
                 $(\'#extremities\').show();
            }
        ...
        //neurologic
         $(\'input[type=radio][name=neurologic]\').change(function() {
            if ($(\'input[name=neurologic]:checked\').val() == \'Not Examined\' || $(\'input[name=neurologic]:checked\').val() == \'Select Details\') {
                 $(\'#neurologic\').show();
            }
        ...
        if($(\'input[name=neurologic]:checked\').val() == \'Not Examined\' || $(\'input[name=neurologic]:checked\').val() == \'Select Details\'){
         ...
         $(\'input[type=radio][name=skin]\').change(function() {
            if ($(\'input[name=skin]:checked\').val() == \'Not Examined\' || $(\'input[name=skin]:checked\').val() == \'Select Details\') {
                 $(\'#skin\').show();
            }
        ...
        //psychiatric
         $(\'input[type=radio][name=psychiatric]\').change(function() {
            if ($(\'input[name=psychiatric]:checked\').val() == \'Not Examined\' || $(\'input[name=psychiatric]:checked\').val() == \'Select Details\') {
                 $(\'#psychiatric\').show();
            }
        ...
        //endocrine
         $(\'input[type=radio][name=endocrine]\').change(function() {
            if ($(\'input[name=endocrine]:checked\').val() == \'Not Examined\' || $(\'input[name=endocrine]:checked\').val() == \'Select Details\') {
                 $(\'#endocrine\').show();
            }
        ...
        //hai
         $(\'input[type=radio][name=hai]\').change(function() {
            if ($(\'input[name=hai]:checked\').val() == \'Not Examined\' || $(\'input[name=hai]:checked\').val() == \'Select Details\') {
                 $(\'#hai\').show();
            }
        ...
        if($(\'input[name=hai]:checked\').val() == \'Not Examined\' || $(\'input[name=hai]:checked\').val() == \'Select Details\'){
         ...
         $(\'input[type=radio][name=neck]\').change(function() {
            if ($(\'input[name=neck]:checked\').val() == \'Not Examined\' || $(\'input[name=neck]:checked\').val() == \'Select Details\') {
                 $(\'#neck\').show();
            }
...
/interface/forms/allcare_ros/save_custom.php?encounter=<?php echo $this->_tpl_vars['encounter']; ?>
&pid=<?php echo $this->_tpl_vars['pid']; ?>
&id1=<?php echo $this->_tpl_vars['id']; ?>
&location=<?php echo $this->_tpl_vars['location']; ?>
&provider=<?php echo $this->_tpl_vars['provider']; ?>
&DONT_SAVE_LINK=<?php echo $this->_tpl_vars['DONT_SAVE_LINK']; ?>
"
...
:</td>
			<td class="response"><?php echo smarty_function_html_radios(array('name' => 'change_in_appetite','options' => $this->_tpl_vars['form']->get_options(),'selected' => $this->_tpl_vars['form']->get_change_in_appetite(),'separator' => ""), $this);?>
                     ...
                     <tr><td colspan="6"><label class="response_prompt">  Other  </label><input type="text" name ="constitutional_text"  value="<?php echo ((is_array($_tmp=$this->_tpl_vars['form']->get_constitutional_text())) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
" size="50"/></td></tr>
                    </table>
</tr><td>
...
:</td>
			<td class="response"><?php echo smarty_function_html_radios(array('name' => 'obstruction','options' => $this->_tpl_vars['form']->get_options(),'selected' => $this->_tpl_vars['form']->get_obstruction(),'separator' => ""), $this);?>
                    ...
                    <tr>
                        <td class="response_prompt"><?php echo smarty_function_xl(array('t' => 'Blurry Vision'), $this);?>
:</td>
			<td class="response"><?php echo smarty_function_html_radios(array('name' => 'blurry_vision','options' => $this->_tpl_vars['form']->get_options(),'selected' => $this->_tpl_vars['form']->get_blurry_vision(),'separator' => ""), $this);?>
</td>
                    </tr>
                    <tr><td colspan="6"><label class="response_prompt">Other</label><input type="text" name ="eyes_text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['form']->get_eyes_text())) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
" size="50"></td></tr>
                </table>
...
:</td>
                            ...
                            <td class="response_prompt"><?php echo smarty_function_xl(array('t' => 'Bleeding'), $this);?>
:</td>
                            <td class="response"><?php echo smarty_function_html_radios(array('name' => 'bleeding','options' => $this->_tpl_vars['form']->get_options(),'selected' => $this->_tpl_vars['form']->get_bleeding(),'separator' => ""), $this);?>
</td>
                    </tr>
                    <tr><td colspan="6"><label class="response_prompt">Other</label><input type="text" name ="ent_text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['form']->get_ent_text())) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
" size="50"></td></tr>
                </table>
...
:</td>
			<td class="response"><?php echo smarty_function_html_radios(array('name' => 'tenderness','options' => $this->_tpl_vars['form']->get_options(),'selected' => $this->_tpl_vars['form']->get_tenderness(),'separator' => ""), $this);?>
                    ...
                    <tr><td colspan="6"><label class="response_prompt" >Other</label><input type="text" name ="neck_text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['form']->get_neck_text())) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
" size="50"></td></tr>
                </table>
</tr><td></td>
</tr>
...
:</td>
                    ...
                    <tr><td colspan="6"><label class="response_prompt">Other</label><input type="text" name ="breast_text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['form']->get_breast_text())) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
" size="50"></td></tr>
                </table>
</tr><td>
...
:</td>
                    ...
                    <tr><td colspan="6"><label class="response_prompt">Other</label><input type="text" name ="respiratory_text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['form']->get_respiratory_text())) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
" size="50"></td></tr>
                </table>
</tr><td>
...
:</td>
                    ...
                    <tr><td colspan="6"><label class="response_prompt">Other</label><input type="text" name ="cardiovascular_text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['form']->get_cardiovascular_text())) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
" size="50"></td></tr>
                </table>
...
:</td>
                    ...
                    <tr><td colspan="6"><label class="response_prompt">Other</label><input type="text" name ="gastrointestinal_text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['form']->get_gastrointestinal_text())) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
" size="50"/></td></tr>
                </table>
</tr><td>
...
:</td>
                            ...
                            <td class="response_prompt"><?php echo smarty_function_xl(array('t' => 'Polydipsia'), $this);?>
:</td>
...
:</td>
                            ...
                            <td class="response_prompt"><?php echo smarty_function_xl(array('t' => 'Kidney Failure'), $this);?>
:</td>
                            <td class="response"><?php echo smarty_function_html_radios(array('name' => 'kidney_failure','options' => $this->_tpl_vars['form']->get_options(),'selected' => $this->_tpl_vars['form']->get_kidney_failure(),'separator' => ""), $this);?>
</td>
                    </tr>
                    <tr><td colspan="6"><label class="response_prompt">Other</label><input type="text" name ="genitourinary_text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['form']->get_genitourinary_text())) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
" size="50"></td></tr>
                </table>
</tr><td>
...
:</td>
                    ...
                    <tr><td colspan="6"><label class="response_prompt">Other</label><input type="text" name ="genitourinarymale_text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['form']->get_genitourinarymale_text())) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
" size="50"></td></tr>
                </table>
</tr><td>	
	</td>
...
:</td>
                    ...
                    <tr><td colspan="6"><label class="response_prompt">Other</label><input type="text" name ="genitourinaryfemale_text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['form']->get_genitourinaryfemale_text())) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
" size="50"></td></tr>
                </table>
</tr><td>
	</td>
...
:</td>
                    ...
                    <tr><td colspan="6"><label class="response_prompt" >Other</label><input type="text" name ="musculoskeletal_text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['form']->get_musculoskeletal_text())) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
" size="50"></td></tr>
                </table>
</tr><td>	
	</td>
...
:</td>
                    ...
                    <tr><td colspan="6"><label class="response_prompt" >Other</label><input type="text" name ="extremities_text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['form']->get_extremities_text())) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
" size="50"></td></tr>
                </table>
</tr><td>	
	</td>
...
:</td>
                            ...
                            <td class="response_prompt"><?php echo smarty_function_xl(array('t' => 'Tingling'), $this);?>
:</td>
                            <td class="response"><?php echo smarty_function_html_radios(array('name' => 'tingling','options' => $this->_tpl_vars['form']->get_options(),'selected' => $this->_tpl_vars['form']->get_tingling(),'separator' => ""), $this);?>
</td>
                            <td class="response_prompt"><?php echo smarty_function_xl(array('t' => 'Burning Sensation'), $this);?>
:</td>
                            <td class="response"><?php echo smarty_function_html_radios(array('name' => 'burning_sensation','options' => $this->_tpl_vars['form']->get_options(),'selected' => $this->_tpl_vars['form']->get_burning_sensation(),'separator' => ""), $this);?>
</td>
                    </tr>
                    <tr><td colspan="6"><label class="response_prompt" >Other</label><input type="text" name ="neurologic_text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['form']->get_neurologic_text())) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
" size="50"></td></tr>
                </table>
</tr><td>	
	</td>
...
:</td>
                            ...
                            <td class="response_prompt"><?php echo smarty_function_xl(array('t' => 'Lesions'), $this);?>
:</td>
                            <td class="response"><?php echo smarty_function_html_radios(array('name' => 'lesions','options' => $this->_tpl_vars['form']->get_options(),'selected' => $this->_tpl_vars['form']->get_lesions(),'separator' => ""), $this);?>
</td>
                    </tr>
                    <tr>
                            <td class="response_prompt"><?php echo smarty_function_xl(array('t' => 'Sores'), $this);?>
:</td>
                            <td class="response"><?php echo smarty_function_html_radios(array('name' => 'sores','options' => $this->_tpl_vars['form']->get_options(),'selected' => $this->_tpl_vars['form']->get_sores(),'separator' => ""), $this);?>
</td>
                    </tr>
                    
                    <tr><td colspan="6"><label class="response_prompt" >Other</label><input type="text" name ="skin_text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['form']->get_skin_text())) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
" size="50"></td></tr>
                </table>
</tr><td>	
	</td>
...
:</td>
                    ...
                    <tr>
                            <td class="response_prompt"><?php echo smarty_function_xl(array('t' => 'Changes in Sleep Habits'), $this);?>
:</td>
                            <td class="response"><?php echo smarty_function_html_radios(array('name' => 'changes_in_sleep_habits','options' => $this->_tpl_vars['form']->get_options(),'selected' => $this->_tpl_vars['form']->get_changes_in_sleep_habits(),'separator' => ""), $this);?>
</td>
                            
                    </tr>
                    <tr><td colspan="6"><label class="response_prompt" >Other</label><input type="text" name ="psychiatric_text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['form']->get_psychiatric_text())) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
" size="50"></td></tr>
                </table>
</tr><td>	
	</td>
...
:</td>
                     ...
                     <tr>
                            <td class="response_prompt"><?php echo smarty_function_xl(array('t' => 'Polyphagia'), $this);?>
:</td>
                            <td class="response"><?php echo smarty_function_html_radios(array('name' => 'polyphagia','options' => $this->_tpl_vars['form']->get_options(),'selected' => $this->_tpl_vars['form']->get_polyphagia(),'separator' => ""), $this);?>
</td>
                            <td class="response_prompt"><?php echo smarty_function_xl(array('t' => 'Cirrhosis'), $this);?>
:</td>
                            <td class="response"><?php echo smarty_function_html_radios(array('name' => 'cirrhosis','options' => $this->_tpl_vars['form']->get_options(),'selected' => $this->_tpl_vars['form']->get_cirrhosis(),'separator' => ""), $this);?>
</td>
                    </tr>
                    <tr><td colspan="6"><label class="response_prompt" >Other</label><input type="text" name ="endocrine_text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['form']->get_endocrine_text())) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
" size="50"></td></tr>
                </table>
</tr><td>	
	</td>
...
:</td>
                    ...
                    <tr><td colspan="6"><label class="response_prompt" >Other</label><input type="text" name ="hai_text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['form']->get_hai_text())) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')); ?>
" size="50"></td></tr>
                </table>
</tr><td>	
	</td>
...
" />
	<input type="hidden" name="pid2" value="<?php echo $this->_tpl_vars['form']->get_pid(); ?>
" />
	<input type="hidden" name="process" value="true" />
        <input type="hidden" name="encounter" value="<?php echo $this->_tpl_vars['encounter']; ?>
" />
	<input type="hidden" name="pid" value="<?php echo $this->_tpl_vars['pid']; ?>
" />
        <input type="hidden" name="id1" value="<?php echo $this->_tpl_vars['id']; ?>
" />
        <input type="hidden" name="location" value="<?php echo $this->_tpl_vars['location']; ?>
" />
        <input type="hidden" name="isFromCharts" value="<?php echo $this->_tpl_vars['form']->get_isFromCharts(); ?>
" />
        <input type="hidden" name="isSingleView" value="<?php echo $this->_tpl_vars['form']->get_isSingleView(); ?>
" />
        <input type="hidden" name="provider" value="<?php echo $this->_tpl_vars['provider']; ?>
" />
        <input type="hidden" name="DONT_SAVE_LINK" value="<?php echo $this->_tpl_vars['DONT_SAVE_LINK']; ?>
" />
        <input type="hidden" name="location1" value="<?php echo $this->_tpl_vars['form']->get_location(); ?>
" />
        <input type="hidden" name="provider1" value="<?php echo $this->_tpl_vars['form']->get_provider(); ?>
" />
        <input type="hidden" name="encounter1" value="<?php echo $this->_tpl_vars['form']->get_encounter(); ?>
" />
...
<td> <?php if ($this->_tpl_vars['location'] == 'provider_portal' || $this->_tpl_vars['form']->get_location() == 'provider_portal'): ?> <a href="" id="ds" class="link" onclick="window.close();">[<?php  xl("Don't Save","e");  ?>]</a><br><br> <?php else: ?>
    <a href="<?php echo $this->_tpl_vars['DONT_SAVE_LINK']; ?>
" class="link" onclick="top.restoreSession()">[<?php  xl("Don't Save","e");  ?>]</a><br><br> <?php endif; ?>
        <a href="javascript:;" class="link" onclick="window.open( 'http://<?php echo $_SERVER['HTTP_HOST']; ?>
