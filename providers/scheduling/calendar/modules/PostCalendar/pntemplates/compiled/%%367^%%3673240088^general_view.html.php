<?php /* Smarty version 2.6.2, created on 2014-06-25 03:00:15
         compiled from /mnt/stor10-wc2-dfw1/551939/551948/emrsb.risecorp.com/web/content/templates/documents/general_view.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'xl', '/mnt/stor10-wc2-dfw1/551939/551948/emrsb.risecorp.com/web/content/templates/documents/general_view.html', 37, false),array('function', 'user_info', '/mnt/stor10-wc2-dfw1/551939/551948/emrsb.risecorp.com/web/content/templates/documents/general_view.html', 194, false),array('modifier', 'escape', '/mnt/stor10-wc2-dfw1/551939/551948/emrsb.risecorp.com/web/content/templates/documents/general_view.html', 163, false),array('modifier', 'replace', '/mnt/stor10-wc2-dfw1/551939/551948/emrsb.risecorp.com/web/content/templates/documents/general_view.html', 219, false),)), $this); ?>
<head>
...
as_file=false"></embed>
			<?php elseif ($this->_tpl_vars['file']->get_mimetype() == "image/png" || $this->_tpl_vars['file']->get_mimetype() == "image/jpg" || $this->_tpl_vars['file']->get_mimetype() == "image/jpeg" || $this->_tpl_vars['file']->get_mimetype() == "image/gif" || $this->_tpl_vars['file']->get_mimetype() == "application/pdf" && $this->_tpl_vars['file']->get_type() == 'file_url'): ?>
			 <iframe frameborder="0" type="<?php echo $this->_tpl_vars['file']->get_mimetype(); ?>
" src="<?php echo $this->_tpl_vars['web_path']; ?>
as_file=false"></iframe>
			 <?php elseif ($this->_tpl_vars['file']->get_type() == 'web_url'): ?>
			 <?php $this->assign('fileid', $this->_tpl_vars['file']->get_url_web()); ?>
			 <?php $this->assign('fileidvalue', ((is_array($_tmp=$this->_tpl_vars['fileid'])) ? $this->_run_mod_handler('replace', true, $_tmp, 'export=download', 'edit') : smarty_modifier_replace($_tmp, 'export=download', 'edit'))); ?>
			 <a href='<?php echo "https://docs.google.com/a/riseglobal.net/".($this->_tpl_vars['fileidvalue']); ?>
' target="_blank".>Click on the Link to View the File</a>
			 <!--<iframe type="<?php echo $this->_tpl_vars['file']->get_mimetype(); ?>
" src="https://docs.google.com/a/riseglobal.net/$fileidvalue as_file=true" frameborder="1"></iframe>-->
