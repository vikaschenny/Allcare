...
<div id="immunization_list">
    ...
    <tr class='text bold'>
    <th>
        <a href="javascript:location.href='immunizations_custom.php?sortby=vacc&pid=<?php echo $pid; ?>';" title='<?php echo htmlspecialchars( xl('Sort by vaccine'), ENT_QUOTES); ?>'>
    ...
    <th>
        <a href="javascript:location.href='immunizations_custom.php?sortby=date&pid=<?php echo $pid; ?>';" title='<?php echo htmlspecialchars( xl('Sort by date'), ENT_QUOTES); ?>'>
...
var EditImm = function(imm) {
   // top.restoreSession();
    location.href='immunizations_custom.php?mode=edit&pid=<?php echo $pid; ?>&id='+imm.id;
}
...
var DeleteImm = function(imm) {
    if (confirm("<?php echo htmlspecialchars( xl('This action cannot be undone.'), ENT_QUOTES); ?>" + "\n" +"<?php echo htmlspecialchars( xl('Do you wish to PERMANENTLY delete this immunization record?'), ENT_QUOTES); ?>")) {
      //  top.restoreSession();
        location.href='immunizations_custom.php?mode=delete&pid=<?php echo $pid; ?>&id='+imm.id;
    }
}

var ErrorImm = function(imm) {
   // top.restoreSession();
	location.href='immunizations_custom.php?mode=added_error&pid=<?php echo $pid; ?>&id='+imm.id+'&isError='+imm.checked;
}
