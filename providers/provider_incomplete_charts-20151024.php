...
$sql=sqlStatement("insert into incomplete_charts_filter (provider,patient,audit_status,encounter_status,`from`,`to`,facility,visit_category,loginuser) values('$provider','$patient_val1','$audit_val1','$enc_val1','$from','$to','$fac_val1','$vc_val1','$provider')");
