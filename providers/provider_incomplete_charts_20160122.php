...
$sql=sqlStatement("insert into incomplete_charts_filter (provider,patient,audit_status,encounter_status,`from`,`to`,facility,visit_category,loginuser,assigned_by) values('$id1','$patient_val1','$audit_val1','$enc_val1','$from','$to','$fac_val1','$vc_val1','$provider','$assign_val1')");
...
//    echo "UPDATE  form_encounter SET elec_signedby=".$provider_id['provider_id']." ,elec_signed_on=DATE_FORMAT( $elec_dt, '%Y-%m-%d')  where pid=$patient_id AND encounter=$encounter";
    $update = sqlStatement("UPDATE  form_encounter SET elec_signedby=".$provider_id['provider_id']." ,elec_signed_on= '$elec_dt' where pid=$patient_id AND encounter=$encounter ");
    ...
    $create_transaction = sqlStatement("INSERT INTO tbl_form_chartoutput_transactions (pid,encounter,date_of_service,created_date,refer_to,notes,$field_id1) VALUES($patient_id,$encounter,'$dos',NOW(),'$refer_to','$notes',$field_value1)");
    ...
    //    $finalized = $_POST['finalized'];
        ...
        $ip_addr=GetIP();
        if(empty($array)):
            $array2[] = array( 'authuser' =>$_SESSION["authUser"],'Status' => $status,'date' => date("Y/m/d"), 'action'=>'created','ip_address'=>$ip_addr."(provider portal)" ,'count'=> $count+1);
            ...
            if(mysql_num_rows($result) > 0){
                $array2[] = array( 'authuser' =>$_SESSION["authUser"],'Status' => $status, 'date' => date("Y/m/d"), 'action' => 'updated','ip_address'=>$ip_addr."(provider portal)" ,'count'=> $count+1);
                $logdata = array_merge_recursive($array, $array2);
                $logdata= ($logdata? serialize($logdata): serialize($array2) );
                                                     ...
                                                     if($priority5=='Required'){
                                                        if(!empty($field_val[0])){    
                                                            if(in_array('pending',$field_val) && in_array('finalized',$field_val)){
                                                                 $fname_comp_his.=$order."<a href='javascript:;' onclick=win1('procedure_order/new.php?encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a>,";
                                                            }
                                                            elseif(in_array('pending',$field_val) ){

                                                                  $fname_his.=$order."<a href='javascript:;' onclick=win1('procedure_order/new.php?encounter=$resenc1&pid=$respid1&provider=$provider&location=provider_portal&formid=$formid1&id=$fid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a>,";
                                                                ...
                                                                $req_not_started_his.=$order."<a href='javascript:;' onclick=win1('procedure_order/new.php?encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a>,";
                                                            }
                                                        }else if($priority5=='Optional'){
                                                            if(!empty($field_val[0])){ 
                                                                 if(in_array('pending',$field_val) && in_array('finalized',$field_val) ){
                                                                      $fname_opt_his_comp.=$order."<a href='javascript:;' onclick=win1('procedure_order/new.php?encounter=$resenc1&pid=$respid1&provider=$provider&location=provider_portal&formid=$formid1&id=$fid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a>,";
                                                                 }
                                                                 elseif(in_array('pending',$field_val)){
                                                                     ...
                                                                     $fname_opt_his.=$order."<a href='javascript:;' onclick=win1('procedure_order/new.php?encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a>,";
                                                                }
                                                            }else{
                                                                $opt_not_started_his.=$order."<a href='javascript:;' onclick=win1('procedure_order/new.php?encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a>,";
                                                            }
                                                        }
                                                     }else {
                                                         if($priority5=='Required'){
                                                      
                                                                $req_not_started_his.=$order."<a href='javascript:;' onclick=win1('procedure_order/new.php?encounter=$resenc1&pid=$respid1&id=0&provider=$provider&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a>,";
                                                            
                                                        }else if($priority5=='Optional'){
                                                            
                                                                $opt_not_started_his.=$order."<a href='javascript:;' onclick=win1('procedure_order/new.php?encounter=$resenc1&pid=$respid1&id=0&provider=$provider&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a>,";
                                                     ...
                                                     if($fid1!=''){
                                                        if($priority5=='Required'){ 
                                                            if(($frow_enc['elec_signedby']!='' && $frow_enc['elec_signed_on']!='' ) && $frow_enc['audited_status'] == 'Completed' ){
                                                                $fname_comp_issue.=$order."<a href='javascript:;' onclick=win1('auditform/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl('Audit Form'), ENT_NOQUOTES)."</span></a>,";
                                                            }else  {
                                                                  $fname_issue.=$order."<a href='javascript:;' onclick=win1('auditform/new_custom.php?encounter=$resenc1&pid=$respid1&provider=$provider&location=provider_portal&id=$fid1') ><span>".htmlspecialchars( xl('Audit Form'), ENT_NOQUOTES)."</span></a>,";
                                                            }
                                                        }else if($priority5=='Optional'){
                                                            if(($frow_enc['elec_signedby']!='' && $frow_enc['elec_signed_on']!='' ) && $frow_enc['audited_status'] == 'Completed' ){
                                                                $fname_opt_issue_comp.=$order."<a href='javascript:;' onclick=win1('auditform/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl('Audit Form'), ENT_NOQUOTES)."</span></a>,";
                                                            }else {
                                                                $fname_opt_issue.=$order."<a href='javascript:;' onclick=win1('auditform/new_custom.php?encounter=$resenc1&pid=$respid1&provider=$provider&location=provider_portal&id=$fid1') ><span>".htmlspecialchars( xl('Audit Form'), ENT_NOQUOTES)."</span></a>,";
                                                            }
                                                        }
                                                     }else{
                                                         if($priority5=='Required'){ 
                                                                ...
                                                                $req_not_started_issue.=$order."<a href='javascript:;' onclick=win1('auditform/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl('Audit Form'), ENT_NOQUOTES)."</span></a>,";
                                                            
                                                        }else if($priority5=='Optional'){
                                                                $fid1=0;
                                                                 
                                                                 $opt_not_started_issue.=$order."<a href='javascript:;' onclick=win1('auditform/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&provider=$provider&location=provider_portal') ><span>".htmlspecialchars( xl('Audit Form'), ENT_NOQUOTES)."</span></a>,";
                                                        ...
                                                        if($priority5=='Required'){
                                                            ...
                                                            if(!empty($field_val6[0])){
                                                                if(in_array('pending',$field_val6) && in_array('finalized',$field_val6)){
                                                                     $fname_comp_issue.=$order."<a href='javascript:;' onclick=win1('/providers/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a>,";
                                                                }
                                                                elseif(in_array('pending',$field_val6) ){

                                                                      $fname_issue.=$order."<a href='javascript:;' onclick=win1('/providers/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a>,";
                                                                ...
                                                                $req_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/providers/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a>,";
                                                            }
                                                        }else if($priority5=='Optional'){
                                                            ...
                                                            if(!empty($field_val6[0])){
                                                                 ...
                                                                 if(in_array('finalized',$field_val6) && in_array('pending',$field_val6)){
                                                                      ...
                                                                      $fname_opt_issue_comp.=$order."<a href='javascript:;' onclick=win1('/providers/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a>,"; 
                                                                }
                                                                 elseif(in_array('finalized',$field_val6)){
                                                                     ...
                                                                     $fname_opt_issue.=$order."<a href='javascript:;' onclick=win1('/providers/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a>,";
                                                                }
                                                            }
                                                           else {
                                                               
                                                                $opt_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/providers/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a>,";
                                                            }
                                                        }
                                                     }else {
                                                         if($priority5=='Required'){
                                                            
                                                             $req_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/providers/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=0&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a>,";
                                                           
                                                        }else if($priority5=='Optional'){
                                                            $opt_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/providers/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=0&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a>,";
                                                        ...
                                                        if($priority5=='Required'){
                                                            ...
                                                            if(!empty($field_val_ccm[0])){
                                                                if(in_array('pending',$field_val_ccm) && in_array('finalized',$field_val_ccm)){
                                                                     $fname_comp_issue.=$order."<a href='javascript:;' onclick=win1('/providers/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid_ccm&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a>,";
                                                                }
                                                                elseif(in_array('pending',$field_val_ccm) ){

                                                                      $fname_issue.=$order."<a href='javascript:;' onclick=win1('/providers/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid_ccm&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a>,";
                                                                ...
                                                                $req_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/providers/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid_ccm&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a>,";
                                                            }
                                                        }else if($priority5=='Optional'){
                                                            ...
                                                            if(!empty($field_val_ccm[0])){
                                                                 ...
                                                                 if(in_array('finalized',$field_val_ccm) && in_array('pending',$field_val_ccm)){
                                                                      ...
                                                                      $fname_opt_issue_comp.=$order."<a href='javascript:;' onclick=win1('/providers/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid_ccm&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a>,"; 
                                                                }
                                                                 elseif(in_array('finalized',$field_val_ccm)){
                                                                     ...
                                                                     $fname_opt_issue.=$order."<a href='javascript:;' onclick=win1('/providers/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid_ccm&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a>,";
                                                                }
                                                            }
                                                           else {
                                                               
                                                                $opt_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/providers/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid_ccm&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a>,";
                                                            }
                                                        }
                                                     }else {
                                                         if($priority5=='Required'){
                                                            
                                                             $req_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/providers/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=0&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a>,";
                                                           
                                                        }else if($priority5=='Optional'){
                                                            $opt_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/providers/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=0&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a>,";
...
?>
  ...
  window.open('chartoutput/preview_charts.php?'+datastring,'popup','width=900,height=900,scrollbars=no,resizable=yes');
            ...
            function postValue(enc1,pid1,date2,grp){  
                date2 = date2.trim();
                ...
                <?php
                    ...
                    $dropdowntitle = sqlStatement("SELECT title FROM layout_options WHERE field_id='refer_to' AND form_id = 'F2F'");
                    while ($dropdowntitle_value = mysql_fetch_array($dropdowntitle)) {
                        $dropdown_title = $dropdowntitle_value['title'];
                    }
                ...
                if(newDate.getMonth()<10){
                    getmonthvalue = '0'+newDate.getMonth();
                } else{
                    getmonthvalue = newDate.getMonth();
                }
                
                var maxdate =  newDate.getFullYear() + "-" + (getmonthvalue+1) + "-" + getdatevalue;
                ...
                if(document.getElementById('finalize_'+enc1).checked){ 
                    ...
                    var htmlStr = "<form action='' method='post'><p align='center'>"+displaydata+"Date: <input type='date' name='elec_date' id='elec_date' min='"+date2+"'";
                    ...
                    htmlStr += "<?php echo $dropdown_title ; ?>:<select id='refer_to' name='refer_to' required><option value=''>Select</option>";
                    <?php 
                        foreach($uarray as $uid => $uvalue){
                            ?>  htmlStr += "<option value='<?php echo $uid; ?>'> <?php echo $uvalue; ?></option> ";<?php
                        }
                    ?>
                                                                              ...
                                                                              $enc=$result1['encounter'];
                                                                                 ...
                                                                                 if($grpres['chart_group']!=''){ 
                                                                                  ...
                                                                                  while($mob_row1=sqlFetchArray($mobile_sql)){
                                                                                    ...
                                                                                    <a href='javascript:; ' onclick="window.open('chartoutput/preview_charts.php?'+'<?php echo $datastring; ?>','popup','width=900,height=900,scrollbars=no,resizable=yes');" class='css_button_small'><span><?php echo  htmlspecialchars( xl('Preview'), ENT_NOQUOTES); ?></span></a> |
                                                                                 <?php }else { ?>
...
<!--                                                                                <a href='javascript:; ' onclick="previewpost1('<?php echo $enc; ?>','<?php echo $pid; ?>','<?php echo $date; ?>')" class='css_button_small'><span><?php echo  htmlspecialchars( xl('Preview'), ENT_NOQUOTES); ?></span></a> -->
                                                                                  ...
                                                                                  <?php if($result1['audit_status']=='Complete'){  ?>
                                                                                        <input type='checkbox' name='finalize_<?php echo $enc; ?>' id='finalize_<?php echo $enc; ?>' onclick="postValue('<?php echo $enc; ?>','<?php echo $pid; ?>','<?php echo $date; ?> ','<?php echo $grpres['chart_group']; ?>')"/>Finalize | 
                            ...
                            //                                                      ?>
                                                                        ...
                                                                        echo "</td>";
                                                                         ...
                                                                         $sql_vis=sqlStatement("SELECT provider_incomp from tbl_user_custom_attr_1to1 where userid='".$id1."'");
                                                                         $row1_vis=sqlFetchArray($sql_vis);
                                                                         $enc=$result1['encounter'];
                                                                         $pid=$result1['pid'];
                                                                    if(!empty($row1_vis)) {
