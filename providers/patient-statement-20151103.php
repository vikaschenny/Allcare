...
if ($INTEGRATED_AR) {
  ...
  echo '<label class="col-sm-3 control-label" for="form_payer_id">'.xl('Payer').': </label>';
...
?>
<div class="form-group">
    <label class="col-sm-3 control-label" for="form_source"><?php xl('Source:','e'); ?></label>
    <div class="col-sm-3">
    ...
    <label class="col-sm-3 control-label" for="form_paydate"><?php xl('Pay Date:','e'); ?></label>
    <div class="col-sm-3">
...
<div class="form-group">
    <label class="col-sm-3 control-label" for="form_amount"><?php xl('Amount:','e'); ?></label>
    <div class="col-sm-3">
    ...
    <label class="col-sm-3 control-label" for="form_deposit_date"><?php xl('Deposit Date:','e'); ?></label>
    <div class="col-sm-3">
...
<div class="form-group">
    <label class="col-sm-3 control-label" for="insuredID">Insured Type: </label>
    <div class="col-sm-9">
...
<div class="form-group">
    <label class="col-sm-3 control-label" for="defaultFacility">Default Facility: </label>
    <div class="col-sm-9">
        ...
        <fieldset>
            <legend>Patients by Appointments</legend>
            <div class="form-group">
                <label class="col-sm-2 col-md-3 control-label" for="form_from_date"><?php xl('From','e'); ?> : </label>
                ...
                <label class="col-sm-2 col-md-3 control-label" for="form_tol_date"><?php xl('To','e'); ?> : </label>
                <div class="col-sm-4 col-md-3">
                    <div class="input-group">
            ...
            <div class="form-group">
                <div class="col-sm-12 text-center">
                   <input type="button" name="patlist" id="patlist" value="Get Patients" class="btn btn-submit btn-sm"><br /><span id="calmsg"></span>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-12">
            ...
            <div class="form-group">
                <div class="col-sm-9 col-sm-push-3">
                    <div class="checkbox">
                        <label>
                          <input type="checkbox" name="optionsRadios" onchange="fnShowHide(3)">
...
<div class="row form-horizontal" role="form">
    <div class="col-sm-12">
        <div class="form-group">
            <label class="col-sm-3 control-label" for="form_name"><?php xl('Name:','e'); ?></label>
            <div class="col-sm-3">
            ...
            <label class="col-sm-3 control-label" for="form_pid"><?php xl('Chart ID:','e'); ?></label>
            <div class="col-sm-3">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label" for="form_encounter"><?php xl('Encounter:','e'); ?></label>
            <div class="col-sm-3">
            ...
            <label class="col-sm-3 control-label" for="form_date"><?php xl('Svc Date:','e'); ?></label>
            <div class="col-sm-3">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label" for="form_to_date"><?php xl('To:','e'); ?></label>
            <div class="col-sm-3">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label" for="form_ageby"><?php xl('Age By','e') ?>:</label>
            <div class="col-sm-3">
            ...
            <label class="col-sm-3 control-label" for="form_age_cols"> <?php xl('Aging Columns:','e') ?></label>
            <div class="col-sm-3">
                <input type='text' name='form_age_cols' id='form_age_cols' size='10' value='<?php echo $form_age_cols; ?>'
                class="form-control">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label" for="form_age_inc"><?php xl('Days/Col:','e') ?></label>
            <div class="col-sm-9">
                <input type='text' name='form_age_inc' id='form_age_inc' size='10' value='<?php echo $form_age_inc; ?>'
                class="form-control">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-12 text-center">
                <input type='submit' name='form_search' id='form_age_inc' value='<?php xl("Search","e"); ?>'
...
//if ($_POST['form_search'] || $_POST['form_print']) {
  ...
  if ($INTEGRATED_AR) {
    ...
    $insuranceClause = $faciltyClause = $patlistselectClause = "";
    if($insuredIdStr != ''):
    ...
    $query = "SELECT DISTINCT f.encounter, f.id, f.pid, f.date,f.billing_note, " .
      ...
      "WHERE $where $payerClause $insuranceClause $faciltyClause $patlistselectClause AND bb.provider_id !=0 AND bb.payer_id !='' " .
...
<table cellspacing='0' width='100%' id="patientstatement" class="table table-striped table-bordered nowrap">
    <thead>
 <tr>
  <th>
   <?php xl('Payer','e'); ?>
