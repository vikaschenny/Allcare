...
class C_FormVitals_custom extends Controller {
    ...
    function default_action_custom($form_id,$pid1,$encounter1,$provider1,$location1,$pending,$finalized) {
        $this->assign("encounter",$encounter1);
        ...
        if (is_numeric($form_id)) {
    		$vitals = new FormVitals($form_id,$pid1,$pending,$finalized);
           
    	}
    	else {
    		$vitals = new FormVitals(0,$pid1);
    	}
    ...
    function default_action_process_custom() {
		...
		$this->vitals = new FormVitals($_POST['id1'],$_POST['pid']);
