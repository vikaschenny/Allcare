...
//        });
//    }
//    function updateallids(newformid){
//        $(".newwindow a").each(function(){
//            var url = $(this).attr("href")
//            var newurl = url.replace("id=0",("id="+newformid))
//            $(this).attr("href",newurl);
//        });
//    }
</script>
...
//          " left join openemr_postcalendar_categories on fe.pc_catid=openemr_postcalendar_categories.pc_catid  WHERE fe.pid = ? order by fe.date desc", array($pid_row['pid']));
    ...
    <br><br>
    <?php 
    echo "select * from tbl_visitcat_chartgrp_mapping where visit_category='".$res_dos['pc_catid']."'";
    ...
    if($grpres['chart_group'] != ''){ 
        ...
        $datastring     = $res.'patientid'.'='.$pid.'&'.'encounter_id'.'='.$encounter.'&'.'dos'.'='.$dos[0].'&'.'chartgroupshidden'.'='.$grpres['chart_group']; ?>
       ...
       <?php 
        ...
        <a class="various" data-fancybox-type="iframe" href="chartoutput/preview_group.php?enc=<?php echo $encounter; ?>&pid=<?php echo $pid; ?>&date=<?php echo $dos[0]; ?>&grp=0"  ><span><?php echo  htmlspecialchars( xl('Preview'), ENT_NOQUOTES); ?></span></a>
   <?php } ?>
