...
//            phone : 480
//        };
//        var tableElement = $('#patientstatement');
...
<form method='post' action='providers_patient.php' enctype='multipart/form-data'>
...
if ($INTEGRATED_AR) {
  ...
  foreach ($insurancei as $iid => $iname) {
    ...
    if ($iid == $_REQUEST['form_payer_id']) echo " selected";
    echo ">" . $iname . "</option>\n";
  }
  echo "   </select>\n";
  echo "  </td>\n";
...
?>
  ...
  <td>
   <input type='text' name='form_source' size='10' value='<?php echo $_REQUEST['form_source']; ?>'
  ...
  <td>
   <input type='text' name='form_paydate' size='10' value='<?php echo $_REQUEST['form_paydate']; ?>'
...
<?php if ($INTEGRATED_AR) { // include deposit date ?>
  ...
  <td>
   <input type='text' name='form_deposit_date' size='10' value='<?php echo $_REQUEST['form_deposit_date']; ?>'
    onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc)'
...
<?php } ?>
  ...
  <td>
   <input type='text' name='form_amount' size='10' value='<?php echo $_REQUEST['form_amount']; ?>'
...
<table border='0' cellpadding='5' cellspacing='0'>
 ...
 <tr bgcolor='#ddddff'>
  ...
  <td>
   <input type='text' name='form_pid' size='10' value='<?php echo $_REQUEST['form_pid']; ?>'
  ...
  <td>
   <input type='text' name='form_encounter' size='10' value='<?php echo $_REQUEST['form_encounter']; ?>'
  ...
  <td>
   <input type='text' name='form_date' size='10' value='<?php echo $_REQUEST['form_date']; ?>'
  ...
  <td>
   <input type='text' name='form_to_date' size='10' value='<?php echo $_REQUEST['form_to_date']; ?>'
...
<?php
 foreach (array(xl('Open'), xl('All'), xl('Due Pt'), xl('Due Ins')) as $value) {
  ...
  if ($_REQUEST['form_category'] == $value) echo " selected";
  echo ">$value</option>\n";
 }
?>
   </select>
 ...
 <tr>
    ...
    <?php
     foreach (array('Service Date', 'Last Activity Date') as $value) {
      echo "    <option value='$value'";
      if ($_REQUEST['form_ageby'] == $value) echo " selected";
...
//if ($_POST['form_search'] || $_POST['form_print']) {
  ...
  $is_ageby_lad   = strpos($_REQUEST['form_ageby'], 'Last') !== false;
  $form_age_cols = (int) $_REQUEST['form_age_cols'];
  $form_age_inc  = (int) $_REQUEST['form_age_inc'];
  ...
  if ($INTEGRATED_AR) {
    ...
    //Subhan
    $formPayerId = $_REQUEST['form_payer_id'];
    $payerClause = "";
    if($formPayerId != 0):
        $payerClause = " AND bb.payer_id = ".$formPayerId;
    endif;
    ...
    $query = "SELECT DISTINCT f.encounter, f.id, f.pid, f.date, " .
    ...
    if ($_REQUEST['form_category'] != 'All' && !$eracount) {
      $query .= "AND ar.amount != ar.paid ";
      // if ($_REQUEST['form_category'] == 'Due') {
...
<table border='0'  id="patientstatement"  cellpadding='0' cellspacing='0' border='0' class='display'>
    <thead>
 <tr>
   <th data-hide='phone' data-name='Zirmed Id'>
   <?php xl('Zirmed Id','e'); ?>
  </th>
  <!--<th>
   <?php xl('Payer Name','e'); ?>
  </th>-->
  <th data-hide='phone' data-name='Practice Name'>
   <?php xl('Practice Name','e'); ?>
  </th>
  <th data-hide='phone' data-name='Practice Address'>
   <?php xl('Practice Address','e'); ?>
  </th>
  <th data-hide='phone' data-name='Practice City'>
   <?php xl('Practice City','e'); ?>
  </th>
  <th data-hide='phone' data-name='Practice State'>
   <?php xl('Practice State','e'); ?>
  </th >
  <th data-hide='phone' data-name='Practice Zip'>
   <?php xl('Practice Zip','e'); ?>
  </th>
  <th data-hide='phone' data-name='Statement Date'>
   <?php xl('Statement Date','e'); ?>
  </th>
  <th data-hide='phone' data-name='Invoice'>
   <?php xl('Invoice','e'); ?>
  </th>
  <th data-hide='phone' data-name='Account Number'>
   <?php xl('Account Number','e'); ?>
  </th>
  <th data-class='expand'>
   <?php xl('Bill To','e'); ?>
  </th>
  <th data-hide='phone' data-name='Bill To Address'>
   <?php xl('Bill To Address','e'); ?>
  </th>
  <th data-hide='phone' data-name='Bill To City'>
   <?php xl('Bill To City','e'); ?>
  </th>
  <th data-hide='phone' data-name='Bill To State'>
   <?php xl('Bill To State','e'); ?>
  </th>
  <th data-hide='phone' data-name='Bill To Zip'>
   <?php xl('Bill To Zip','e'); ?>
  </th>
  <th data-hide='phone' data-name='DOS' >
   <?php xl('DOS','e'); ?>
  </th>
  <th data-hide='phone' data-name='Procedure'>
   <?php xl('Procedure','e'); ?>
  </th>
  <th data-hide='phone' data-name='Description'>
   <?php xl('Description','e'); ?>
  </th>
  <th data-hide='phone' data-name='DX Code'>
   <?php xl('DX Code','e'); ?>
  </th>
  <!--<th>
   <?php xl($INTEGRATED_AR ? 'Last Stmt' : 'Due Date','e'); ?>
  </th>-->
  <th align="right" data-hide='phone' data-name='Charge'>
   <?php xl('Charge','e'); ?>
  </th>
  <th align="right" data-hide='phone' data-name='Paid'>
   <?php xl('Paid','e'); ?>
  </th>
  <th align="right" data-hide='phone' data-name='Adjust'>
   <?php xl('Adjust','e'); ?>
  </th> 
  <th align="right" data-hide='phone' data-name='Balance'>
   <?php xl('Balance','e'); ?>
  </th>
    <?php
...
<?php
  ...
  if ($INTEGRATED_AR) {
    while ($row = sqlFetchArray($t_res)) {
      ...
      if ($_REQUEST['form_category'] != 'All' && $eracount == 0 && $balance == 0) continue;
      ...
      //
      if (substr($_REQUEST['form_category'], 0, 3) == 'Due' && !$isdueany) continue;
      if ($_REQUEST['form_category'] == 'Due Ins' && ($duncount >= 0 || !$isdueany)) continue;
      if ($_REQUEST['form_category'] == 'Due Pt'  && ($duncount <  0 || !$isdueany)) continue;
