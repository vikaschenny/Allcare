...
<script type='text/javascript'>
    $(document).ready(function() {
        ...
        function windowresize(){
           ...
           $('#patientstatement thead tr th').each(function(index,elm){
...
<?php } ?>
 ...
 <tr><td></td>
     <td><fieldset><legend>Patients by Appointments</legend><?php xl('From','e'); ?>:<input type='text' name='form_from_date' id="form_from_date"
                                    ...
                                    <br /><select name="patlistselect[]" id="patlistselect" multiple></select><br /><input type="checkbox" onchange="fnShowHide(3)">Show/hide Appointment Date
         </fieldset></td>   
 </tr> 
 <tr><td></td>
     <td><input type="checkbox" onchange="fnShowHide(4)">Show/hide Billing Note<br />
...
<table cellspacing='0' width='100%' id="patientstatement" class="table table-striped table-bordered dt-responsive nowrap">
    <thead>
 <tr>
  <th>
   <?php xl('Payer','e'); ?>
