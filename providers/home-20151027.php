               ...
               function DoPost(page_name, provider) {
                ...
                $(function(){
                     ...
                     $( ".row > #readmore" ).click(function() {
                         ...
                         if(nonevisibleitem <=6){$(this).children('a').addClass("disabled")};
                                  ...
                                  $i=0;
                                   while($row_app3=sqlFetchArray($sql12)){
                                           ...
                                           if($allow=='YES' && $date!=''){
                                            ...
                                            if($app_date[2]!=$today_event[2] && $app_date[1]!=$today_event[1] && $app_date[0]!=$today_event[0]){ 
                                                 if($i==0){
                                                 
                                                  echo " <div class='day-event1 row row-eq-height' id='app'  date-day=$today_event[2] date-month=$today_event[1] date-year=$today_event[0] data-number='1' style='padding-top:60px; background-color: #F2F2F2; height:250px; display:block;'>";
