...
$client->setRedirectUri('https://' . $_SERVER['HTTP_HOST'] . '/api/DriveSync/oauth2callback_web.php');
...
if (! isset($_GET['code'])) {
 ...
 $db->commit();
  ...
  $redirect_uri = "https://" . $_SERVER['HTTP_HOST'] . "/interface/main/allcarereports/drivesync_auth.php?status=1&email=".$_SESSION['useremail'];
