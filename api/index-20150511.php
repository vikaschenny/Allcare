	...
	try 
        {
            ...
            $sql = "SELECT count(f.id) as count FROM `form_encounter` f INNER JOIN patient_data p ON f.pid = p.pid WHERE (f.elec_signed_on = '' AND f.elec_signedby = '') AND p.providerID=$providerid ";
