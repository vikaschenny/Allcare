...
function getConnection() 
{
	...
	$dbhost="mysql51-054.wc2.dfw1.stabletransit.com";
	$dbuser="551948_allcrbox";
	$dbpass="Allcr@321";
	$dbname="551948_allcrbox";
...
/* hema */
//to get all patients fromopenEMR
...
function getAllAddressbookTypes(){
	...
	$sql = "SELECT seq,title FROM `list_options` WHERE list_id ='abook_type'";      
