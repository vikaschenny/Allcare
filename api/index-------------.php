...
//        if(!empty($dataResult)){
            ...
            $get_CPO_data = (isset($dataResult[0]->cpo_data)? $dataResult[0]->cpo_data : '');
            ...
            for($i=0; $i<$count_array; $i++){
                ...
                $cpo_data[$i]['cpotype']['value'] = (isset($unseralized_cpo[0]['cpotype'])? $unseralized_cpo[0]['cpotype'] : '');
                $cpo_data[$i]['cpotype']['options'] = $cpo_types;
                $cpo_data[$i]['start_date']['type'] = 'Date Field';
                $cpo_data[$i]['start_date']['label'] = 'Date';
                $cpo_data[$i]['start_date']['value'] = (isset($unseralized_cpo[0]['start_date'])? $unseralized_cpo[0]['start_date'] : '');
                ...
                $cpo_data[$i]['timeinterval']['value'] = (isset($unseralized_cpo[0]['timeinterval'])? $unseralized_cpo[0]['timeinterval'] : '');
                ...
                $cpo_data[$i]['users']['value'] = (isset($unseralized_cpo[0]['users'])? $unseralized_cpo[0]['users'] : '');
                $cpo_data[$i]['users']['options'] = $user_name;
                $cpo_data[$i]['location']['type'] = 'Textarea';
                $cpo_data[$i]['location']['label'] = 'Location';
                $cpo_data[$i]['location']['value'] = (isset($unseralized_cpo[0]['location'])? $unseralized_cpo[0]['location'] : '');
                $cpo_data[$i]['description']['type'] = 'Textarea';
                $cpo_data[$i]['description']['label'] = 'Description';
                $cpo_data[$i]['description']['value'] = (isset($unseralized_cpo[0]['description'])? $unseralized_cpo[0]['description'] : '');
                $cpo_data[$i]['reference']['type'] = 'Textarea';
                $cpo_data[$i]['reference']['label'] = 'Reference';
                $cpo_data[$i]['reference']['value'] = (isset($unseralized_cpo[0]['reference'])? $unseralized_cpo[0]['reference'] : '');
...
//        if(!empty($dataResult)){
            ...
            $get_CCM_data = isset($dataResult[0]->ccm_data)? $dataResult[0]->ccm_data : '';
            if(!empty($get_CPO_data)){
            ...
            for($i=0; $i<$count_array; $i++){
                ...
                $ccm_data[$i]['ccmtype']['value'] = isset($unseralized_ccm[0]['ccmtype'])? $unseralized_ccm[0]['ccmtype']  : '';
                $ccm_data[$i]['ccmtype']['options'] = $ccm_types;
                $ccm_data[$i]['start_date']['type'] = 'Date Field';
                $ccm_data[$i]['start_date']['label'] = 'Date';
                $ccm_data[$i]['start_date']['value'] = isset($unseralized_ccm[0]['start_date'])? $unseralized_ccm[0]['start_date']  : '';
                ...
                $ccm_data[$i]['timeinterval']['value'] = isset($unseralized_ccm[0]['timeinterval'])? $unseralized_ccm[0]['timeinterval']  : '';
                ...
                $ccm_data[$i]['users']['value'] = isset($unseralized_ccm[0]['users'])? $unseralized_ccm[0]['users']  : '';
                $ccm_data[$i]['users']['options'] = $user_name;
                $ccm_data[$i]['location']['type'] = 'Textarea';
                $ccm_data[$i]['location']['label'] = 'Location';
                $ccm_data[$i]['location']['value'] = isset($unseralized_ccm[0]['location'])? $unseralized_ccm[0]['location']  : '';
                $ccm_data[$i]['description']['type'] = 'Textarea';
                $ccm_data[$i]['description']['label'] = 'Description';
                $ccm_data[$i]['description']['value'] = isset($unseralized_ccm[0]['description'])? $unseralized_ccm[0]['description']  : '';
                $ccm_data[$i]['reference']['type'] = 'Textarea';
                $ccm_data[$i]['reference']['label'] = 'Reference';
                $ccm_data[$i]['reference']['value'] = isset($unseralized_ccm[0]['reference'])? $unseralized_ccm[0]['reference']  : '';
...
//        echo "<pre>"; print_r($filesArray); echo "</pre>";
        ...
        $cpo_data      = serialize($filesArray['cpo_data']);
...
//        echo "<pre>"; print_r($filesArray); echo "</pre>";
        ...
        $user          = $filesArray['user'];
        $user_id       = $filesArray['user_id'];
        $ccm_data      = serialize($filesArray['ccm_data']);
        $provider_id   = $filesArray['provider_id'];
        $authorized    = 1;
        $activity      = 1;
        $authProvider  = 'Default';
...
function getMedical_recorddata($pid) {
    ...
    try
    {
     ...
     $sql1 = "select field_id from layout_options where group_name LIKE  '%Mobile%' and form_id = 'CHARTOUTPUT' order by seq";
     $sqlstmt1 = $db->prepare($sql1);
     $sqlstmt1->execute();
