...
$layouts = array(
  ...
  'SERVICEFAC' =>xl('Service Facility'),
  'AGENCY' =>xl('Agencies'),
  'F2F'  =>xl('Face To Face'),
  'CHARTOUTPUT'  =>xl('Medical Record'),
  'PCA'  =>xl('Pharmacy Custom Attributes'),
  'INSCA' =>xl('Insurance Companies Custom Attributes'),
  'UCA'  =>xl('Users Custom Attributes'), 
  'ADDRCA'  =>xl('Address book Custom Attributes')  ,
  'USERS' =>xl('User Credentials'),
  'PHA' =>xl('Pharmacies Preferences'),
  'INSUCOMP' =>xl('Insurance Plans'),
  'ABOOKCONTACT' =>xl('Addressbook Contacts'),
  'ABOOKCRED' =>xl('Addressbook Credentials'),
  'PROVCRED' =>xl('Provider Credentials'),
  'PAYROLL' =>xl('Payroll'),
  'ESIGN' =>xl('Chart Electronically Signed By'),
  'ALLCARE' =>xl('AllCare Menu'),  
  'AUDITFORM' =>xl('Audit Form'),  
  'FCA'  =>xl('Facility Custom Attributes'),
  'ELIGIBILITY'  =>xl('Eligibility Response'),
  'NONENC'=>  xl('Medical Record Non Encounter'),
  'INSCUTOM'  =>xl('Patient Insurance Custom Attributes'),
  'ELIGRESULTS'  =>xl('Eligibility Estimation Results'),
  
  'BENEFITS'=>  xl('Benefits')  
...
$datatypes = array(
  ...
  "34" => xl("NationNotes"),
  "35" => xl("Facilities"),
  "36" => xl("Date Of Service"),
  "37" => xl("Insurance Companies"),
  "38" => xl("Users"),  
  "39" => xl("Date-Time")  ,
  "40" => xl("Providers-multiselect"),
  "41" => xl("Insurance-multiselect")   
);
...
if ($_POST['formaction'] == "save" && $layout_id) {
    ...
    if (substr($layout_id,0,3) != 'LBF' && $layout_id != "FACUSR") {
      ...
      else if ($layout_id == "SERVICEFAC") { $tablename = "tbl_patientfacility"; }
      else if ($layout_id == "AGENCY") { $tablename = "tbl_patientagency"; }
      ...
      else if ($layout_id == "USERS") { $tablename ="tbl_patientuser"; }
      else if ($layout_id == "PHA") { $tablename ="tbl_patientpharmacy"; }
      else if ($layout_id == "INSUCOMP") { $tablename ="tbl_patientinsurancecompany"; }
      else if ($layout_id == "ABOOKCONTACT") { $tablename ="tbl_user_abookcontact"; }
      else if ($layout_id == "ABOOKCRED") { $tablename ="tbl_user_cred"; }
      else if ($layout_id == "PROVCRED") { $tablename ="tbl_patientprovidercredentials"; }
      else if ($layout_id == "PAYROLL") { $tablename ="tbl_userpayroll"; }
      else if ($layout_id == "F2F") { $tablename = "tbl_form_facetoface_transactions"; }
      else if ($layout_id == "CHARTOUTPUT") { $tablename = "tbl_form_chartoutput_transactions"; }
      else if ($layout_id == "PCA") { $tablename = "tbl_pharmacy_custom_attributes_1to1"; }
      else if ($layout_id == "INSCA") { $tablename = "tbl_inscomp_custom_attr_1to1"; }
      else if ($layout_id == "UCA") { $tablename = "tbl_user_custom_attr_1to1"; }
      else if ($layout_id == "ADDRCA") { $tablename = "tbl_addrbk_custom_attr_1to1"; }
      else if ($layout_id == "ESIGN") { $tablename = "form_encounter"; }
      else if ($layout_id == "ALLCARE") { $tablename = "tbl_allcare_menu"; }
      else if ($layout_id == "AUDITFORM") { $tablename = "tbl_form_audit"; }
      else if ($layout_id == "FCA") { $tablename = "tbl_facility_custom_attr_1to1"; } 
      else if ($layout_id == "ELIGIBILITY") { $tablename = "tbl_eligibility_response_data"; } 
      else if ($layout_id == "NONENC") { $tablename = "tbl_nonencounter_data"; }
      else if ($layout_id == "INSCUTOM") { $tablename = "tbl_patient_insurancedata_meta_data"; }
      else if ($layout_id == "ELIGRESULTS") { $tablename = "tbl_elig_est_results"; }
      else if ($layout_id == "BENEFITS") { $tablename = "tbl_inscomp_benefits"; }
      if($data_type == 4 )
      {
          $type=date;
      }
...
<td><input type="textbox" name="gnewdesc" id="gnewdesc" value="" size="30" maxlength="500"> </td>
</tr>
</tbody>
</table>
<br>
