...
function provider_newEvt(selectedBox)
{
     ...
     {
  dlgopen('all_extensions/get_table_fields.php?table_name='+document.getElementById(selectedBox).value+'&selectedBox='+selectedBox+'&extension_name=provider',
   '_blank', 550, 270);
     }
  return false;
}
    ...
    {      
        if(jQuery('#provider_txtFieldName'+i).val()!=='')
        {
            ...
            $.ajax({
                ...
                dataType: "html",
		async: false, 
                data: {extension_name:'provider',FieldName:FieldName,chk1to1:chk1to1,chk1ton:chk1ton},
...
function provider_insertFields()
{
        ...
        $.ajax({
                type: 'POST',
		url: finalURL,	
		data: {extension_name:'provider',chk1to1:chk1to1,chk1ton:chk1ton,relatedTables:relatedTables,FieldName:FieldName,
...
function provider_showGroupsRecordsets()
{
    ...
    $.ajax({
                type: 'POST',
                url: finalURL,	
                data: {extension_name:'provider',table_name:table_name},
...
function provider_showFieldsByGroupRecordsets(tableName)
{
        ...
        $.ajax({
                    type: 'POST',
                    url: finalURL,	
                    data: {extension_name:'provider',table_name:table_name,selectedGR:selectedGR},
...
{               
        ...
        $.ajax({
            type: 'POST',
            url: finalURL,	
            data: {extension_name:'provider',TableName:TableName,GroupRecordsetName:GroupRecordsetName,
...
var mappingTableName=(jQuery('#provider_rd1to1').is(':checked'))?'tbl_allcare_provider1to1_fieldmapping':'tbl_allcare_provider1ton_fieldmapping';    
    ...
    $.ajax({
            type: 'POST',
            url: finalURL,	
            data: {extension_name:'provider',mappingTableName:mappingTableName,groupRecordsetName:groupRecordsetName,
                   selectedFields:selectedFields,showYesNo:showYesNo},
