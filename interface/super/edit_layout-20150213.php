...
$layouts = array(
  ...
  'AGENCY' =>xl('Agencies'),
  'USERS' =>xl('User Attributes'),
  'PHA' =>xl('Pharmacy Attributes'),
  'INSUCOMP' =>xl('Insurance Attributes'),
  'ABOOK' =>xl('Addressbook Attributes')
);
...
if ($_POST['formaction'] == "save" && $layout_id) {
    ...
    if (substr($layout_id,0,3) != 'LBF' && $layout_id != "FACUSR") {
      ...
      else if ($layout_id == "ABOOK") { $tablename ="tbl_patientaddressbook"; }
