...
$sql=sqlStatement("insert into incomplete_charts_filter (provider,patient,audit_status,encounter_status,`from`,`to`,facility,visit_category,loginuser,rendering_provider) values('$Provider_val1','$patient_val1','$audit_val1','$enc_val1','$from','$to','$fac_val1','$vc_val1','$loginuser','$rend_provider_val1')");
                                                   ...
                                                   if($field_id=='chief_complaint' || $field_id=='hpi' || $field_id=='assessment_note' || $field_id=='progress_note' || $field_id=='plan_note' ){
                                                      ...
                                                      if($field_id=='chief_complaint' || $field_id=='hpi' || $field_id=='assessment_note' || $field_id=='progress_note' || $field_id=='plan_note' ){
                                                        ...
                                                        if($priority=='Required'){
                                                               ...
                                                               $req_not_started.=$order."<a href='javascript:;' onclick=win1('allcare_enc_forms.php?groupname=$gname&form_id1=0&enc3=$resenc1&pid1=$respid1&inmode1=edit&file_name1=Incomplete_charts&fname1=$resfname3') ><span>".htmlspecialchars( xl($title1), ENT_NOQUOTES)."</span></a><br>";
                                                           
                                                       } else if($priority=='Optional'){
                                                            
                                                             
                                                                $opt_not_started.=$order."<a href='javascript:;' onclick=win1('allcare_enc_forms.php?groupname=$gname&form_id1=0&enc3=$resenc1&pid1=$respid1&inmode1=edit&file_name1=Incomplete_charts&fname1=$resfname3') ><span>".htmlspecialchars( xl($title1), ENT_NOQUOTES)."</span></a><br>";
                                         ...
                                         foreach($sequence1 as $key2 => $val2){
                                            ...
                                            if($field_id5=='history_past' || $field_id5=='family_history' || $field_id5=='family_med_con' || $field_id5=='family_exam_test' || $field_id5=='history_social'){
                                                ...
                                                if($resfname1=='Allcare Encounter Forms' && $allcare=='YES' ){ 
                                                    ...
                                                    $resfname3=str_replace(" ","_",$resfname1);
                                                        if($priority5=='Required'){
                                                           $req_not_started_his.=$order."<a href='javascript:;' onclick=win1('allcare_enc_forms.php?groupname=$gname&form_id1=0&enc3=$resenc1&pid1=$respid1&inmode1=edit&file_name1=Incomplete_charts&fname1=$resfname3') ><span>".htmlspecialchars( xl($title1), ENT_NOQUOTES)."</span></a><br>";
                                                            
                                                        } else if($priority5=='Optional'){
                                                           
                                                           $opt_not_started_his.=$order."<a href='javascript:;' onclick=win1('allcare_enc_forms.php?groupname=$gname&form_id1=0&enc3=$resenc1&pid1=$respid1&inmode1=edit&file_name1=Incomplete_charts&fname1=$resfname3') ><span>".htmlspecialchars( xl($title1), ENT_NOQUOTES)."</span></a><br>";
                                                        } 
                                                  }
                                                        ...
                                                        if($priority5=='Required'){
                                                            if(!empty($field_val5[0])){
                                                                if(in_array('pending',$field_val5) && in_array('finalized',$field_val5)){
                                                                     $fname_comp_his.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
                                                                }
                                                                elseif(in_array('pending',$field_val5) ){

                                                                      $fname_his.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&location=provider_portal&formid=$formid1&id=$fid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
                                                                ...
                                                                $req_not_started_his.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                        }else if($priority5=='Optional'){
                                                            if(!empty($field_val5[0])){
                                                                 if(in_array('finalized',$field_val5) && in_array('pending',$field_val5)){
                                                                      $fname_opt_his_comp.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&location=provider_portal&formid=$formid1&id=$fid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>"; 
                                                                }
                                                                 elseif(in_array('finalized',$field_val5)){
                                                                     ...
                                                                     $fname_opt_his.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
                                                                }
                                                            }
                                                           else {
                                                                $opt_not_started_his.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                        }
                                                     }else{
                                                          if($priority5=='Required'){
                                                            
                                                                $req_not_started_his.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&id=0&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
                                                            
                                                        }else if($priority5=='Optional'){
                                                            
                                                                $opt_not_started_his.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&id=0&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
                                                ...
                                                if(!empty($frow_his)){ 
                                                   ...
                                                   if($priority5=='Required'){ 
                                                        if( strpos('finalized',$qa_stat_res['field_value']) !== false  ){
                                                            $fname_comp_his.=$order."<a href='javascript:;' onclick=win1('allcare_enc_forms.php?pid1=$respid1&enc3=$resenc1&provider=$provider&inmode1=edit&file_name1=Incomplete_charts&form_id1=$qaform_id') ><span>".htmlspecialchars( xl('Quality Of Care'), ENT_NOQUOTES)."</span></a><br>";
                                                        }else if( strpos('pending',$qa_stat_res['field_value']) !== false  ) {
                                                            $fname_his.=$order."<a href='javascript:;' onclick=win1('allcare_enc_forms.php?pid1=$respid1&enc3=$resenc1&provider=$provider&inmode1=edit&file_name1=Incomplete_charts&form_id1=$qaform_id') ><span>".htmlspecialchars( xl('Quality Of Care'), ENT_NOQUOTES)."</span></a><br>";
                                                        }else{
                                                            $req_not_started_his.=$order."<a href='javascript:;' onclick=win1('allcare_enc_forms.php?groupname=$gname&pid1=$respid1&enc3=$resenc1&provider=$provider&inmode1=edit&file_name1=Incomplete_charts&form_id1=$qaform_id') ><span>".htmlspecialchars( xl('Quality Of Care'), ENT_NOQUOTES)."</span></a><br>";
                                                        }
                                                   }else if($priority5=='Optional'){
                                                        if(strpos('finalized',$qa_stat_res['field_value']) !== false){
                                                            $fname_opt_his_comp.=$order."<a href='javascript:;' onclick=win1('allcare_enc_forms.php?groupname=$gname&pid1=$respid1&enc3=$resenc1&provider=$provider&inmode1=edit&file_name1=Incomplete_charts&form_id1=$qaform_id') ><span>".htmlspecialchars( xl('Quality Of Care'), ENT_NOQUOTES)."</span></a><br>";
                                                        }else if( strpos('pending',$qa_stat_res['field_value']) !== false  ) {
                                                            $fname_opt_his.=$order."<a href='javascript:;' onclick=win1('allcare_enc_forms.php?groupname=$gname&pid1=$respid1&enc3=$resenc1&provider=$provider&inmode1=edit&file_name1=Incomplete_charts&form_id1=$qaform_id') ><span>".htmlspecialchars( xl('Quality Of Care'), ENT_NOQUOTES)."</span></a><br>";
                                                        }else{
                                                            $opt_not_started_his.=$order."<a href='javascript:;' onclick=win1('allcare_enc_forms.php?groupname=$gname&pid1=$respid1&enc3=$resenc1&provider=$provider&inmode1=edit&file_name1=Incomplete_charts&form_id1=$qaform_id') ><span>".htmlspecialchars( xl('Quality Of Care'), ENT_NOQUOTES)."</span></a><br>";
                                                        }
                                                   }
                                                }else{
                                                    if($priority5=='Required'){ 
                                                        $req_not_started_his.=$order."<a href='javascript:;' onclick=win1('allcare_enc_forms.php?groupname=$gname&pid1=$respid1&enc3=$resenc1&provider=$provider&inmode1=edit&file_name1=Incomplete_charts&form_id1=0') ><span>".htmlspecialchars( xl('Quality Of Care'), ENT_NOQUOTES)."</span></a><br>";

                                                    }else if($priority5=='Optional'){ 
                                                        $opt_not_started_his.=$order."<a href='javascript:;' onclick=win1('allcare_enc_forms.php?groupname=$gname&pid1=$respid1&enc3=$resenc1&provider=$provider&inmode1=edit&file_name1=Incomplete_charts&form_id1=0') ><span>".htmlspecialchars( xl('Quality Of Care'), ENT_NOQUOTES)."</span></a><br>";
                                                ...
                                                if($fid1!=''){
                                                     if($priority5=='Required'){
                                                        $resid_ros1=sqlStatement("select finalized,pending  from tbl_form_allcare_ros where id  =$fid1  AND pid=$respid1  ORDER BY id DESC");  
                                                          ...
                                                          if($priority5=='Required'){
                                                               ...
                                                               $req_not_started_pre.=$order."<a href='javascript:;' onclick=win1('/interface/forms/allcare_ros/new_custom.php?formname=allcare_ros&encounter=$resenc1&pid=$respid1') ><span>".htmlspecialchars( xl('Allcare Ros'), ENT_NOQUOTES)."</span></a><br>";
                                                            
                                                       
                                                          }else if($priority5=='Optional'){
                                                        
                                                                $opt_not_started_pre.=$order."<a href='javascript:;' onclick=win1('/interface/forms/allcare_ros/new_custom.php?formname=allcare_ros&encounter=$resenc1&pid=$respid1') ><span>".htmlspecialchars( xl('Allcare Ros'), ENT_NOQUOTES)."</span></a><br>";
                                                     ...
                                                     if($fid!=''){
                                                          ...
                                                          if($priority5=='Required'){ 
                                                            ...
                                                            $req_not_started_pre.=$order."<a href='javascript:;' onclick=win1('/interface/forms/allcare_physical_exam/new_custom.php?formname=allcare_physical_exam&edit=custom_pe&encounter=$resenc1&pid=$respid1&menu_val=$menu') ><span>".htmlspecialchars( xl('Allcare Physical_exam'), ENT_NOQUOTES)."</span></a><br>";
                                                                
                                                          }else if($priority5=='Optional'){
                                                            
                                                            $opt_not_started_pre.=$order."<a href='javascript:;' onclick=win1('allcare_physical_exam/new_custom.php?formname=allcare_physical_exam&edit=custom_pe&encounter=$resenc1&pid=$respid1&menu_val=$menu') ><span>".htmlspecialchars( xl('Allcare Physical_exam'), ENT_NOQUOTES)."</span></a><br>";
                                                     ...
                                                     if($fid1!=''){
                                                        if($priority5=='Required'){
                                                         ...
                                                         if($priority5=='Required'){
                                                                ...
                                                                $req_not_started_pre.=$order."<a href='javascript:;' onclick=win1('/interface/forms/vitals/new_custom.php?formname=Vitals&encounter=$resenc1&pid=$respid1&status=$status') ><span>".htmlspecialchars( xl('Vitals'), ENT_NOQUOTES)."</span></a><br>";
                                                            
                                                        }else if($priority5=='Optional'){
                                                           
                                                                $opt_not_started_pre.=$order."<a href='javascript:;' onclick=win1('/interface/forms/vitals/new_custom.php?formname=Vitals&encounter=$resenc1&pid=$respid1&status=$status') ><span>".htmlspecialchars( xl('Vitals'), ENT_NOQUOTES)."</span></a><br>";
                                                         ...
                                                         if($priority5=='Required'){
                                                             if(!empty($field_val[0])){
                                                                 if(in_array('finalized',$field_val) && in_array('pending',$field_val) ){
                                                                  $fname_comp_issue.=$order."<a href='javascript:;' onclick=win1('../patient_file/summary/stats_full_custom.php?active=all&category=$type&encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formid') ><span>".htmlspecialchars( xl($title), ENT_NOQUOTES)."</span></a><br>";
                                                                } 
                                                                elseif(in_array('finalized',$field_val)){
                                                                     ...
                                                                     $fname_issue.=$order."<a href='javascript:;' onclick=win1('../patient_file/summary/stats_full_custom.php?active=all&category=$type&encounter=$resenc1&pid=$respid1&location=provider_portal&formid=$formid') ><span>".htmlspecialchars( xl($title), ENT_NOQUOTES)."</span></a><br>";
                                                                }
                                                             }
                                                            else {
                                                                $req_not_started_issue.=$order."<a href='javascript:;' onclick=win1('../patient_file/summary/stats_full_custom.php?active=all&category=$type&encounter=$resenc1&pid=$respid1&location=provider_portal&formid=$formid') ><span>".htmlspecialchars( xl($title), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                        }else if($priority5=='Optional'){
                                                            if(!empty($field_val[0])){
                                                                if(in_array('finalized',$field_val) && in_array('pending',$field_val)){
                                                                  $fname_opt_issue_comp.=$order."<a href='javascript:;' onclick=win1('../patient_file/summary/stats_full_custom.php?active=all&category=$type&encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formid') ><span>".htmlspecialchars( xl($title), ENT_NOQUOTES)."</span></a><br>"; 
                                                                }
                                                                     ...
                                                                     $fname_opt_issue.=$order."<a href='javascript:;' onclick=win1('../patient_file/summary/stats_full_custom.php?active=all&category=$type&encounter=$resenc1&pid=$respid1&location=provider_portal&formid=$formid') ><span>".htmlspecialchars( xl($title), ENT_NOQUOTES)."</span></a><br>";
                                                                }
                                                            }
                                                            else {
                                                                $opt_not_started_issue.=$order."<a href='javascript:;' onclick=win1('../patient_file/summary/stats_full_custom.php?active=all&category=$type&encounter=$resenc1&pid=$respid1&location=provider_portal&formid=$formid') ><span>".htmlspecialchars( xl($title), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                        }
                                                 ...
                                                 $resid_his=sqlStatement("select *  from billing where  pid=$respid1 AND encounter=$resenc1 AND activity = 1");  
                                                   ...
                                                   if(!empty($frow_his)){
                                                        ...
                                                        if(!empty($frow_his) && $frow_his['billed']==1){
                                                             ...
                                                             $fname_issue.=$order."<a href='javascript:;' onclick=win1('../forms/fee_sheet/feesheet_custom.php?pid=$respid1&encounter=$resenc1') ><span>".htmlspecialchars( xl('Codes'), ENT_NOQUOTES)."</span></a><br>";
                                                        }
                                                    }else if($priority5=='Optional'){
                                                         if(!empty($frow_his) && $frow_his['billed']==1){
                                                             
                                                              $fname_opt_issue_comp.=$order."<a href='javascript:;' onclick=win1('../forms/fee_sheet/feesheet_custom.php?pid=$respid1&encounter=$resenc1') ><span>".htmlspecialchars( xl('Codes'), ENT_NOQUOTES)."</span></a><br>";
                                                        }else {
        
                                                            $fname_opt_issue.=$order."<a href='javascript:;' onclick=win1('../forms/fee_sheet/feesheet_custom.php?pid=$respid1&encounter=$resenc1') ><span>".htmlspecialchars( xl('Codes'), ENT_NOQUOTES)."</span></a><br>";
                                                        }
                                                    }
                                                   }else{
                                                    if($priority5=='Required'){ 
                                                      
                                                             $req_not_started_issue.=$order."<a href='javascript:;' onclick=win1('../forms/fee_sheet/feesheet_custom.php?pid=$respid1&encounter=$resenc1') ><span>".htmlspecialchars( xl('Codes'), ENT_NOQUOTES)."</span></a><br>";
                                                       
                                                    }else if($priority5=='Optional'){
                                                        
        
                                                            $opt_not_started_issue.=$order."<a href='javascript:;' onclick=win1('../forms/fee_sheet/feesheet_custom.php?pid=$respid1&encounter=$resenc1') ><span>".htmlspecialchars( xl('Codes'), ENT_NOQUOTES)."</span></a><br>";
                                                     ...
                                                     if($fid1!=''){
                                                         if($priority5=='Required'){ 
                                                            if(($frow_enc['elec_signedby']!='' && $frow_enc['elec_signed_on']!='' ) && $frow_enc['audited_status'] == 'Completed' ){
                                                                $fname_comp_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/auditform/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1') ><span>".htmlspecialchars( xl('Audit Form'), ENT_NOQUOTES)."</span></a><br>";
                                                            }else{
                                                                  $fname_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/auditform/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1') ><span>".htmlspecialchars( xl('Audit Form'), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                        }else if($priority5=='Optional'){
                                                            if(($frow_enc['elec_signedby']!='' && $frow_enc['elec_signed_on']!='' ) && $frow_enc['audited_status'] == 'Completed' ){
                                                                $fname_opt_issue_comp.=$order."<a href='javascript:;' onclick=win1('/interface/forms/auditform/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1') ><span>".htmlspecialchars( xl('Audit Form'), ENT_NOQUOTES)."</span></a><br>";
                                                            }else{
                                                                  $fname_opt_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/auditform/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1') ><span>".htmlspecialchars( xl('Audit Form'), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                        }
                                                     }else {
                                                         if($priority5=='Required'){ 
                                                                ...
                                                                $fid1=0;
                                                                  $req_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/auditform/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1') ><span>".htmlspecialchars( xl('Audit Form'), ENT_NOQUOTES)."</span></a><br>";
                                                           
                                                        }else if($priority5=='Optional'){
                                                               $fid1=0;
                                                                 $opt_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/auditform/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1') ><span>".htmlspecialchars( xl('Audit Form'), ENT_NOQUOTES)."</span></a><br>";
                                                        ...
                                                        if($priority5=='Required'){
                                                            ...
                                                            if(!empty($field_val6[0])){
                                                                if(in_array('pending',$field_val6) && in_array('finalized',$field_val6)){
                                                                     $fname_comp_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a><br>";
                                                                }
                                                                elseif(in_array('pending',$field_val6) ){

                                                                      $fname_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a><br>";
                                                                ...
                                                                $req_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                        }else if($priority5=='Optional'){
                                                            ...
                                                            if(!empty($field_val6[0])){
                                                                 ...
                                                                 if(in_array('finalized',$field_val6) && in_array('pending',$field_val6)){
                                                                      ...
                                                                      $fname_opt_issue_comp.=$order."<a href='javascript:;' onclick=win1('/interface/forms/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a><br>"; 
                                                                }
                                                                 elseif(in_array('finalized',$field_val6)){
                                                                     ...
                                                                     $fname_opt_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a><br>";
                                                                }
                                                            }
                                                           else {
                                                               
                                                                $opt_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                        }
                                                     }else {
                                                         if($priority5=='Required'){
                                                            
                                                             $req_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=0&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a><br>";
                                                           
                                                        }else if($priority5=='Optional'){
                                                            $opt_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&id=0&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a><br>";
                                                        ...
                                                        if($priority5=='Required'){
                                                            ...
                                                            if(!empty($field_val_ccm[0])){
                                                                if(in_array('pending',$field_val_ccm) && in_array('finalized',$field_val_ccm)){
                                                                     $fname_comp_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid_ccm&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a><br>";
                                                                }
                                                                elseif(in_array('pending',$field_val_ccm) ){

                                                                      $fname_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid_ccm&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a><br>";
                                                                ...
                                                                $req_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid_ccm&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                        }else if($priority5=='Optional'){
                                                            ...
                                                            if(!empty($field_val_ccm[0])){
                                                                 ...
                                                                 if(in_array('finalized',$field_val_ccm) && in_array('pending',$field_val_ccm)){
                                                                      ...
                                                                      $fname_opt_issue_comp.=$order."<a href='javascript:;' onclick=win1('/interface/forms/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid_ccm&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a><br>"; 
                                                                }
                                                                 elseif(in_array('finalized',$field_val_ccm)){
                                                                     ...
                                                                     $fname_opt_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid_ccm&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a><br>";
                                                                }
                                                            }
                                                           else {
                                                               
                                                                $opt_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid_ccm&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a><br>";
                                                            }
                                                        }
                                                     }else {
                                                         if($priority5=='Required'){
                                                            
                                                             $req_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=0&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a><br>";
                                                           
                                                        }else if($priority5=='Optional'){
                                                            $opt_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/ccm/new_custom.php?encounter=$resenc1&pid=$respid1&id=0&location=provider_portal&formid=$formid_ccm') ><span>".htmlspecialchars( xl('CCM'), ENT_NOQUOTES)."</span></a><br>";
                                        ...
                                        <td>
                                          <?php
                                            ...
                                            <td><input type='text' name='form_to_date' id="form_to_date"
                                                    ...
                                                    border='0' alt='[?]' style='cursor: pointer'
                                                    title='<?php xl('Click here to choose a date','e'); ?>'></td>
                                     </tr><tr> <td class='bold' nowrap><?php xl('Facility','e'); ?>:</td>
