...
if($group_name1!=''){
	...
	print "<tr class='showborder_head'><th style='width=10px;'>&nbsp;</th><th style='width=10px;'>&nbsp;</th><th style='width=10px;'>&nbsp;</th><th style='width=10px;'>&nbsp;</th><th style='width=10px;'>&nbsp;</th><th style='width:500px;'>Type</th><th style='width:10px;'>Date</th><th>Date Of Service</th>";
...
//                        }
    ...
    while($frow2 = sqlFetchArray($labels)) {
            ...
            if($i==1){
                print "<tr class='showborder_head'><th style='width=10px;'>&nbsp;</th><th style='width=10px;'>&nbsp;</th><th style='width=10px;'>&nbsp;</th><th style='width=10px;'>&nbsp;</th><th style='width=10px;'>&nbsp;</th><th style='width:10px;'>Type</th><th style='width:10px;'>Group</th><th style='width:10px;'>Date</th><th style='width:10px;'>Date Of Service</th>";
