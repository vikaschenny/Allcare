...
$sql=sqlStatement("insert into incomplete_charts_filter (provider,patient,audit_status,encounter_status,`from`,`to`,facility,visit_category) values('$loginuser','$patient_val1','$audit_val1','$enc_val1','$from','$to','$fac_val1','$vc_val1')");
 
} else{
    $sql1=sqlStatement("select * from incomplete_charts_filter where provider='$loginuser' order by id desc");
                                                   ...
                                                   if($field_id=='chief_complaint' || $field_id=='hpi' || $field_id=='assessment_note' || $field_id=='progress_note' || $field_id=='plan_note' ){
                                                        ...
                                                        if($priority=='Required'){
                                                            ...
                                                            $ra = sqlStatement("select field_value from lbf_data  where field_id LIKE  '%$field_id1%'  AND form_id='".$resid1."'");
                                                             ...
                                                             if(!in_array('finalized',$a1) || empty($frowa) ){
                                                ...
                                                if($field_id5=='history_past'){
                                                    ...
                                                    $grp_stat='History_Social';
                                                         ...
                                                         if($priority5=='Required'){ 
                                                            if(in_array('finalized',$field_val1)){
                                                                 $finalized+=1;
                                         ...
                                         foreach($sequence3 as $keys => $values){
                                             ...
                                             if($field_id5=='ros'){
                                                     if($priority5=='Required'){
                                                        ...
                                                        if($fid1!=''){
                                                             ...
                                                             if($ros='YES'  && $frow_ros1['finalized']=='NO'){
                                                     ...
                                                     if($fid!=''){
                                                          ...
                                                          if($priority5=='Required'){ 
                                                        if($pe='YES' && $frow_pe1['pending']=='Y' && $frow_pe1['finalized']=='N'){
                                             ...
                                             //vitals 
                                                  ...
                                                  $resid_vt=sqlStatement("select *  from forms where form_name  ='Vitals' AND encounter=$resenc1 AND pid=$respid1  AND deleted=0 ORDER BY id DESC");  
                                                     ...
                                                     if($fid1!=''){
                                                        if($priority5=='Required'){ 
                                                            if(!in_array('finalized',$field_val2) ){
                                            ...
                                            if($field_id5=='medical_problem' || $field_id5=='allergies' || $field_id5=='medication' || $field_id5=='surgeries' || $field_id5=='dental_problems'){
                                                   if($field_id5=='medical_problem'){
                                                     ...
                                                     if(!empty($frow_res)){
                                                         ...
                                                         if($priority5=='Required'){ 
                                                            if(in_array('finalized',$field_val)){
                                                           ...
                                                           $sql_form=sqlStatement("select max(form_id)as new_form from forms where form_name='Allcare Encounter Forms' AND formdir='LBF2'");
                                                            ...
                                                            $row1_form=sqlFetchArray($ins_form);
                                                             $res1=sqlstatement("select * from lbf_data lb INNER JOIN layout_options l ON l.field_id=lb.field_id where lb.form_id='$new_id1' AND l.form_id='LBF2' AND l.group_name LIKE '%$gname%' AND lb.field_id LIKE '%$fieldid%' order by seq");
                                                             $res_row1=sqlFetchArray($res1);
                                                             $field_val=explode("|",$res_row1['field_value']);
                                                             if($priority5=='Required'){ 
                                                                if(in_array('finalized',$field_val)){
                                                                      ...
                                                                      $fname_comp_issue.=$order."<a href='javascript:;' onclick=win1('../patient_file/summary/stats_full_custom.php?active=all&category=$type&encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&provider=$provider&formid=$new_id1') ><span>".htmlspecialchars( xl($title), ENT_NOQUOTES)."</span></a><br>";

                                                                }else if(!in_array('finalized',$field_val) ) {


                                                                     $fname_issue.=$order."<a href='javascript:;' onclick=win1('../patient_file/summary/stats_full_custom.php?active=all&category=$type&encounter=$resenc1&pid=$respid1&location=provider_portal&provider=$provider&formid=$new_id1') ><span>".htmlspecialchars( xl($title), ENT_NOQUOTES)."</span></a><br>";
                                                                }
                                                            }else if($priority5=='Optional'){
                                                                 if(in_array('finalized',$field_val)){

                                                                      $fname_opt_issue_comp.=$order."<a href='javascript:;' onclick=win1('../patient_file/summary/stats_full_custom.php?active=all&category=$type&encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&provider=$provider&formid=$new_id1') ><span>".htmlspecialchars( xl($title), ENT_NOQUOTES)."</span></a><br>"; 
                                                                }else if(!in_array('finalized',$field_val) ){


                                                                     $fname_opt_issue.=$order."<a href='javascript:;' onclick=win1('../patient_file/summary/stats_full_custom.php?active=all&category=$type&encounter=$resenc1&pid=$respid1&location=provider_portal&provider=$provider&formid=$new_id1') ><span>".htmlspecialchars( xl($title), ENT_NOQUOTES)."</span></a><br>";
                                                                }
                                                            }
                                                     }
                                                    ...
                                                    $ins_form=sqlStatement("INSERT INTO  forms (date,encounter,form_name,form_id,pid,user,groupname,authorized,deleted,formdir) VALUES (NOW(),$resenc1,'Allcare Encounter Forms',$new_id1,$respid1,'$_SESSION[authUser]','default',1,0,'LBF2')");
                                                    $row1_form=sqlFetchArray($ins_form); 
                                                    $res1=sqlstatement("select * from lbf_data lb INNER JOIN layout_options l ON l.field_id=lb.field_id where lb.form_id='$new_id1' AND l.form_id='LBF2' AND l.group_name LIKE '%Immunization%' AND lb.field_id LIKE 'immunization_stat' order by seq");
                                                     $res_row1=sqlFetchArray($res1);
                                                     $field_val=explode("|",$res_row1['field_value']);
                                                     if($priority5=='Required'){ 
                                                        if(in_array('finalized',$field_val)){
                                                            
                                                             $fname_comp_issue.=$order."<a href='javascript:;' onclick=win1('/interface/patient_file/summary/immunizations_custom.php?pid=$respid1&form_id=$new_id1&encounter=$resenc1') ><span>".htmlspecialchars( xl('Immunizations'), ENT_NOQUOTES)."</span></a><br>";
                                                         }else if(!in_array('finalized',$field_val) ){
        
                                                            $fname_issue.=$order."<a href='javascript:;' onclick=win1('/interface/patient_file/summary/immunizations_custom.php?pid=$respid1&form_id=$new_id1&encounter=$resenc1') ><span>".htmlspecialchars( xl('Immunizations'), ENT_NOQUOTES)."</span></a><br>";
                                                        }
                                                    }else if($priority5=='Optional'){
                                                         if(in_array('finalized',$field_val)){
                                                               
                                                              $fname_opt_issue_comp.=$order."<a href='javascript:;' onclick=win1('/interface/patient_file/summary/immunizations_custom.php?pid=$respid1&form_id=$new_id1&encounter=$resenc1') ><span>".htmlspecialchars( xl('Immunizations'), ENT_NOQUOTES)."</span></a><br>";
                                                        }else if(!in_array('finalized',$field_val) ){
        
                                                             $fname_opt_issue.=$order."<a href='javascript:;' onclick=win1('/interface/patient_file/summary/immunizations_custom.php?pid=$respid1&form_id=$new_id1&encounter=$resenc1') ><span>".htmlspecialchars( xl('Immunizations'), ENT_NOQUOTES)."</span></a><br>";
                                                        }
                                                    }     
                                                 }
...
//                                             $i++;
                                               ...
                                               $resid_vt1=sqlStatement("select *  from forms where form_name  ='Procedure Order' AND encounter=$resenc1 AND pid=$respid1  AND deleted=0 ORDER BY id DESC");  
                                                     ...
                                                     if($fid1!=''){
                                                        ...
                                                        if($priority5=='Required'){ 
                                                            if(!in_array('finalized',$field_val5) ){
                                                        ...
                                                        $ins_form=sqlStatement("INSERT INTO  forms (date,encounter,form_name,form_id,pid,user,groupname,authorized,deleted,formdir) VALUES (NOW(),$resenc1,'Allcare Encounter Forms',$new_id1,$respid1,'$_SESSION[authUser]','default',1,0,'LBF2')");
                                                        $row1_form=sqlFetchArray($ins_form);
                                                        $res1=sqlstatement("select * from lbf_data lb INNER JOIN layout_options l ON l.field_id=lb.field_id where lb.form_id='$new_id1' AND l.form_id='LBF2' AND l.group_name LIKE '%PProcedure%' AND lb.field_id LIKE 'procedure_stat' order by seq");
                                                         $res_row1=sqlFetchArray($res1);
                                                         $field_val5=explode("|",$res_row1['field_value']);
                                                         if($fid1!=''){
                                                            ...
                                                            if($priority5=='Required'){ 
                                                                if(!in_array('finalized',$field_val5) ){
                                                                      ...
                                                                      $fname_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&formid=$new_id1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";

                                                                }else if(in_array('finalized',$field_val5)) {


                                                                    $fname_comp_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&formid=$new_id1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
                                                                }
                                                            }else if($priority5=='Optional'){
                                                                 if(in_array('finalized',$field_val5)){

                                                                      $fname_opt_issue_comp.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&formid=$new_id1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";

                                                                }else if(!in_array('finalized',$field_val5)){

                                                                     $fname_opt_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&formid=$new_id1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
                                                                }
                                                            }
                                                         }
