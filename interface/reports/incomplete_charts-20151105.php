...
//                                                                     $fname_comp_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
//                                                                }
//                                                                elseif(in_array('pending',$field_val5) ){
//
//                                                                      $fname_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
//
...
//                                                            }
//                                                            else {
//                                                                $req_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
//                                                            }
//                                                        }else if($priority5=='Optional'){
//                                                            if(!empty($field_val5)){
//                                                                 if(in_array('finalized',$field_val5) && in_array('pending',$field_val5)){
//                                                                      $fname_opt_issue_comp.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>"; 
//                                                                }
...
//
//                                                                     $fname_opt_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
//                                                                }
//                                                            }
//                                                           else {
//                                                                $opt_not_started_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&id=$fid1&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
//                                                            }
//                                                        }
//                                                     }
//                                             }       
...
//                                                         $formids=0;
//                                                     }
//                                                   //  echo "select * from lbf_data lb INNER JOIN layout_options l ON l.field_id=lb.field_id where lb.form_id='$formid1' AND l.form_id='LBF2' AND l.group_name LIKE '%CPO%' AND lb.field_id LIKE '_stat' order by seq";
...
//
//                                                                      $fname_issue.=$order."<a href='javascript:;' onclick=win1('/interface/forms/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a><br>";
//
...
//                                                                     
//                                                                      $fname_opt_issue_comp.=$order."<a href='javascript:;' onclick=win1('/interface/forms/cpo/new_custom.php?encounter=$resenc1&pid=$respid1&location=provider_portal&formid=$formids') ><span>".htmlspecialchars( xl('CPO'), ENT_NOQUOTES)."</span></a><br>"; 
//                                                                }
