                   ...
                   if(!empty($frow_his)){ 
                      ...
                      if($priority5=='Required'){ 
                           if( strpos('finalized',$qa_stat_res['field_value']) !== false  ){
                               $fname_comp_his.=$order."<a href='javascript:;' onclick=win1('allcare_enc_forms.php?pid1=$respid1&enc3=$resenc1&provider=$provider&inmode1=edit&file_name1=Incomplete_charts&form_id1=$qaform_id') ><span>".htmlspecialchars( xl('Quality Of Care'), ENT_NOQUOTES)."</span></a>,";
                           }else if( strpos('pending',$qa_stat_res['field_value']) !== false  ) {
                               $fname_his.=$order."<a href='javascript:;' onclick=win1('allcare_enc_forms.php?pid1=$respid1&enc3=$resenc1&provider=$provider&inmode1=edit&file_name1=Incomplete_charts&form_id1=$qaform_id') ><span>".htmlspecialchars( xl('Quality Of Care'), ENT_NOQUOTES)."</span></a>,";
                           }else{
...
//                                                                    echo "<tr height='25'>";
                                                                    if($result1['encounter'] == $_REQUEST['encounter']){
                                                                        ...
                                                                        <style type="text/css">
                                                                        tr.encountercell td {
                                                                                background-color: #A6F8F3; color: black;
                                                                        }
                                                                        </style>
                                                                        <?php
                                                                    }else{
