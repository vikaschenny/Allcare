                                                        ...
                                                        if($priority5=='Required'){
                                                            if(!empty($field_val5[0])){
                                                                ...
                                                                elseif(in_array('pending',$field_val5) ){
                                                                      ...
                                                                      $fname_his.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>";
                                                            ...
                                                            if(!empty($field_val5[0])){
                                                                 if(in_array('finalized',$field_val5) && in_array('pending',$field_val5)){
                                                                      $fname_opt_his_comp.=$order."<a href='javascript:;' onclick=win1('/interface/forms/procedure_order/new_custom.php?encounter=$resenc1&pid=$respid1&location=provider_portal&formid=$formid1') ><span>".htmlspecialchars( xl('Procedure Order'), ENT_NOQUOTES)."</span></a><br>"; 
                                                                }
