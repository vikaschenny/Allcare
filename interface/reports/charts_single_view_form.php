...
//                                alert(encounter+"="+pid+"="+type+"="+form_id+"="+string_label+"="+field_val);
        ...
        $('.newwindow a').click(function(evt){evt.preventDefault();});
    ...
    function win1(target){
        var url = $(target).attr("href");
        var popup = window.open(url,'singleviewpop','width=900,height=500,scrollbars=yes,resizable=yes');
...
<!--    <div class="section-header">
        <h4><b> <?php// xl("Encounter Forms Single Page View", "e" )?></b></h4>
    </div>-->
    <?php
//    echo "<div id='info'><b>Patient Name: </b>".$res_row1['pname']."<br>";
...
//    echo "</div>";
    ...
    for($j=0; $j< count($sequence); $j++){
        ...
        if($group == 'quality_of_care' || $group == 'hpi' || $group == 'chief_complaint' || $group == 'progress_note' || $group == 'plan_note' || $group == 'assessment_note' || $group == 'cert_recert' || $group == 'face2face'){
            ...
            echo "<div class='newwindow' id='$grouptitle'><a href='../patient_file/summary/stats_full_custom.php?active=all&category=$grouptitle&encounter=$encounter&pid=$pid&formid=$lbf_form_id&isSingleView=1&isFromCharts=$isFromCharts' onclick=win1(this) ><span>". ucwords(str_replace("_"," ",$group))."</span></a></div>";
        ...
        <?php    
            ...
            echo "<div class='newwindow' id='$group'><a href='/interface/forms/$group/new_custom.php?encounter=$encounter&pid=$pid&id=$static_form_id".$checkstring."&isSingleView=1&isFromCharts=$isFromCharts' onclick=win1(this) ><span>". ucwords(str_replace("_"," ",$group))."</span></a></div>";
            
        }else if($group == 'codes'){
            echo "<div class='newwindow' id='$group'><a href='../forms/fee_sheet/feesheet_custom.php?pid=$pid&encounter=$encounter&isSingleView=1&isFromCharts=$isFromCharts' onclick=win1(this) ><span>". ucwords(str_replace("_"," ",$group))."</span></a></div>";
        }else if($group == 'ros'){
            $group = "allcare_ros";
            ...
            echo "<div class='newwindow' id='$group'><a href='/interface/forms/$group/view_custom.php?formname=$group&encounter=$encounter&pid=$pid&id=$ros_form_id&isSingleView=1&isFromCharts=$isFromCharts' onclick=win1(this) ><span>".$form_name."</span></a></div>";
            ...
            echo "<div class='newwindow' id='$group'><a href='/interface/forms/$group/new_custom.php?formname=$group&edit=custom_pe&encounter=$encounter&pid=$pid&id=$allcare_physical_exam_form_id&menu_val=&isSingleView=1&isFromCharts=$isFromCharts' onclick=win1(this) ><span>". ucwords(str_replace("_"," ",$group))."</span></a></div>";
            ...
            echo "<div class='newwindow' id='$group'><a href='/interface/forms/$group/view_custom.php?formname=$formname&encounter=$encounter&pid=$pid&id=$vitals_form_id&&status=$status&isSingleView=1&isFromCharts=$isFromCharts' onclick=win1(this) ><span>". ucwords(str_replace("_"," ",$group))."</span></a></div>";
        }
//        else{
