...
//
  ...
  //echo $form_id;
    ...
    if($groupname1 == 'Certification_Recertification')
...
//echo "SELECT * FROM layout_options " .
...
{  
  ...
  if ($GLOBALS['concurrent_layout']) {
    ...
    window.opener.location.href = 'incomplete_charts.php?encounter=$ecounter';</script>";
   
  }
  else{
//   echo "<script>window.close();
//
//    window.opener.location.href = 'incomplete_charts.php?encounter=".$ecounter."#".$ecounter."';</script>";
    echo "<script>window.close();
...
<br>
    <?php  
                ...
                echo "<tr><td style='border:0 !important'><b>Patient Name: </b>".$res_row1['pname']."</td><td>&nbsp;</td><td style='border:0 !important'><b>Encounter: </b>".$res_row1['encounter']."</td></tr>";
