...
{  
  ...
  if ($GLOBALS['concurrent_layout']) {
    ...
    window.opener.location.href = 'incomplete_charts.php';</script>";
   ...
   echo "<script>window.close();
    ...
    window.opener.location.href = 'incomplete_charts.php';</script>";
    //$body_onload_code = "javascript:parent.Layout-Based Visit Forms.location.href='incomplete_charts.php';";
  }
}
