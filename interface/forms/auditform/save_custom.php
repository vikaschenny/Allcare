...
//    $finalized = $_POST['finalized'];
    ...
    if($lbf_formid == 0):
            $array2[] = array( 'authuser' =>$_SESSION["authUser"],'Status' => $status,'date' => date("Y/m/d"), 'action'=>'updated','ip_address'=>$ip_addr.'(Incomplete Charts Audit Form)' ,'audit_note' => $_REQUEST['form_audit_note'],'audit_date'=>$auditdate ,'count'=> $count+1);
