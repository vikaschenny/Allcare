...
class allcare_FormROS extends ORDataObject {
	...
	var $use_of_antideprassants = "N/A";
        ...
        var $changes_in_sleep_habits = "N/A";
	...
	function allcare_FormROS($id= "",$pid1, $location ,$provider,$encounter, $isSingleView,$isFromCharts,$_prefix = ""){
                //print_r($_POST);
		...
		$this->pid = $pid1;
                ...
                $this->isFromCharts = $isFromCharts;
		if ($id != "") {
        ...
        function get_isSingleView() {
		return $this->isSingleView;
	}
        function get_isFromCharts() {
	...
	function set_obstruction($data){
        ...
        function get_blurry_vision(){
		return $this->blurry_vision;
	}
	function set_blurry_vision($data){
		if(!empty($data)){
			$this->blurry_vision = $data;
		}
	}
        function get_ent(){
		return $this->ent;
	...
	function set_change_in_nature_of_urine($data){
        ...
        function get_kidney_failure(){
		return $this->kidney_failure;
	}
	function set_kidney_failure($data){
		if(!empty($data)){
			$this->kidney_failure = $data;
		}
	}
	...
	function set_changes_in_mentation($data){
        ...
        function get_tingling(){
		return $this->tingling;
	}
	function set_tingling($data){
            if(!empty($data)){
                    $this->tingling = $data;
            }
	}
        function get_burning_sensation(){
		return $this->burning_sensation;
	}
	function set_burning_sensation($data){
            if(!empty($data)){
                    $this->burning_sensation = $data;
            }
	}
	...
	function set_itching($data){
        ...
        function get_lesions(){
		return $this->lesions;
	}
	function set_lesions($data){
            if(!empty($data)){
                    $this->lesions = $data;
            }
	}
	...
	function set_thought_content($data){
        ...
        function get_changes_in_sleep_habits(){
		return $this->changes_in_sleep_habits;
	}
	function set_changes_in_sleep_habits($data){
            if(!empty($data)){
                    $this->changes_in_sleep_habits = $data;
            }
	}
	...
	function set_excessive_hunger($data){
        ...
        function get_polydipsia(){
		return $this->polydipsia;
	}
	function set_polydipsia($data){
            if(!empty($data)){
                    $this->polydipsia = $data;
            }
	}
        function get_polyphagia(){
		return $this->polyphagia;
	}
	function set_polyphagia($data){
            if(!empty($data)){
                    $this->polyphagia = $data;
            }
	}
        function get_cirrhosis(){
		return $this->cirrhosis;
	}
	function set_cirrhosis($data){
            if(!empty($data)){
                    $this->cirrhosis = $data;
            }
	}
