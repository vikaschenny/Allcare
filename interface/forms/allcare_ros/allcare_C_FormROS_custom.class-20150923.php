...
class allcare_C_FormROS1 extends Controller {
	...
	var $template_dir;
        ...
        function default_action1($enc,$pid1,$id1) {
	...
	function view_action1($form_id,$pid1) {
		
		if (is_numeric($form_id)) {
    		$ros = new allcare_FormROS($form_id,$pid1);
    	}
    	else {
    		$ros = new allcare_FormROS(0,$pid1);
    	}
	...
	function default_action_process1() {
		...
		$this->allcareros = new allcare_FormROS($_POST['id1'],$_POST['pid']);//print_r($_POST);
...
//		}
		...
		if(empty($_POST['id1']))
		{
			addForm($_POST['encounter'], "Allcare Review Of Systems", $this->allcareros->id, "allcare_ros", $_POST['pid'], $_SESSION['userauthorized']);
			$_POST['process'] = "";
