...
class allcare_FormROS extends ORDataObject {
	...
	var $arthritis = "N/A";
        var $gout = "N/A";
        var $range_of_motion = "N/A";
	var $paraesthesia = "N/A";
        var $spasms = "N/A";
	...
	function set_intolerance($data){
        ...
        function get_appetite(){
		return $this->appetite;
	}
	function set_appetite($data){
		if(!empty($data)){
			$this->appetite = $data;
		}
	}
	...
	function set_dental_difficulties($data){
        ...
        function get_dentures(){
		return $this->dentures;
	}
	function set_dentures($data){
		if(!empty($data)){
			$this->dentures = $data;
		}
	}
	...
	function set_back_pain($data){
        ...
        function get_range_of_motion(){
		return $this->range_of_motion;
	}
	function set_range_of_motion($data){
		if(!empty($data)){
			$this->range_of_motion = $data;
		}
	}
        function get_paraesthesia(){
		return $this->paraesthesia;
	}
	function set_paraesthesia($data){
		if(!empty($data)){
			$this->paraesthesia = $data;
		}
	}
	function get_loc(){
		return $this->loc;
	...
	function get_radio_options(){
		$ret = array("Normal" => xl('Normal'),"Not Examined" => xl('Not Examined/Select Details'));
		return $ret;
	}	
...
//        }
	...
	function set_blood_in_stool($data){
        ...
        function get_trouble_swallowing(){
		return $this->trouble_swallowing;
	}
	function set_trouble_swallowing($data){
		if(!empty($data)){
			$this->trouble_swallowing = $data;
		}
	}
