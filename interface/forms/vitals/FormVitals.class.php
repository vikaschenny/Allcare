...
class FormVitals extends ORDataObject {
	...
	function FormVitals($id= "",$pending,$finalized, $_prefix = "")	{
            
               $sql=sqlStatement("select date from form_encounter where pid='".$GLOBALS['pid']."' and encounter='".$GLOBALS['encounter']."'");
