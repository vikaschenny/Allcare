...
function previewpost(){
   ...
   // top.restoreSession();
    location.href = '../../forms/cpo/print.php?'+datastring;
}
...
echo "<form method='post' name='my_form' id='my_form'" .
  "action='$rootdir/forms/cpo/save_custom.php?id=" . attr($formid) ."&encounter=".$_REQUEST['encounter']."&isSingleView=$isSingleView&isFromCharts=$isFromCharts'>\n";
