    ...
    if (! $_POST['form_refresh']) {
       if($_REQUEST['isSingleView'] == 1 && $isFromCharts == 0){
            echo "<script>window.close();
                window.opener.location.href = '../../reports/single_view_form.php?encounter=$encounter&pid=$pid1';</script>";
            ...
            #window.opener.location.href = '../../reports/patient_full_encounters_single_view.php?encounter=$encounter&pid=$pid1';</script>
        }else{
            echo "<script>window.close();
...
<script language="JavaScript">
    ...
    function updateopner(){
        //alert("call");
      //window.opener.datafromchildwindow(<?php echo $formid; ?>);
    }
</script>
    ...
    <body class="body_top">
        <?php   if($_REQUEST['isSingleView'] == 1)
                    ...
                    $isSingleView = 0;
        ?>
        <form method="post" action="<?php echo $rootdir ?>/forms/allcare_physical_exam/new_custom.php?encounter=<?php echo $encounter; ?>&pid=<?php echo $pid1; ?>&id=<?php echo $formid; ?>&location=<?php echo $location; ?>&provider=<?php echo $provider; ?>&menu_val=<?php echo $menu; ?>&isSingleView=<?php echo $isSingleView; ?>&isFromCharts=<?php echo $isFromCharts; ?>"
