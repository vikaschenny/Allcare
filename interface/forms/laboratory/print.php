 ...
 *  @uses laboratory/report.php
 * 
 *************************************************************************** */
require_once("../../globals.php");
include_once("{$GLOBALS['incdir']}/forms/laboratory/report.php");
...
$id = $_REQUEST['id'];
if (!$id) die ("FATAL ERROR: missing form identifier!!");
$pid = $_REQUEST['pid'];
...
<html>
	...
	<body class="wmtPrint">
		...
		<?php laboratory_report($pid, $encounter, '*', $id); ?>
	</body>
</html>