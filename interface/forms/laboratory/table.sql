--
-- Table structure for table `form_laboratory`
--
CREATE TABLE IF NOT EXISTS `form_laboratory` (
  ...
  `lab_namespace` varchar(255) DEFAULT NULL,
  `pat_pubpid` varchar(32) DEFAULT NULL,
  `pat_namespace` varchar(255) DEFAULT NULL,
  `pat_id_type` varchar(32) DEFAULT NULL,
  `pat_fname` varchar(255) DEFAULT NULL,
  `pat_mname` varchar(255) DEFAULT NULL,
  `pat_lname` varchar(255) DEFAULT NULL,
  `pat_suffix` varchar(32) DEFAULT NULL,
  `pat_title` varchar(32) DEFAULT NULL,
  `pat_DOB` date DEFAULT NULL COMMENT 'used in result matching',
  `pat_race` varchar(32) DEFAULT NULL,
  `pat_ethnicity` varchar(32) DEFAULT NULL,
  ...
  `doc_suffix` varchar(32) DEFAULT NULL,
  `doc_title` varchar(32) DEFAULT NULL,
  `doc_name_type` varchar(32) DEFAULT NULL,
  `doc_id_type` varchar(32) DEFAULT NULL,
  `ins_primary` bigint(20) DEFAULT '0',
  `ins_secondary` bigint(20) DEFAULT '0',
  `diagnoses` text,
  `order_number` varchar(225) NOT NULL,
  `order_namespace` varchar(255) DEFAULT NULL,
