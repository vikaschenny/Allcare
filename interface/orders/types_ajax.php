...
// WMT - exclude lab related information
...
//  "ORDER BY seq, name, procedure_type_id");
	...
	$query .= "WHERE parent = '$id' AND ( (pp.type != 'internal' AND pp.type != 'laboratory' AND pp.type != 'quest' AND pp.type != 'labcorp') OR pp.type IS NULL ) ";
