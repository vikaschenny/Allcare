...
function validate(f) {
  ...
  msg += "\n<?php echo htmlspecialchars(xl('Please fill them in before continuing.'),ENT_QUOTES); ?>";
   ...
   if($("#selectFacility").val()!=0)
 {
     if($("#admitdate").val()=='')
         {
             alert("Please enter Admin Date");
             $("#admitdate").addClass("redclass");
             return false;
         }
 }
 
 
 if($("#selectagency").val()!=0)
 {
     if($("#orgadmitdate").val()=='' )
         {
             alert("Please enter Admin Date");
             $("#orgadmitdate").addClass("redclass");
             return false;
         }
 }
  if ( errMsgs.length > 0 ) {
...
<?php
  ...
  // Created POS div 
  echo "<br /><span class='bold'><input type='checkbox' name='form_cb_facility' value='1' " .
    "onclick='return divclick(this,\"div_8\");'";
  if ($display_style == 'block') echo " checked";
  echo " /><b>" . xl('Patient\'s (POS Specific) Attributes') . "</b></span>\n";
  echo "<div id='div_8' class='section' style='display:$display_style;'>\n";
  
  echo "<table border=0><tr><td width=20% align=left class='fontbold'>POS Type :</td>";
  echo "<td align='left'>";  
  ...
  $POS1to1qry =  sqlStatement($POS1to1Sql);
    ...
    echo "<br/><div id='divResponse'></div>";
   
           
               
echo "</div>";

echo "<br /><span class='bold'><input type='checkbox' name='form_cb_pos' value='1' " .
    "onclick='return divclick(this,\"div_9\");'";
if ($display_style == 'block') echo " checked";
  echo " /><b>" . xl('Service Facility') . "</b></span>\n";
  

echo "<div id='div_9' class='section' style='display:$display_style;'>\n";
?>
 <table cellpadding="10" cellspacing="0" width="60%" id="tblFacility"><tbody>
            <?php
               $fres = sqlStatement("select id,name from facility order by name");
                if ($fres) {
                  ...
                  while ($frow = sqlFetchArray($fres))
                   ...
                   echo "<td> 
                       <input type='text' size='16' id='admitdate'   name='admitdate'  placeholder='yyyy-mm-dd' value='' onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc)' title='yyyy-mm-dd' required>
...
echo "<br /><span class='bold'><input type='checkbox' name='form_cb_pos2' value='1' " .
    "onclick='return divclick(this,\"div_10\");'";
if ($display_style == 'block') echo " checked";
  echo " /><b>" . xl('Agencies') . "</b></span>\n";
  

echo "<div id='div_10' class='section' style='display:$display_style;'>\n";
?>
 <table cellpadding="10" cellspacing="0" width="60%" id="tblagency"><tbody>
            <?php
