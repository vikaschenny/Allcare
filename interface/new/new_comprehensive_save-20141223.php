...
{ 
    ...
    echo $AgencySql="update tbl_patientagency set 
    ...
    {
     echo $AgencySql = "insert into tbl_patientagency(patientid,agencyid,admitdate,dischargedate,isactive,createdby,createddate,notes,related_links) 
