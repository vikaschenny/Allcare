...
<?php
  ...
  echo "<table border=0><tr><td width=25% align=left class='fontbold'>Patient's Attribute Type :</td>";
  echo "<td align='left'>";  
  echo "<select name='lstPOS' id='lstPOS' style='width:250px;' onchange='return showMapping(this.value);'>"
  . "<option value=0>- Patient's Attribute Type -</option>";
...
group by fg.Recordset_ID,fg.Field_ID";
  $outerPOSSql = "SELECT pt.id,pt.title from tbl_pos_types pt 
                                INNER JOIN tbl_allcare_patients1ton_fieldmapping fg ON fg.POS_id=pt.id
                                group by pt.title order by pt.title";
           ...
           echo "<ul id='posnavigation' class='treeview-gray treeview'>";
           while ($outerPOSrow = sqlFetchArray($outerPOSqry)) 
                {
                
                echo  "<li class='expandable'><div class='hitarea expandable-hitarea'></div><span><b>POS : ".$outerPOSrow['title']."</b></span>";
...
group by fg.Recordset_ID";
           ...
           echo "<li class='collapsable'><div class='hitarea collapsable-hitarea'></div><span class=''><b>Recordset : ".$mostinnerRecordsetrow['Recordset_Name']."</b></span>";
...
group by fg.Recordset_ID,fg.Field_ID order by pt.title ";
  	 ...
  	 //   echo "<li><span>".$innerRecordsetrow['Field_Name']."</span></li>";
                  echo "<li><span>";
                  echo "<table><tr><td width=40% align=right>$textboxname :</td>";
