    ...
    while($POS1tonRes = sqlFetchArray($showRecordsetQry)) 
         {
            ...
            echo "</tr>";
            echo "<tr><td align=right>";?>  <a href='javascript:void(0);' onclick="javascript:addtablerow('tbl<?php echo $POS1tonRes['Recordset_ID'];?>','<?php echo $POS1tonRes['Recordset_ID'];?>');">Add</a></td></tr>
            <?php echo "<tr><td>";
