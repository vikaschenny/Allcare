...
require_once("$srcdir/classes/CouchDB.class.php");
    ...
    echo "</select>";    */
     ...
     echo "<div id='insurance_divFields' name='insurance_divFields' style='border:1px SOLID #000;height:150px;width:300px;overflow-y:scroll;'>";
    ...
    {        
        ...
        echo "<tr>
                <td id='".$allcarerows['Field']."'>
                    <input type='checkbox' id='insurance_chkbox_".$allcarerows['Field']."' name='insurance_chkAllFields' value='".$allcarerows['Field']."'>
                </td>
                <td>
                    <label for='insurance_chkbox_".$allcarerows['Field']."'>".$allcarerows['Field']."</label>
                </td>
              </tr>";    
