  ...
  foreach ($grparr as $fldid => $fldarr) {
   if ( $_GET['mode'] != "user" || ($_GET['mode'] == "user" && in_array($fldid, $USER_SPECIFIC_GLOBALS)) ) {
    ...
    if (is_array($fldtype)) {
      ...
      include_once('manage_new_fields.php');            
      
    }
    
    
    else if ($fldtype == 'global_address_book') {
      if ($_GET['mode'] == "user") {
        $globalTitle = $globalValue;
      }
      ...
      include_once('manage_address_book.php');           
      
    }
    
        else if ($fldtype == 'global_schedulling') {
      if ($_GET['mode'] == "user") {
        $globalTitle = $globalValue;
      }
      ...
      include_once('manage_patient_query.php');           
      
    }
    
    
    else if ($fldtype == 'global_insurance') {
      if ($_GET['mode'] == "user") {
        $globalTitle = $globalValue;
      }
      ...
      include_once('manage_insurance.php');           
      
    }
    
    
    else if ($fldtype == 'global_pharmacy') {
      if ($_GET['mode'] == "user") {
        $globalTitle = $globalValue;
      }
      ...
      include_once('manage_pharmacy.php');           
      
    }
    
    
    else if ($fldtype == 'global_provider') {
      if ($_GET['mode'] == "user") {
        $globalTitle = $globalValue;
      }
