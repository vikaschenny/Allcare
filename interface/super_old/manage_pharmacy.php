...
function pharmacy_newEvt(selectedBox)
{
     ...
     {
  dlgopen('pharmacy_get_table_fields.php?table_name='+document.getElementById(selectedBox).value+'&selectedBox='+selectedBox,
   '_blank', 550, 270);
     }
  return false;
}
...
{
        var finalURL='pharmacy_add_new_fields.php';  
...
{
    var finalURL='pharmacy_show_groups_recordsets.php';  
...
{                         
        var finalURL='pharmacy_show_fields.php';  
...
{
        var finalURL='pharmacy_show_fields_by_groups_recordsets.php';  
        //var table_name=jQuery("#pharmacy_rd1to1").is(":checked")?'tbl_allcare_pharmacy1to1_fieldmapping':'tbl_allcare_pharmacy1ton_fieldmapping';
...
{               
        var finalURL='pharmacy_edit_group_recordset.php';
...
{
    var finalURL='pharmacy_insert_in_mapping.php';                  
