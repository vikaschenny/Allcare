...
function insurance_newEvt(selectedBox)
{
     ...
     {
  dlgopen('insurance_get_table_fields.php?table_name='+document.getElementById(selectedBox).value+'&selectedBox='+selectedBox,
   '_blank', 550, 270);
     }
  return false;
}
...
function insurance_validateStep2()
{
...
//    else if(jQuery('#insurance_txtGroupRecordset').val()==='')
//    {
//        alert("Please enter the Group/Recordset name");
//        return false;
//    }
//    
//    else if(!jQuery('#insurance_comboFields').val())
//    {
...
{
        var finalURL='insurance_add_new_fields.php';  
...
{
    var finalURL='insurance_show_groups_recordsets.php';  
...
{                         
        var finalURL='insurance_show_fields.php';  
...
{
        var finalURL='insurance_show_fields_by_groups_recordsets.php';  
        //var table_name=jQuery("#insurance_rd1to1").is(":checked")?'tbl_allcare_insurance1to1_fieldmapping':'tbl_allcare_insurance1ton_fieldmapping';
...
{               
        var finalURL='insurance_edit_group_recordset.php';
...
{
    var finalURL='insurance_insert_in_mapping.php';                  
