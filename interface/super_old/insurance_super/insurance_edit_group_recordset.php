...
$GR_ID=($table_name=='tbl_allcare_insurance1to1_fieldmapping') ? 'Grouping_ID' : 'Recordset_ID';
$table_ID=($table_name=='tbl_allcare_insurance1to1_fieldmapping') ? 1 : 2;
$GR=($table_name=='tbl_allcare_insurance1to1_fieldmapping') ? 'Group' : 'Recordset';
...
{           
    ...
    $sql ="INSERT INTO $table_name(POS_id,$GR_ID,$GR_name,Table_ID,Field_ID,isVisible,Created_Date,Updated_Date)
           VALUES('',$GRid,'$group_recordset_name',$table_ID,".$getFieldId['field_ID'].",'$showYesNo','$GRcreatedDate',now())";
