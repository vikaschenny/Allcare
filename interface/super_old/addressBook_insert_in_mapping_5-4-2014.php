...
{            
    ...
    if($mappingTableName=='tbl_allcare_addressbook1to1_fieldmapping')    
    {
        ...
        $sql ="INSERT INTO $mappingTableName(POS_id,Grouping_ID,Grouping_Name,Table_ID,Field_ID,isVisible,Created_Date)
    ...
    else if($mappingTableName=='tbl_allcare_addressbook1ton_fieldmapping') 
    {
        ...
        $sql ="INSERT INTO $mappingTableName(POS_id,Recordset_ID,Recordset_Name,Table_ID,Field_ID,isVisible,Created_Date)
