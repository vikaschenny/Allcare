...
$GR_ID=($table_name=='tbl_allcare_provider1to1_fieldmapping') ? 'Grouping_ID' : 'Recordset_ID';
$table_ID=($table_name=='tbl_allcare_provider1to1_fieldmapping') ? 1 : 2;
$GR=($table_name=='tbl_allcare_provider1to1_fieldmapping') ? 'Group' : 'Recordset';
