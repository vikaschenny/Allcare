    ...
    <!--            <input type='submit' id='btnSave' name='btnSave' value='Save' />-->
                <input type='button' id='btnSave' name='btnSave' value='Save' 
                       onclick='javascript: 
                                            ...
                                            if(jQuery("#comboGroupsRecordsets").val()==="none" && jQuery("#txtGroupRecordset").val()==="")
                                            {
...
function validateStep2(mapping_flag)
{
    ...
    if(mapping_flag===0)
    {
        checked_fields=document.getElementsByName("chkSelectedFields");        
    }
    else if(mapping_flag===1)
    {
        checked_fields=document.getElementsByName("chkAllFields");        
    }    
...
function validateDataTypes()
{
    ...
    {                 
        if(jQuery('#txtFieldName'+i).val()!=='' && jQuery('#data_types'+i).val()!=='')
        {
            ...
            {
                if(jQuery('#txtDataLength'+i).val()===''  && 
                   jQuery('#txtDataLength'+i).attr('readonly')===true)   //  isNaN(jQuery('#txtDataLength'+i).val())
                {
...
function validateDefaultValues()
{
    for(var i=0;i<20;i++)
    {
        if(jQuery('#txtFieldName'+i).val()!=='')
        {
            ...
            var dataLength=jQuery('#txtDataLength'+i).val();
...
function checkDataType()
{
    for(var i=0;i<20;i++)
    {
        ...
        jQuery('#boolFieldRequired'+i).prop('disabled','');
        jQuery('#txtDefaultValue'+i).prop('disabled','');
        jQuery('#txtDataLength'+i).prop('readonly','');
