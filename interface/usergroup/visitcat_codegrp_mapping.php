...
<script type="text/javascript">
    $(document).ready(function() {
                ...
                $("#codeoption_9PQRS").hide();
                $("#codeoption_ACounseling").hide();
                $("#codeoption_BVaccine").hide();
                $("#codeoption_CVisit_secondary").hide();
              ...
              $("select#codegroups-post").on('change', function () {
               if ($(this).val() == "1Out Patient New Patient") {
                ...
                $("#codeoption_7H\\&P").hide();                
                $("#codeoption_8IPPE").hide();
                $("#codeoption_9PQRS").show();
                $("#codeoption_ACounseling").hide();
                $("#codeoption_BVaccine").hide();
                $("#codeoption_CVisit_secondary").hide();
                
               }else if ($(this).val() == "ACounseling") {
                 $("#codeoption_1Out_Patient_New_Patient").hide();
                $("#codeoption_2Out_Patient_Established_Patient").hide();
                $("#codeoption_3CPO").hide();
                $("#codeoption_4Tests\\/Exams").hide();
                ...
                $("#codeoption_8IPPE").hide();
                $("#codeoption_9PQRS").hide();
                $("#codeoption_ACounseling").show();
                $("#codeoption_BVaccine").hide();
                $("#codeoption_CVisit_secondary").hide();
                
               }else if ($(this).val() == "BVaccine") {
                 $("#codeoption_1Out_Patient_New_Patient").hide();
                $("#codeoption_2Out_Patient_Established_Patient").hide();
                $("#codeoption_3CPO").hide();
                $("#codeoption_4Tests\\/Exams").hide();
                ...
                $("#codeoption_9PQRS").hide();
                $("#codeoption_ACounseling").hide();
                $("#codeoption_BVaccine").show();
                $("#codeoption_CVisit_secondary").hide();
                
               }else if ($(this).val() == "CVisit_secondary") {
                 $("#codeoption_1Out_Patient_New_Patient").hide();
                $("#codeoption_2Out_Patient_Established_Patient").hide();
                $("#codeoption_3CPO").hide();
                $("#codeoption_4Tests\\/Exams").hide();
                ...
                $("#codeoption_ACounseling").hide();
                $("#codeoption_BVaccine").hide();
                $("#codeoption_CVisit_secondary").show();
