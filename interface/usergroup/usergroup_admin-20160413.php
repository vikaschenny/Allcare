...
?>
    ...
    function showPopOver(target){
        ...
        if($self.val() == ""){
            ...
            var $selectpharma = $self.parents("tr").find('td:first-child  a');
            $self.parents('td').find(".newwindowicon").html("<a href='#' class='show-pop-async popoverph'  title='Click to see Template' data-placement='right-bottom'><i class='glyphicon glyphicon-new-window'></i></a>");
