...
$widgetTitle = xl("Users Custom Attributes");
$widgetLabel = "users";
$widgetButtonLabel = xl("Edit");
$widgetButtonLink = "users_full_1to1.php?uid1=$id";
$widgetButtonClass = "";
$linkMethod = "html";
$bodyClass = "";
...
?>
         <div id="Users_custom_attributes" >
          <ul class="tabNav">
          ...
          <div class="tabContainer" style="height:200px; overflow-y:scroll; background-color:#FFFFFF;">
           <?php display_layout_tabs_data('UCA', $result, $result2); ?>
          </div>
         </div>
