...
<div id="addressbook_list">
    <div>
       <table>
	  <tr>
                <td><a href="addrbook_attr_dropdown_1to1.php" class="css_button"><span><?php xl('Add Addressbook Custom Attributes','e'); ?></span></a></td>
		<td><a href="abook_contacts_1ton.php?userid=<?php echo $userid; ?>" class="css_button"><span><?php xl('Addressbook Contacts','e'); ?></span></a>
		</td>
                <td><a href="abook_cred_1ton.php?userid=<?php echo $userid; ?>" class="css_button"><span><?php xl('Addressbook Credentials','e'); ?></span></a>
		</td>
   	  </tr>
	</table>
    </div>
