...
<?php
 ...
 $uni_user=sqlStatement("select users from tbl_allcare_facuservisit where screen_group='".$screengroups."'");
        ...
        <?php
            while($row = sqlFetchArray($fuvRows)):
               ...
               /* $screenames=substr($row['screen_names'], 1);*/
                ...
                $f_res4 = sqlStatement("select title, description from `layout_options` WHERE group_name LIKE '%".$screengroup."%'");
                $f_arr5 = array();
