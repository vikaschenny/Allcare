...
if ($result = getAbookDatabyUserid($abookuserid)) {
	...
	echo "<tr height='25'><td>";
        print "<a href='abook_contact.php?abookuserid=$abookuserid&id=".htmlspecialchars( $iter{"id"}, ENT_NOQUOTES).
                "&inmode=edit' onclick='addresbooktable(event,this,\"Address Book Contacts\")' class='css_button_small'><span>".
        ...
        if (acl_check('admin', 'super')) {
                echo "<a href='../patient_file/deleter.php?abookcontactid=".
                        ...
                        "' onclick='deleteaddressbookrow(event,this,\"abookcontactid\")' class='css_button_small'><span>".
        ...
        foreach($field_id as $attr){
            $fres2=sqlStatement("SELECT data_type FROM layout_options WHERE form_id = 'ABOOKCONTACT' AND uor > 0 AND field_id = '$attr'");
