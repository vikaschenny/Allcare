...
require_once("$srcdir/facilities_custom_attr.inc.php");
  ...
  //echo $id;
 //$id=1;
 $result=getFacilityCustomAttr($id);
 ?>
<html>
...
$widgetTitle = xl("Facility Custom Attributes");
$widgetLabel = "users";
$widgetButtonLabel = xl("Edit");
$widgetButtonLink = "facilities_full_1to1.php?facilityid=$id";
$widgetButtonClass = "";
$linkMethod = "html";
$bodyClass = "";
...
?>
         <div id="Facilities_custom_attributes" >
          <ul class="tabNav">
          ...
          <div class="tabContainer" style="height:200px; overflow-y:scroll; background-color:#FFFFFF;">
           <?php display_layout_tabs_data('FCA', $result, $result2); ?>
          </div>
         </div>
