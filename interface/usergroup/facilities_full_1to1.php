...
/*$id=$_REQUEST['id'];
echo $id;*/
$result  = getFacilityCustomAttr($facilityid);
...
<?php generate_layout_validation('FCA'); ?>
...
<body class="body_top">
<form action='facilities_save_1to1.php?facilityid=<?php echo htmlspecialchars( $facilityid, ENT_QUOTES); ?>' name='facilities_form' method='post' onsubmit='return validate(this)'>
<input type='hidden' name='mode' value='save' />
<input type='hidden' name='db_facilityid' value="<?php echo $facilityid?>" />
...
<table cellpadding='0' cellspacing='0' border='0'>
	<tr>
		...
		<td>
			<a href="facilities_dropdown_1to1.php"  class='css_button' onclick="top.restoreSession()">
...
<br>
  <div class="section-header">
   <span class="text"><b> <?php xl("Facility Custom Attributes", "e" )?></b></span>
</div>

<div id="facility_custom_attr" >

	<ul class="tabNav">
	   <?php display_layout_tabs('FCA', $result, $result2); ?>
	</ul>

	<div class="tabContainer"style="height: 300px;background:#FFF; overflow-y: scroll; width: 80%;">
		<?php display_layout_tabs_data_editable('FCA', $result, $result2); ?>
	</div>
</div>
<br>
 </form>
