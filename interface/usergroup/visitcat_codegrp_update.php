...
//    echo "SELECT * FROM  tbl_allcare_vistcat_codegrp WHERE    code_groups='".$codegrps."' AND  code_options='".$codegrpopt."' AND facility='".$facilities."' AND visit_category='".$visitcat."'";
    if($facilities != ""  && $visitcat != "" && $codegrps != "" && $codegrpopt != ""):
        ...
        if(sqlNumRows($result) > 0 ):
            ...
            $updateQuery = "UPDATE tbl_allcare_vistcat_codegrp SET facility = '". $facilities ."',visit_category= '". $visitcat ."',code_groups= '". $codegrps ."', code_options= '". $codegrpopt ."' WHERE id=".$fuvid;
