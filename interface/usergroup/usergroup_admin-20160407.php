...
//echo "<script>alert('actvar usergroup_admin===".$_POST["active"]."');</script>";
$alertmsg = '';
$bg_msg = '';
$set_active_msg=0;
$show_message=0;
...
if (isset($_POST["mode"])) 
{
  if ($_POST["mode"] == "new_user") 
  {
    ...
    $sign_img='';
    if(move_uploaded_file($_FILES['imgSignature']['tmp_name'],"../pic/user_sign/".$_FILES['imgSignature']['name']))
    {
        $sign_img=$_FILES['imgSignature']['name'];
    }
