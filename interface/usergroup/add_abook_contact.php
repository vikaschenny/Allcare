...
<body class="body_top">
    ...
    <tr>
        ...
        <td>
            ...
            <!-- Define CSS Buttons -->
            <a href="abook_contact.php?abookuserid=<?php echo $abookuserid; ?> " <?php if (!$GLOBALS['concurrent_layout']) echo "target='Main'"; ?> class="css_button" onclick="addresbooktable(event,this,'Address Book Contacts')">
