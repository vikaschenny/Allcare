...
if(addressbooktype=="add")
   window.parent.hidepenal(["save",addressbooknumber,"abook_cred_list"]);
	...
	<table>
	    <tr>
            <td>
             ...
             <td>
                 <a href="abook_cred_1ton.php?abookuserid=<?php echo $abookuserid; ?>"  <?php if (!$GLOBALS['concurrent_layout']) echo "target='Main'"; ?> class="css_button" onclick="canceladd(event)" >
