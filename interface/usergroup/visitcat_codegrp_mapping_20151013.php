...
<script type="text/javascript">
    $(document).ready(function() {
                ...
                $("#codeoption_3SNF_New_Patient").hide();
                $("#codeoption_4SNF_Established_Patient").hide();
                $("#codeoption_5Hospital_New_Patient").hide();                
                $("#codeoption_6Hosital_Established_Patient").hide();
                $("#codeoption_7Domicilary_New_Patient").hide();
                $("#codeoption_8Domicilary_Established_Patient").hide();
                $("#codeoption_9CPO").hide();
                $("#codeoption_ATests\\/Exams").hide();
                $("#codeoption_BAWV").hide();
                $("#codeoption_CCCM").hide();
                $("#codeoption_DPreventive_New_Patient").hide();
                $("#codeoption_EPreventive_Established_Patient").hide();
              ...
              $("select#codegroups-post").on('change', function () {
               if ($(this).val() == "1Out Patient New Patient") {
               ...
               } else if ($(this).val() == "3SNF New Patient") {
                 $("#codeoption_1Out_Patient_New_Patient").hide();
                $("#codeoption_2Out_Patient_Established_Patient").hide();
                $("#codeoption_3SNF_New_Patient").show();
                $("#codeoption_4SNF_Established_Patient").hide();
                $("#codeoption_5Hospital_New_Patient").hide();                
                $("#codeoption_6Hosital_Established_Patient").hide();
                $("#codeoption_7Domicilary_New_Patient").hide();
               ...
               else if ($(this).val() == "4SNF Established Patient") {
                 $("#codeoption_1Out_Patient_New_Patient").hide();
                $("#codeoption_2Out_Patient_Established_Patient").hide();
                $("#codeoption_3SNF_New_Patient").hide();
                $("#codeoption_4SNF_Established_Patient").show();
                $("#codeoption_5Hospital_New_Patient").hide();                
                $("#codeoption_6Hosital_Established_Patient").hide();
                $("#codeoption_7Domicilary_New_Patient").hide();
                $("#codeoption_8Domicilary_Established_Patient").hide();
                ...
                else if ($(this).val() == "5Hospital New Patient") {
                 $("#codeoption_1Out_Patient_New_Patient").hide();
                $("#codeoption_2Out_Patient_Established_Patient").hide();
                $("#codeoption_3SNF_New_Patient").hide();
                $("#codeoption_4SNF_Established_Patient").hide();
                $("#codeoption_5Hospital_New_Patient").show();                
                $("#codeoption_6Hosital_Established_Patient").hide();
                $("#codeoption_7Domicilary_New_Patient").hide();
                $("#codeoption_8Domicilary_Established_Patient").hide();
                $("#codeoption_9CPO").hide();
               ...
               else if ($(this).val() == "6Hosital Established Patient") {
                 $("#codeoption_1Out_Patient_New_Patient").hide();
                $("#codeoption_2Out_Patient_Established_Patient").hide();
                $("#codeoption_3SNF_New_Patient").hide();
                $("#codeoption_4SNF_Established_Patient").hide();
                $("#codeoption_5Hospital_New_Patient").hide();                
                $("#codeoption_6Hosital_Established_Patient").show();
                $("#codeoption_7Domicilary_New_Patient").hide();
                $("#codeoption_8Domicilary_Established_Patient").hide();
                $("#codeoption_9CPO").hide();
                $("#codeoption_ATests\\/Exams").hide();
               ...
               else if ($(this).val() == "7Domicilary New Patient") {
                 $("#codeoption_1Out_Patient_New_Patient").hide();
                $("#codeoption_2Out_Patient_Established_Patient").hide();
                $("#codeoption_3SNF_New_Patient").hide();
                $("#codeoption_4SNF_Established_Patient").hide();
                $("#codeoption_5Hospital_New_Patient").hide();                
                $("#codeoption_6Hosital_Established_Patient").hide();
                $("#codeoption_7Domicilary_New_Patient").show();
                $("#codeoption_8Domicilary_Established_Patient").hide();
                $("#codeoption_9CPO").hide();
                $("#codeoption_ATests\\/Exams").hide();
                $("#codeoption_BAWV").hide();
               ...
               else if ($(this).val() == "8Domicilary Established Patient") {
                 $("#codeoption_1Out_Patient_New_Patient").hide();
                $("#codeoption_2Out_Patient_Established_Patient").hide();
                $("#codeoption_3SNF_New_Patient").hide();
                $("#codeoption_4SNF_Established_Patient").hide();
                ...
                $("#codeoption_6Hosital_Established_Patient").hide();
                $("#codeoption_7Domicilary_New_Patient").hide();
                $("#codeoption_8Domicilary_Established_Patient").show();
                $("#codeoption_9CPO").hide();
                $("#codeoption_ATests\\/Exams").hide();
                $("#codeoption_BAWV").hide();
                $("#codeoption_CCCM").hide();
                ...
                $("#codeoption_8Domicilary_Established_Patient").hide();
                $("#codeoption_9CPO").hide();
                $("#codeoption_ATests\\/Exams").show();
                $("#codeoption_BAWV").hide();
                $("#codeoption_CCCM").hide();
                $("#codeoption_DPreventive_New_Patient").hide();
                $("#codeoption_EPreventive_Established_Patient").hide(); 
               }
               else if ($(this).val() == "BAWV") {
                 $("#codeoption_1Out_Patient_New_Patient").hide();
                $("#codeoption_2Out_Patient_Established_Patient").hide();
                $("#codeoption_3SNF_New_Patient").hide();
                $("#codeoption_4SNF_Established_Patient").hide();
                ...
                $("#codeoption_9CPO").hide();
                $("#codeoption_ATests\\/Exams").hide();
                $("#codeoption_BAWV").show();
                $("#codeoption_CCCM").hide();
                $("#codeoption_DPreventive_New_Patient").hide();
                $("#codeoption_EPreventive_Established_Patient").hide(); 
               }
               else if ($(this).val() == "CCCM") {
                 $("#codeoption_1Out_Patient_New_Patient").hide();
                $("#codeoption_2Out_Patient_Established_Patient").hide();
                $("#codeoption_3SNF_New_Patient").hide();
                $("#codeoption_4SNF_Established_Patient").hide();
                ...
                $("#codeoption_ATests\\/Exams").hide();
                $("#codeoption_BAWV").hide();
                $("#codeoption_CCCM").show();
                $("#codeoption_DPreventive_New_Patient").hide();
                $("#codeoption_EPreventive_Established_Patient").hide(); 
               }
               else if ($(this).val() == "DPreventive New Patient") {
                 $("#codeoption_1Out_Patient_New_Patient").hide();
                $("#codeoption_2Out_Patient_Established_Patient").hide();
                $("#codeoption_3SNF_New_Patient").hide();
                $("#codeoption_4SNF_Established_Patient").hide();
                ...
                $("#codeoption_BAWV").hide();
                $("#codeoption_CCCM").hide();
                $("#codeoption_DPreventive_New_Patient").show();
                $("#codeoption_EPreventive_Established_Patient").hide(); 
               }
               else if ($(this).val() == "EPreventive Established Patient") {
                 $("#codeoption_1Out_Patient_New_Patient").hide();
                $("#codeoption_2Out_Patient_Established_Patient").hide();
                $("#codeoption_3SNF_New_Patient").hide();
                $("#codeoption_4SNF_Established_Patient").hide();
                ...
                $("#codeoption_CCCM").hide();
                $("#codeoption_DPreventive_New_Patient").hide();
                $("#codeoption_EPreventive_Established_Patient").show(); 
               }
            });
