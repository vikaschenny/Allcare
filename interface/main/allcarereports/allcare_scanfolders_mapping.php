...
if($_POST['deleteid'] != ""){
        $deleteQuery = "DELETE FROM tbl_allcare_scanfolders WHERE id = ".$_POST['deleteid'];
        sqlStatement($deleteQuery);
}elseif($_POST['drive_folder']!=''){
            ...
            $(document).ready(function(){
                ...
                $('#tkt_status').multiselect({
                 ...
                 $('#editusergroup').on("show.bs.modal", function(event){
                    ...
                    var url = "allcare_scan_folders_edit.php?id="+target.data("href");
                ...
                $("#save").click(function(e) {
                       ...
                       e.preventDefault();
                        ...
                        $.ajax({
                                    type: 'POST',
                                    url: "allcare_scanfolders_mapping.php",	
                                    data: {
    ...
    <body style="background-color:#FFEBD7; padding:30px;" class="container">
        <form class="foldersMapping" name="foldersMapping" id="foldersMapping"  action="" method="POST">
             <div class="form-group" >
                <div class="row">
                    <label class="col-sm-2 control-label">Drive Folders</label>
                    <div  class="col-sm-4">
            ...
            <div class="form-group" >
                <div class="row">
<!--                    <label class="col-sm-2 control-label">Ticket Product</label>
                    <div  class="col-sm-4">
                        <select name="tkt_product" id="tkt_product">
                            <option value="">please Select</option>
                            <?php
                             $sql_status=sqlStatement("select * from list_options where list_id='AllcareCustomProductType'");
...
<!--                        <input type="submit" name="save1" id="save1" value="submit"/>-->
    ...
    <tbody>
        <?php
            $sql1=sqlStatement("select * from tbl_allcare_scanfolders");
            while($row = sqlFetchArray($sql1)):
               ...
               //to get group type
                ...
                $lrow1=sqlFetchArray($list1);
                 ...
                 $list=sqlStatement("select * from list_options where list_id='AllcareScanDriveFolders' and option_id='$scan_folder'");
