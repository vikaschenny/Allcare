...
$insertQuerySet=sqlStatement($sqlInsertQuerySet);
   ...
   $due_appt=$_POST['due_appt'];
   $rend_provider1=$_POST['rend_provider'];
   $rend_provider=rtrim($rend_provider1," ");
   $appt_stat1=$_POST['appt_stat'];
   $appt_stat=rtrim($appt_stat1," ");
   $practitioner1=$_POST['practitioner'];
   $practitioner=rtrim($practitioner1," ");
    
     $sqlInsertQuerySet="INSERT INTO tbl_allcarereports_querysets
    (screen,setname,facility,from_date,to_date,details,selected_fields,visit_type,patient_list,due_appt,rend_provider,appt_stat,practitioner)
    VALUES('$screen','$querySetName', '$facility1_enc','$from_dt','$to_date','$details','$appt_selected_fields1','$visit_type',$patient_list,'$due_appt','$rend_provider','$appt_stat','$practitioner')";
