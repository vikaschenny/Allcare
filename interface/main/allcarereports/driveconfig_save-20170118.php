...
if($providerfolder!='' || $patientfolder!='' || $patientfile!='' || $insfolder!='' || $facfolder!='' || $phfolder!=''){
      ...
      if(empty($sel_row)){
            ...
            $sql=sqlStatement("insert into tbl_drivesync_authentication (date,email,status,user,patient_folder,
                                ...
                                ins_folder_trigger,pharmacy_folder_trigger,addrbk_folder_trigger,
                    ...
                    . "         '".$orgfolder."','".$org_query."','".$autotriggerr."','".$practice."','$insautotriggerr','$phautotriggerr','$addrautotriggerr',"
                    . "         '$facautotriggerr','$userautotriggerr','$psubfolder','$prosubfolder','$inssubfolder','$phsubfolder',"
                    . "         '$addrsubfolder','$facsubfolder')");
      }else {
          //To remove folders id's of each individual object when parent folder is changed
