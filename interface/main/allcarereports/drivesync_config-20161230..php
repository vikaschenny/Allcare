...
//        $redirect ="http://qa2allcare.texashousecalls.com/interface/main/allcarereports/drivesync_config.php";
...
//                        $curl = curl_init();
//                        $form_url = "http://devint.coopsuite.com/DriveSync/oauth/$email_id";
...
//                        curl_close($curl); ?>
                     <script type="text/javascript">
                         ...
                         if(auth==''){
                              window.location.href = "http://"+'<?php echo $_SERVER['HTTP_HOST']; ?>'+"/api/DriveSync/oauth2/"+'<?php echo $email_id; ?>';
                         }else {
                            window.location.href ="//"+'<?php echo $_SERVER['HTTP_HOST']; ?>'+"/interface/main/allcarereports/drivesync_auth.php?status=1&email=<?php echo $email_id; ?>";
                         }
