            ...
            foreach($form as $key => $value){ 
               ...
               $display_style = 'none';
                ...
                foreach($group_name as $group){
                    ...
                    if((substr($group, 1)!='History Past'  && substr($group, 1)!='Family History Medical Conditi' && substr($group, 1)!='Family History Exam Test' && substr($group, 1)!='Codes' && substr($group, 1)!='History Social' ) && (substr($group, 1)!='Family History'  || $key != 'LBF2'))  {
                        if(substr($group, 1)!='Audit Form'){
                            ...
                            if(substr($cgroup, 1)=='Home Health' || substr($cgroup, 1) == 'Payer Audit') {
                                ...
                                <?php 
                                if(substr($group, 1)!='Audit Form'){
                                    if(in_array(substr($group1,1), array('Vitals', 'Medical-Problems', 'Allergies', 'Surgeries', 'Medication', 'Dental-Problems','DME','Prescription','Procedure'))){
                                        ?>    
                            ...
                            if(substr($group, 1)!='Audit Form'){
                                ...
                                if(in_array(substr($group1,1), array('Vitals', 'Medical-Problems', 'Allergies', 'Surgeries', 'Medication', 'Dental-Problems','DME','Prescription', 'Immunization','Procedure'))){
                                ?>    
                                <label>Layout Type:</label> 
