...
function display_db_query($query_string) {
	...
	print("<table border='1' id='patient_enc' class='display'>\n");
...
function display_db_table($fromdate,$todate) {
        $query_string = "CALL Patient_Encounter('$fromdate','$todate')";
...
<?php
display_db_table($fromdate,$todate);
?>
