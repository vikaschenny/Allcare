					...
					document.theform.submit();
                        ...
                        function validate_elig(pid,form_id,month_value)
                        {
                            ...
                            else
                            {
                                ...
                                var form_apptstatus = [];
                                $.each($("#form_apptstatus option:selected"), function(){            
                                    form_apptstatus.push(encodeURIComponent("'"+$(this).val()+"'"));
                                });
                                //alert("elig-verify.php?from="+from+"&to="+to+"&facility="+facility+"&provider="+provider+"&removedrows="+removedrows+"&form_x12="+form_x12+"&pid="+pid+"&form_apptstatus="+form_apptstatus);
                                ...
                                if(pid != ''){
                                    ...
                                    if ($("."+class_name_checkbox).is(':checked') == false) {
                                        window.open("elig-verify.php?from="+from+"&to="+to+"&facility="+facility+"&provider="+provider+"&removedrows="+removedrows+"&form_x12="+form_x12+"&pid="+pid+"&form_apptstatus="+form_apptstatus, "", "width=700, height=600,scrollbars=1,resizable=1");
                                    }
                                    ...
                                    window.open("elig-verify.php?from="+from+"&to="+to+"&facility="+facility+"&provider="+provider+"&removedrows="+removedrows+"&form_x12="+form_x12+"&pid="+pid+"&form_apptstatus="+form_apptstatus, "", "width=880, height=600,scrollbars=1,resizable=1");
                                }
                            }
                        }
