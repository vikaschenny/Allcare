...
<html>
                    ...
                    e.preventDefault();
                        ...
                        $.ajax({
                            ...
                            success: function(response)
                            {
                                ...
                                window.parent.updatedatatable([towner,ttype,tpriority,tstatus]);
    ...
    <body style="background-color:#FFEBD7; padding:30px;" class="container">
        <?php 
            $sql1=sqlStatement("select * from tbl_allcare_document_mapping where id=".$_REQUEST['id']);
        ...
        <form class="foldersMapping" name="foldersMapping" id="foldersMapping"  action="" method="POST">
             ...
             <div class="form-group" >
                <div class="row">
                    <label  class="col-xs-4 control-label ">Ticket owner</label>
                     <div class="col-xs-8" style="display: inline-block;">
            ...
            <div class="form-group" >
                <div class="row">
                    <label  class="col-xs-4 control-label ">Ticket priority</label>
                    <div class="col-xs-8" style="display: inline-block;">
            ...
            <div class="form-group" >
                <div class="row">
                    <label  class="col-xs-4 control-label ">Ticket Status</label>
                    <div class="col-xs-8" style="display: inline-block;">
