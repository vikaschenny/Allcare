 ...
 */
 ...
 $primary_docs = array(
  ...
  'arp' => array(xl('Reports')  , 0, 'main/allcarereports/patientreports.php'),
  'art' => array(xl('Transactions')  , 0, 'main/allcarereports/transactions.php'),   
  'alp' => array(xl('Logs')  , 0, 'main/allcarereports/patientlogs.php'),   
...
<?php } else { // not athletic team ?>
  ...
  <li><a class="collapsed" id="arpimg" ><span><?php xl('AllCare','e') ?></span></a>
      <ul>
          <li><?php genTreeLink('RTop','arp',xl('Reports')); ?></li>
          <li><?php genTreeLink('RTop','art',xl('Transactions')); ?></li>
          <li><?php genTreeLink('RTop','alp',xl('Logs')); ?></li>
      </ul>
  </li>    
  <?php genTreeLink('RBot','msg',xl('Messages')); ?> 
