...
<?php } ?>
 ...
 <tr><td></td>
     <td><input type="checkbox" onchange="fnShowHide(3)">Show/hide Appointment Date</td>
 </tr> 
 <tr><td></td>
     <td><input type="checkbox" onchange="fnShowHide(4)">Show/hide Billing Note</td>
 </tr>
</table>
...
//if ($_POST['form_search'] || $_POST['form_print']) {
  ...
  if ($INTEGRATED_AR) {
    ...
    $query = "SELECT DISTINCT f.encounter, f.id, f.pid, f.date,f.billing_note, " .
      ...
      "WHERE $where $payerClause $insuranceClause $faciltyClause " .
