...
<script src="//maps.googleapis.com/maps/api/js?v=3&key=AIzaSyCzLfZ_qAqcFD_6m-WPm-bcEp6fR5bGdLs&sensor=false&libraries=places" type="text/javascript"></script>
<!--<script src="//maps.googleapis.com/maps/api/js?v=3&sensor=false&libraries=places" type="text/javascript"></script>-->
