    ...
    while ($rowQueries = sqlFetchArray($getQueries)) 
    {
      echo "<option value='" . $rowQueries['name'] . "'>".$rowQueries['name']."</option>";
        ...
        <div>
            ...
            <div class="divSelect">
                <select id='selectVisitTp' class="btn btn-default" style="text-align:left;" onChange="javascript:changeStatuslabel(this);showPatients('Y')">
        ...
        <div>
            ...
            <div class="divSelect">
                <select id='selectPatientsL' class="btn btn-default" style="text-align:left;" onChange="javascript:showPatients('Y')">
