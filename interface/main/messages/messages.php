...
if ($noteid) {
    ...
    // WMT -- added to prevent corruption of lab links
    if (strpos($body,'link_submit') === false) 
  ...
  function addtolist(sel){
    ...
    <input type=hidden name=task value=delete>
        ...
        while ($myrow = sqlFetchArray($result)) {
            ...
            $patient = $myrow['pid'];
            // WMT - modified to exclude "orphan" patients
            if ($patient > 0 && ($patient < 999999990 || $patient > 999999999)) {
