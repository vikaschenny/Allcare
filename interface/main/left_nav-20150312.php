 ...
 */
 ...
 $primary_docs = array(
  ...
  'arp' => array(xl('AllCare Reports')  , 0, 'main/allcarereports/patientreports.php'),
...
$(document).ready(function(){
  if(3 == <?php echo $GLOBALS['concurrent_layout'] ?>){
    ...
    $("#navigation-slide > li  > a#arp0").prepend('<img src="../../images/reports.png" class="nav-menu-img" />');
...
<?php } else { // not athletic team ?>
  ...
  <?php genTreeLink('RTop','arp',xl('AllCare Reports')); ?>
  <?php genTreeLink('RBot','msg',xl('Messages')); ?> 
