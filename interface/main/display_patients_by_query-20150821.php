   ...
   <div id="hd">
      <a onclick="javascript:jQuery('#example_wrapper').toggle(500);
       ...
       style="cursor:pointer;">
           <label id="lblHide1"><b>Hide</b></label>
       </a>
       ...
       style="cursor:pointer;">
           <label id="lblShow1" style="display:none;"><b>Show</b></label>
       </a>
    </div>
    <?php
...
//                  ".$phone_home.$phone_biz.$phone_contact.$phone_cell."</td>";
        ...
        while($rowTemp2=sqlFetchArray($showTemp2))
        {
            ...
            echo "<input type='hidden' id='hdnDetailsBack_$j' name='hdnDetailsBack' 
                  value=\"".$fname." ".$lname."-<br>".$street.$city.$state." ".$postal_code.$country_code."<br>".$phone_home.$phone_biz.$phone_contact.$phone_cell."<br />Appointment Date: ".$openAppdate."\" />
