...
<!--                    <tr><td><b>Primary insurance:</b><input type="text" name="provider" id="provider" value="<?php echo $company2['name']; ?>" class="text-line"/></td></tr>-->
                    ...
                    <tr><td><b>Medicare #:</b><input type="text" name="medicare" id="medicare" value="<?php echo $company2['policy_number']; ?>" class="text-line"/></td><td><b>Medicaid #:</b><input type="text" name="medicaid" id="medicaid" value="" class="text-line"/></td></tr>
