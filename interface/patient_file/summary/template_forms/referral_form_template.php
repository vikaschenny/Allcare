    ...
    <body>
        ...
        <form name="referral" id="referral" action="../chart_output.php" method="post" >
            <div>
                ...
                <br>
                <table>
                    <tr><td><b>Referral source:</b><input type="text" name="referral_source" id="referral_source" value="<?php echo $prow['referral_source']; ?>" class="text-line"/></td><td><b>Date:</b><input type="date" name="referred_date" id="referred_date" value="<?php if($prow['referred_date']!='0000-00-00') echo $prow['referred_date']; ?>" class="text-line" /></td></tr>
                ...
                <b><u>INSURANCE INFORMATION:</u></b><br>
                 <?php $ins1=sqlStatement("SELECT * FROM  `insurance_data` WHERE pid =$patientid and type='primary'");
                       ...
                       $sql31=sqlStatement("select name from insurance_companies where id='".$insdata2['provider']."'");
                       $company21=sqlFetchArray($sql31);
                       
                       //for insurance companies
                       $ins_comp=sqlStatement("SELECT * FROM  `insurance_companies`");
                      
                 ?>
                <table>
<!--                    <tr><td><b>Primary insurance:</b><input type="text" name="provider" id="provider" value="<?php echo $company2['name']; ?>" class="text-line"/></td></tr>-->
                    <tr><td>
                            <b>Primary insurance:</b>
                            <select id="provider" name="provider" class="text-line">
                                <option value=""></option>
                                    <?php while( $inscomp_data=sqlFetchArray($ins_comp)) { ?>
                                <option value="<?php echo $inscomp_data['id']; ?>" <?php if($insdata1['provider']==$inscomp_data['id']) echo "selected"; ?>><?php echo $inscomp_data['name']; ?></option> <?php }?>
                            </select>
                        </td>
                    </tr>
                    <tr><td><b>Medicare #:</b>
                            <input type="text" name="medicare" id="medicare" value="<?php echo $insdata1['policy_number']; ?>" class="text-line"/>
                        </td>
                        <td><b>Medicaid #:</b>
                            <input type="text" name="medicaid" id="medicaid" value="" class="text-line"/></td></tr>
                    <tr><td>
                            <b>Secondary:</b><input type="text" name="sec_ins" id="sec_ins" value="<?php echo $company21['name']; ?>" class="text-line"/></td>
                        <td>
                            <b>Policy/Group #:</b>
                            <input type="text" name="policy_number" id="policy_number" value="<?php echo $insdata2['policy_number']; ?>" class="text-line"/>
                        </td>
                        <td><b>Effective date:</b>
                            <input type="date" name="" id="" value="<?php echo $insdata2['date']; ?>" class="text-line"/>
                        </td>
                    </tr>
                </table>
                <br>
                ...
                <p>You can also complete the Referral form online at http://www.texashousecalls.com/request-a-housecall/</p>
            </div>
          </form>
