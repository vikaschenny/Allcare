...
function display_medications($eid,$pid,$groupName,$layout_type,$min){
    global $tempvalue;
    if($eid != 0)
...
function display_vitals($encounter,$groupName,$min){
    global $tempvalue;
...
function display_ros($encounter,$groupName,$min){
    global $tempvalue;
    $getROS="SELECT r.*
...
function display_physical_exam($encounter,$groupName,$min){
    global $tempvalue;
...
function display_cc($encounterid,$groupName,$min){
    global $tempvalue;
...
function display_progress($encounterid,$groupName,$min){
    global $tempvalue;
...
function display_hpi($encounterid,$pid,$groupName,$min){
    global $tempvalue;
...
function display_assess($encounterid,$groupName,$min){
    global $tempvalue;
...
function display_plan($encounterid,$groupName,$min){
    global $tempvalue;
...
function display_mproblem($eid,$pid,$groupName,$layout_type,$min){
    global $tempvalue;
    if($eid != 0){
...
function display_allergy($encounterid,$layout_type,$groupName,$min){
    global $tempvalue;
...
function display_surgery($encounterid,$layout_type,$min){
    global $tempvalue;
    echo "<br>";
    if($layout_type == 'grid'){
        echo "<style>
...
function display_dental($encounterid,$layout_type,$min){
    global $tempvalue;
    if($encounterid != 0){       
...
//face to face
function display_f2f($encounter1,$groupName1,$min){
    global $tempvalue;
...
function display_dme($encounterid,$layout_type,$min){
    global $tempvalue;
    $surgerysql2 = sqlStatement('SET OPTION SQL_BIG_SELECTS = 1');
    if($encounterid != 0){
        $surgerysql2 = "SELECT 
...
function display_procedure($encounter,$min){
    global $tempvalue;
...
function display_cpo($encounterid,$groupName,$min){
    global $tempvalue;
