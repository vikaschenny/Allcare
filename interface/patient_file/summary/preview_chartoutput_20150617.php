...
function display_demographics($pid, $groupName){
    $pid = !empty($pid)? $pid : $_SESSION['pid'];
...
function display_ros($encounter,$groupName){
    ...
    if(mysql_num_rows($rosdata)>0){
       while ($frow = sqlFetchArray($rosdata)) {
        ...
        if($datacheck == 1){
            $checkval  = 0;
            echo "<li class='ccplay".$encounter."'><b>Constitutional: </b>";
            if($sub == 0){
                echo "Normal.</li>";
            }elseif($sub == 1){
                echo "<li style='margin-left: 1cm;' class='ccplay".$encounter."'>";
                foreach ($rowROSFields as $key=>$value) {
                ...
                if($checkval == 0) echo "<style>.ccplay".$encounter."{display:none;}</style>";
                echo "</li>";
            }
        ...
        if($datacheck == 1){
            $checkval  = 0;
            echo "<li class='eplay".$encounter."'><b>Eyes: </b>";
            if($sub == 0){
                echo "Normal.</li>";
            }elseif($sub == 1){
                echo "<li style='margin-left: 1cm;' class='eplay".$encounter."'>";
                foreach ($rowROSFields as $key=>$value) {
                ...
                if($checkval == 0) echo "<style>.eplay".$encounter."{display:none;}</style>";
                echo "</li>";
            }    
            if($checkval == 1) echo "<br>";
        } 
        ...
        if($datacheck == 1){
            $checkval  = 0;
            echo "<li class='entplay".$encounter."'><b>Ears, Nose, Mouth, Throat: </b>";
            if($sub == 0){
                echo "Normal.</li>";
            }elseif($sub == 1){
                echo "<li style='margin-left: 1cm;' class='entplay".$encounter."'>";
                foreach ($rowROSFields as $key=>$value) {
                ...
                if($checkval == 0) echo "<style>.entplay".$encounter."{display:none;}</style>";
                echo "</li>";
            }   
            if($checkval == 1) echo "<br>";
        }
        ...
        if($datacheck == 1){
            $checkval  = 0;
            echo "<li class='nplay".$encounter."'><b>Neck: </b>";
            if($sub == 0){
                echo "Normal.</li>";
            }elseif($sub == 1){
                echo "<li style='margin-left: 1cm;' class='nplay".$encounter."'>";
                foreach ($rowROSFields as $key=>$value) {
                ...
                if($checkval == 0) echo "<style>.nplay".$encounter."{display:none;}</style>";
                echo "</li>";
            }    
            if($checkval == 1) echo "<br>";
        }    
        ...
        if($datacheck == 1){
            $checkval  = 0;
            echo "<li class='bplay".$encounter."'><b>Breast: </b>";
            if($sub == 0){
                echo "Normal.</li>";
            }elseif($sub == 1){
                echo "<li style='margin-left: 1cm;' class='bplay".$encounter."'>";
                foreach ($rowROSFields as $key=>$value) {
                ...
                if($checkval == 0) echo "<style>.bplay".$encounter."{display:none;}</style>";
                echo "</li>";
            }    
            if($checkval == 1) echo "<br>";
        }    
        ...
        if($datacheck == 1){
            $checkval  = 0;
            echo "<li class='rplay".$encounter."'><b>Respiratory: </b>";
            if($sub == 0){
                echo "Normal.</li>";
            }elseif($sub == 1){
                echo "<li style='margin-left: 1cm;' class='rplay".$encounter."'>";
                foreach ($rowROSFields as $key=>$value) {
                ...
                if($checkval == 0) echo "<style>.rplay".$encounter."{display:none;}</style>";
                echo "</li>";
            }    
            if($checkval == 1) echo "<br>";
        }    
        ...
        if($datacheck == 1){
            $checkval  = 0;
            echo "<li class='cplay".$encounter."'><b>Cardiovascular: </b>";
            if($sub == 0){
                echo "Normal.</li>";
            }elseif($sub == 1){
                echo "<li style='margin-left: 1cm;' class='cplay".$encounter."'>";
                foreach ($rowROSFields as $key=>$value) {
                ...
                if($checkval == 0) echo "<style>.cplay".$encounter."{display:none;}</style>";
                echo "</li>";
            }    
            if($checkval == 1) echo "<br>";
        }    
        ...
        if($datacheck == 1){
            $checkval  = 0;
            echo "<li class='gplay".$encounter."'><b>Gastrointestinal: </b>";
            if($sub == 0){
                echo "Normal.</li>";
            }elseif($sub == 1){
                echo "<li style='margin-left: 1cm;' class='gplay".$encounter."'>";
                foreach ($rowROSFields as $key=>$value) {
                ...
                if($checkval == 0) echo "<style>.gplay".$encounter."{display:none;}</style>";
                echo "</li>";
            }    
            if($checkval == 1) echo "<br>";
        }    
        ...
        if($datacheck == 1){
            $checkval  = 0;
            echo "<li class='giplay".$encounter."'><b>Genitourinary General: </b>";
            if($sub == 0){
                echo "Normal.</li>";
            }elseif($sub == 1){
                echo "<li style='margin-left: 1cm;' class='giplay".$encounter."'>";
                foreach ($rowROSFields as $key=>$value) {
                ...
                if($checkval == 0) echo "<style>.giplay".$encounter."{display:none;}</style>";
                echo "</li>";
            }    
            if($checkval == 1) echo "<br>";
        }    
        ...
        if($datacheck == 1){
            $checkval  = 0;
            echo "<li class='gmplay".$encounter."'><b>Genitourinary Male: </b>";
            if($sub == 0){
                echo "Normal.</li>";
            }elseif($sub == 1){
                echo "<li style='margin-left: 1cm;' class='gmplay".$encounter."'>";
                foreach ($rowROSFields as $key=>$value) {
                ...
                if($checkval == 0) echo "<style>.gmplay".$encounter."{display:none;}</style>";
                echo "</li>";
            }    
            if($checkval == 1) echo "<br>";
        }    
        ...
        if($datacheck == 1){
            $checkval  = 0;
            echo "<li class='gfplay".$encounter."'><b>Genitourinary Female: </b>";
            if($sub == 0){
                echo "Normal.</li>";
            }elseif($sub == 1){
                echo "<li style='margin-left: 1cm;' class='gfplay".$encounter."'>";
                foreach ($rowROSFields as $key=>$value) {
                ...
                if($checkval == 0) echo "<style>.gfplay".$encounter."{display:none;}</style>";
                echo "</li>";
            }    
            if($checkval == 1) echo "<br>";
        }    
        ...
        if($datacheck == 1){
            $checkval  = 0;
            echo "<li class='mplay".$encounter."'><b>Musculoskeletal: </b>";
            if($sub == 0){
                echo "Normal.</li>";
            }elseif($sub == 1){
                echo "<li style='margin-left: 1cm;' class='mplay".$encounter."'>";
                foreach ($rowROSFields as $key=>$value) {
                ...
                if($checkval == 0) echo "<style>.mplay".$encounter."{display:none;}</style>";
                echo "</li>";
            }    
            if($checkval == 1) echo "<br>";
        }    
        ...
        if($datacheck == 1){
            $checkval  = 0;
            echo "<li class='explay".$encounter."'><b>Extremities: </b>";
            if($sub == 0){
                echo "Normal.</li>";
            }elseif($sub == 1){
                echo "<li style='margin-left: 1cm;' class='explay".$encounter."'>";
                foreach ($rowROSFields as $key=>$value) {
                ...
                if($checkval == 0) echo "<style>.explay".$encounter."{display:none;}</style>";
                echo "</li>";
            }    
            if($checkval == 1) echo "<br>";
        }    
        ...
        if($datacheck == 1){
            $checkval  = 0;
            echo "<li class='ngplay".$encounter."'><b>Neurologic: </b>";
            if($sub == 0){
                echo "Normal.</li>";
            }elseif($sub == 1){
                echo "<li style='margin-left: 1cm;' class='ngplay".$encounter."'>";
                foreach ($rowROSFields as $key=>$value) {
                ...
                if($checkval == 0) echo "<style>.ngplay".$encounter."{display:none;}</style>";
                echo "</li>";
            }    
            if($checkval == 1) echo "<br>";
        }    
        ...
        if($datacheck == 1){
            $checkval  = 0;
            echo "<li class='splay".$encounter."'><b>Skin: </b>";
            if($sub == 0){
                echo "Normal.</li>";
            }elseif($sub == 1){
                echo "<li style='margin-left: 1cm;' class='splay".$encounter."'>";
                foreach ($rowROSFields as $key=>$value) {
                ...
                if($checkval == 0) echo "<style>.splay".$encounter."{display:none;}</style>";
                echo "</li>";
            }    
            if($checkval == 1) echo "<br>";
        }    
        ...
        if($datacheck == 1){
            $checkval  = 0;
            echo "<li  class='pyplay".$encounter."'><b>Psychiatric: </b>";
            if($sub == 0){
                echo "Normal.</li>";
            }elseif($sub == 1){
                echo "<li style='margin-left: 1cm;' class='pyplay".$encounter."'>";
                foreach ($rowROSFields as $key=>$value) {
                ...
                if($checkval == 0) echo "<style>.pyplay".$encounter."{display:none;}</style>";
                echo "</li>";
            }    
            if($checkval == 1) echo "<br>";
        }    
        ...
        if($datacheck == 1){
            $checkval  = 0;
            echo "<li  class='endplay".$encounter."'><b>Endocrine: </b>";
            if($sub == 0){
                echo "Normal.</li>";
            }elseif($sub == 1){
                echo "<li style='margin-left: 1cm;'  class='endplay".$encounter."'>";
                foreach ($rowROSFields as $key=>$value) {
                ...
                if($checkval == 0) echo "<style>.endplay".$encounter."{display:none;}</style>";
                echo "</li>";
            }        
            if($checkval == 1) echo "<br>";
        }    
...
//                }
        ...
        if($datacheck == 1){
            $checkval  = 0;
            echo "<li class='haiplay".$encounter."'><b>Hematologic/Allergic/Immunologic: </b>";
            if($sub == 0){
                echo "Normal.</li>";
            }elseif($sub == 1){
                echo "<li style='margin-left: 1cm;' class='haiplay".$encounter."'>";
                foreach ($rowROSFields as $key=>$value) {
                ...
                if($checkval == 0) echo "<style>.haiplay".$encounter."{display:none;}</style>";
                echo "</li>";
            }    
            if($checkval == 1) echo "<br>";
        }   
...
function display_physical_exam($encounter,$groupName){
	...
	'PSYCH' => array(
		'PSYAFF'   => xl('Affect Normal'),
                ...
                'PSYABL'   => xl('Able To Answer Questions Qppropriately')),
	'SKIN' => array(
        ...
        if($layout_type == 'list'){
             foreach($datadme as $key => $value){
                ...
                if($datacheck == ''){
                    ...
                    ?>
                    <script>
                        document.getElementById('show_div_dme<?php echo $encounter1; ?>').style.display = "block";
                    </script>
                    <?php
                    $tempvalue = 0 ;
                    echo "<li>&nbsp;</li>";
...
function display_procedure($encounter){
    global $tempvalue;
    $getProc="SELECT DISTINCT(po.procedure_order_id) AS Order_ID, po.encounter_id AS Encounter, po.provider_id AS OrderedBy, po.date_ordered AS OrderDate, po.date_collected AS PrintDate, po.order_status as Status, po.lab_id AS Lab,po.specimen_type AS SpecimenType
                FROM procedure_order po
                INNER JOIN forms f ON po.procedure_order_id = f.form_id AND po.encounter_id=f.encounter
                AND f.pid = po.patient_id
                WHERE po.patient_id='".$_SESSION['pid']."'
                AND po.encounter_id = ($encounter) AND f.deleted = 0";
    $resProc=sqlStatement($getProc);
    ...
    if(count($data2)>0):
        ...
        $rowProcFields=sqlFetchArray($resProc);
        foreach($data2 as $value){
            foreach ($value as $key => $val) {
                if(!empty($val)){
                    echo "<li>";
                    if($key =='OrderedBy')
                    {   
                        $ordersql=sqlStatement("select CONCAT(fname,' ',lname) as name from users where id='$val'");
                        $rowordersql=sqlFetchArray($ordersql);
                        if(!empty($rowordersql['name']))
                            echo "<b>".ucfirst(str_replace('_',' ',$key)).":"."</b>" .$rowordersql['name'];
                    }else if($key =='Lab')
                    {
                        $labsql=sqlStatement("select name from procedure_providers where ppid='$val'");
                        $rowlabsql=sqlFetchArray($labsql);
                        if(!empty($rowlabsql['name']))
                            echo  "<b>".ucfirst(str_replace('_',' ',$key)).":"."</b>" .$rowlabsql['name'];
                    }
                    else {
                        echo "<b>".ucfirst(str_replace('_',' ',$key)).":"."</b>" .$val;
                    }
        ...
        if(!empty($orderid)){
            echo "<li><b>".'Report:'."</b></li>";
            $proc_ord=array();
            foreach ($orderid as $val) {
                $res_proc=sqlStatement("SELECT CONCAT(pc.procedure_code, ':' ,pc.procedure_name) as Ordered_Procedure, pr.date_report as Reported, pr.specimen_num as Specimen, pr.report_status as Status ,pr.report_notes as Note,pr.procedure_report_id as report_id
                                            ...
                                            INNER JOIN procedure_type pt ON  pt.name= pc.procedure_name
                                            WHERE po.procedure_order_id =".$val."  AND pt.activity=1
                                            ORDER BY pc.procedure_order_seq, pr.procedure_report_id");

                while( $rowProcRes=sqlFetchArray($res_proc)) {
                    $proc_ord=$rowProcRes;
                }
            }
            if(!empty($proc_ord)){
                foreach( $proc_ord as $key => $val){
                     if(!empty($val))
                         echo "<li><b>". ucfirst(str_replace('_',' ',$key)).":"."</b>"  .$val."</li>";
                   }
                   echo "<li>&nbsp;</li>";
        ...
        if(!empty($proc_ord)){
            echo "<li><b>".'Results:'."</b></li>";
            foreach( $proc_ord as $key => $val){
                if($key=='report_id' && $val!='NULL' && $val!=''){
                    $res_proc1=sqlStatement("SELECT ps.result_code as Code , ps.result_text as Name,  ps.abnormal as abn, ps.result as Value, ps.range, ps.result_status as Status,ps.units as Units,  ps.comments as Note
                                    FROM procedure_result AS ps INNER JOIN procedure_type pt ON  pt.name= ps.result_text
                                    WHERE ps.procedure_report_id =".$val." AND pt.activity=1
                                    ORDER BY ps.result_code, ps.procedure_result_id");
                    $proc_ord1=array();
                    while( $rowProcRes1=sqlFetchArray($res_proc1)) {
                       $proc_ord1[]=$rowProcRes1;
                    }
                }
            }
            if(!empty( $proc_ord1)) {                           
                for($i=0; $i<count($proc_ord1); $i++){
                    foreach( $proc_ord1[$i] as $key1 => $val1)
                    { 
                       echo "<li><b>".ucfirst(str_replace('_',' ',$key1)).":"."</b>" .$val1."</li>";
                    }
                    echo "<li>&nbsp;</li>";
                 }
            }
...
$(window).load(function(){
    ...
    <?php
    $getcolval = sqlStatement("SELECT DISTINCT CONCAT(screen_name,'-',substring(group_name FROM 2)) as cname,layout_col,substring(group_name FROM 2)as group_name FROM tbl_chartui_mapping where form_id!='LBF2'");
    while($setcolval = sqlFetchArray($getcolval))
    {   
        $idName = str_replace(" ","-",$setcolval['cname']); 
        ?>  breakList('#<?php echo $idName; ?>','<?php echo $setcolval['layout_col']; ?>', $('.<?php echo $idName; ?>')); <?php
    }
...
static_patient_data($group, $keyarr, $_SESSION['pid'], $minValue);
ksort($keyarr); $j = 1;
$groupName = $group;
    ...
    foreach($keyarr as $key => $value) {
        ...
        if($value=='form_mobile_procedure' || $value=='form_homehealth_procedure'|| $value=='form_payeraudit_procedure'|| $value=='form_referral_procedure' || $value=='form_appeal_procedure'){
            if($_REQUEST[$value] == "YES"){
                ...
                $setpagebr5 = '';
                echo "<div style='clear:both;'>";
                $getpagebr5 = sqlStatement("SELECT DISTINCT(group_name) as group_name,page_break  FROM tbl_chartui_mapping WHERE screen_name = '$groupName' AND group_name LIKE '%Procedure'");
                $setpagebr5= sqlFetchArray($getpagebr5);
                if(substr($setpagebr5['group_name'],1)=='Procedure'){
                    ...
                    echo " <div id='".$idName.$j."'  style='clear:both;'>";   
                    echo "<ul class='".$idName.$j."' >";
                    display_procedure($eidval['encounter'],$groupName);
                    echo "<ul/></div></div>"; 
                    $i++;
                } 
                echo "</div>";
...
echo $s;
function patientdata_not_related_to_encounters($result1Value,$groupName){
    $j = 0;   
        ...
        if($value=='form_mobile_immunizations' || $value=='form_homehealth_immunizations' || $value=='form_payeraudit_immunizations' || $value=='form_referral_immunizations' || $value=='form_appeal_immunizations'){
            if ($_REQUEST[$value] == "YES" ){
                ...
                if (acl_check('patients', 'med')) {
                    $getpagebr2 = "SELECT group_name, layout_type, page_break FROM tbl_chartui_mapping WHERE screen_name = '$groupName' AND group_name LIKE '%Immunization'";
                    $getpage2 = sqlStatement($getpagebr2);
                    $setpagebr= sqlFetchArray($getpage2);
                    if(substr($setpagebr['group_name'], 1)=='Immunization') {
                        $idName = $groupName."-".'Immunization';
                        $idName = str_replace(" ","-",$idName);
                        echo "<div style='clear:both;'>"; 
                        if($setpagebr['group_name'] == 'YES'){
                            display_div_function($display_title,0);
                    }else{
                        echo "<h2> $display_title: </h2>";
                    }  
...
function static_patient_data($groupName,$result1, $pid, $minValue){ 
    ...
    foreach($result1 as $key => $value) { 
        ...
        if(!empty($set_display_field_label))
            $display_title = $set_display_field_label['title'];
        if($value=='form_mobile_history' || $value=='homehealth_history' || $value=='payeraudit_history' || $value=='referral_history' || $value=='appeal_history'){
            if ($_REQUEST[$value] == "YES"){
    ...
    patientdata_not_related_to_encounters($result_arrayValue,$groupName);
}
