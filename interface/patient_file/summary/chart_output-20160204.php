...
if ($mode) {   
 ...
 //$sqlBindArray = array($_POST['form_from_dos'], $_POST['form_to_dos'],$_POST['form_demographics'],$_POST['form_history'],$_POST['form_insurance'],$_POST['form_immunizations'],$_POST['form_vitals']);
  ...
  //for who & notes
//  $fres1 = sqlStatement("SELECT * FROM layout_options " . 
//     "WHERE form_id = 'F2F' AND uor > 0 AND data_type!=36 " .
//     "ORDER BY group_name, seq");
//  while ($frow1 = sqlFetchArray($fres1)) {
//    $data_type1 = $frow1['data_type'];
//    $field_id1  = $frow1['field_id'];
//    $value1 = $_POST["form_$field_id1"];
//    $sets .=  add_escape_custom($field_id1) . " = ?"."," ;
//    array_push($sqlBindArray, $value1);
//  }
  if ($id) {       
    //use sql placemaker
...
<div id='chartdiv'>
    ...
    <fieldset style="width:600px;">
        <legend>Who:</legend>
           ...
           <label>Notes:</label>
           <textarea name="form_notes" id="form_notes" title="" cols="30" rows="5"><?php echo $res21['notes']; ?></textarea> 
    </fieldset> <br><br> 
