...
if($group_name1!=''){
	...
	print "<thead><tr ><th style='width=10px;'>&nbsp;</th><th style='width=10px;'>&nbsp;</th><th style='width=10px;'>&nbsp;</th><th style='width:10px;'>Type</th><th style='width:10px;'>Date</th>";
    ...
    while($frow2 = sqlFetchArray($labels)) {
           ...
           // echo "<pre>"; print_r($field_id); echo "</pre>";
            if($i==1){
                print "<thead><tr ><th style='width=10px;'>&nbsp;</th><th style='width=10px;'>&nbsp;</th><th style='width=10px;'>&nbsp;</th><th style='width:10px;'>Type</th><th style='width:10px;'>Group</th><th style='width:10px;'>Date</th>";
