...
$group=$_REQUEST['chartgroupshidden2'];
$tempvalue = 1 ;
...
function display_insurance($patient_id,$rowdos) 
{    
    $datacheck = '';
    ...
    foreach($priroty_type as $pri_val){
        $getInsuranceData="SELECT insd.type AS Priority,
                           ...
                           WHERE insd.pid='".$patient_id."' and insd.date < '$rowdos[0]' and insd.type='$pri_val' order by insd.id desc limit 0,1";        
...
$rowdos=$_REQUEST['dos'];
static_patient_data($group, $keyarr, $patient_id, $minValue,$rowdos);
ksort($keyarr); $j = 1;
$groupName = $group;
...
function static_patient_data($groupName,$result1, $pid,$minValue,$rowdos){ 
