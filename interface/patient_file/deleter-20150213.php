...
&chart_output_trans_pid=<?php echo $_REQUEST['hdnPid'];?>&id=<?php echo $service_facility; ?>&aid=<?php echo $agency; ?>&pharmacyid=<?php echo $pharmacyid; ?>&insuid=<?php echo $insuid; ?>&userid=<?php echo $userid; ?>' onsubmit="javascript:alert('1');document.deleform.submit();">
...
<?php
 if ($patient) {
  ...
  echo xl('service_facility') . " $service_facility ";
 }
 else if ($agency ) {
