...
if($_SESSION['email']==1){
    ...
    unset($_SESSION['gplusuer']); ?>
     ...
     <?php echo xlt("This Email id doesn't exist!"); ?>
     </td></tr>
      <?php      
}else if($_SESSION['em']!=''){
    unset($_SESSION['access_token']);
    unset($_SESSION['gplusuer']);?>
    <tr><td colspan='2' class='text' style='color:red'>
    <?php echo xlt($_SESSION['em']. ' is already exists!'); ?>
    </td></tr>
<?php }
if (isset($_SESSION['loginfailure']) && ($_SESSION['loginfailure'] == 1)):  
    if ($_SESSION['allow'] == 1 ) {
        ...
        <tr><td colspan='2' class='text' style='color:red'>
        <?php echo xlt(ucfirst($_SESSION['role']).' role is not allowed'); ?>
        </td></tr>
        <?php }else{ ?>
            <tr><td colspan='2' class='text' style='color:red'>
        <?php echo xlt('Role is not mentioned !'); ?>
        </td></tr>
        <?php  }
        
    }elseif($_SESSION['email_exists'] == 1 ){ ?>
        <tr><td colspan='2' class='text' style='color:red'>
        <?php echo xlt($_SESSION['email_id'].' is already Exists! '); ?>
        </td></tr>
<?php }elseif($_SESSION['unmatched'] == 1 ){ ?>
        <tr><td colspan='2' class='text' style='color:red'>
        <?php echo xlt("Username already  exists!"); ?>
        </td></tr>
<?php }else {  ?>
        <tr><td colspan='2' class='text' style='color:red'>
