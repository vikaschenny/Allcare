...
$widgetTitle = xl("Pharmacy Custom Attributes");
$widgetLabel = "pharmacy";
$widgetButtonLabel = xl("Edit");
$widgetButtonLink = "pharmacies_full_1to1.php?phid1=$id";
$widgetButtonClass = "";
$linkMethod = "html";
$bodyClass = "";
...
?>
         <div id="Pharmacy_custom_attributes" >
          <ul class="tabNav">
          ...
          <div class="tabContainer" style="height:200px; overflow-y:scroll; background-color:#FFFFFF;">
           <?php display_layout_tabs_data('PCA', $result, $result2); ?>
          </div>
         </div>
