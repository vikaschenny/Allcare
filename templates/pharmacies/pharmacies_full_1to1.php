...
<?php generate_layout_validation('PCA'); ?>
...
<body class="body_top">
<form action='pharmacies_save_1to1.php' name='pharmacies_form' method='post' onsubmit='return validate(this)'>
<input type='hidden' name='mode' value='save' />
<input type='hidden' name='db_phid' value="<?php echo $phid?>" />
...
<table cellpadding='0' cellspacing='0' border='0'>
	<tr>
		...
		<td>
			<a href="pharmacy_dropdown_1to1.php" id="cancelbtn" class='css_button' onclick="top.restoreSession()">
...
<br>
  <div class="section-header">
   <span class="text"><b> <?php xl("Pharmacies Custom Attributes", "e" )?></b></span>
</div>

<div id="pharmacy_custom_attr" >

	<ul class="tabNav">
	   <?php display_layout_tabs('PCA', $result, $result2); ?>
	</ul>

	<div class="tabContainer"style="height: 300px;background:#FFF; overflow-y: scroll; width: 80%;">
		<?php display_layout_tabs_data_editable('PCA', $result, $result2); ?>
	</div>
</div>
<br>
 </form>
