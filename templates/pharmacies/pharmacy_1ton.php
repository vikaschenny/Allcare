                        ...
                        <td>
                            ...
                            <select id="pharmacy" name="pharmacy" onchange="javascript:dropdownchange();">
                                ...
                                while($rowFinEncByDOS=sqlFetchArray($resFinEncByDOS)){ 
                                    ...
                                    if($_REQUEST['pharmacy'] == $rowFinEncByDOS['id']) echo "selected"; 
            ...
            function dropdownchange(){
                if($( "#pharmacy option:selected" ).val() == 0){
                   //$("#pca").hide();
                    ...
                    var pharmaid = $( "#pharmacy option:selected" ).val();
                    $("#pca").load("add_pharmacy.php?pharmaid="+pharmaid);
                }
     ...
     if(isset($_REQUEST['pharmacy'])){
        ...
        <script type="text/javascript">
            jQuery(document).ready(function(){
                $("#pca").load("add_pharmacy.php?pharmaid="+<?php echo $_REQUEST['pharmacy']; ?>);
            });
         </script>
     <?php 
     }
