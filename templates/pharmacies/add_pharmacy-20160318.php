...
<script type="text/javascript">
    ...
    $("#pharmacydata_div").load("pharmacy_data_list.php?pharmaid="+pharmaid,function(){
             $('#dvLoading').hide();
        });
...
<body class="body_top">
    ...
    <tr>
        ...
        <td>
            <!-- Define CSS Buttons -->
            <a href="pharmacy_data.php?pharmaid=<?php echo $_REQUEST['pharmaid']; ?>" <?php if (!$GLOBALS['concurrent_layout']) echo "target='Main'"; ?> class="css_button" onclick="top.restoreSession()">
    ...
    <?php } 
        ...
        <span class="text"><?php echo htmlspecialchars( xl('No Pharmacy Preferences Data.'), ENT_NOQUOTES); ?></span>
    <?php } ?>
    </div>
</body>
</html>