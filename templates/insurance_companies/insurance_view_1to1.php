...
$widgetTitle = xl("Insurance Company Custom Attributes");
$widgetLabel = "insurance";
$widgetButtonLabel = xl("Edit");
$widgetButtonLink = "insurance_full_1to1.php?insid1=$id";
$widgetButtonClass = "";
$linkMethod = "html";
$bodyClass = "";
...
?>
         <div id="Pharmacy_custom_attributes" >
          ...
          <div class="tabContainer" style="height:200px; overflow-y:scroll; background-color:#FFFFFF;">
           <?php display_layout_tabs_data('INSCA', $result, $result2); ?>
          </div>
         </div>
