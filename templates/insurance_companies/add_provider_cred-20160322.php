...
<script type="text/javascript">
    ...
    $("#insurancecompanydata_div").load("provider_cred_list.php?insuranceid="+insuranceid,function(){
             $('#dvLoading').hide();
        });
...
<body class="body_top">
    ...
    <tr>
        ...
        <td>
            <!-- Define CSS Buttons -->
            <a href="provider_cred.php?insuranceid=<?php echo $_REQUEST['insuranceid']; ?>" <?php if (!$GLOBALS['concurrent_layout']) echo "target='Main'"; ?> class="css_button" onclick="top.restoreSession()">
            <span><?php echo htmlspecialchars( xl('Add'), ENT_NOQUOTES); ?></span></a>
            <a href="javascript:window.history.back();"class="css_button"><span><?php echo htmlspecialchars( xl('Back'), ENT_NOQUOTES); ?></span></a>
        </td>
    </tr>
    </table>
