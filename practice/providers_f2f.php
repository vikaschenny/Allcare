                                                ...
                                                <table>
                                                    <tr><td> <span class='bold'><?php echo htmlspecialchars( xl('Patient Name'), ENT_NOQUOTES); ?>:</span>
                                                            <?php
                                                                ...
                                                                /* Updated by Subhan on 20160330. So that we get all the patients and not specific patients to provider */
                                                                /*
                                                                ...
                                                                echo "   <select name='form_patient'   id='form_patient' onchange='this.form.submit()'>\n";
...
//                                                                echo  "selected"; echo" >-- " . xl('Select') . " --\n";
                                            ...
                                            function auto_submit(){
                                                var form_patient =jQuery('#form_patient').val();
                                                    ...
                                                    $("#uca").load("f2f/add_face_to_face.php?form_patient="+form_patient ,function(){ 
