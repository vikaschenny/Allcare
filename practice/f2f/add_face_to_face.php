...
//          $('#dvLoading').show();
//
//           $("#f2f_div").load("f2f_list.php?provider=<?php echo $provider; ?>&pid=<?php echo $pid1; ?>&location=provider_portal",function(){
//               
//                    $('#dvLoading').hide();
//                });
 ...
 $.ajax({
                    type: 'POST',
                    url: "f2f/f2f_list.php",	
                    data:{provider:'<?php echo $provider; ?>',
                    pid:<?php echo $pid1; ?>,
                    location:'provider_portal',
                    refer:'<?php echo $refer; ?>' },
                    success: function(response)
                    { 
                       
                     $('#f2f_div').html(response);
          ...
          <table>
            <tr>
                ...
                <td>
                    ...
                    <a class='various' data-fancybox-type='iframe' href='f2f/face_to_face.php?patient_id=<?php echo  $pid1 ; ?>&location=provider_portal&provider=<?php echo $provider; ?>&refer=<?php echo $refer; ?>' style="background-color:#49C1DC;
