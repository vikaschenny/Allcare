...
?>
<script type='text/javascript' src='../../interfacemain/js/jquery-1.11.1.min.js'></script>
<?php  
 $field_id=array();
 $title=array();
...
$sql7=sqlStatement("select * from tbl_form_chartoutput_transactions where  pid=$patient_id and date_of_service='$date_of_service' and transaction=2 and id=$id");
