                            ...
                            if($datatypeno == 23){ 
                                if(!empty($val)){
                                    ...
                                    for($i= 0; $i< count($explodeval2); $i++){
                                        ...
                                        $optid='"'.$explodelist2[0].'"';
                                        $getvalname = sqlStatement("SELECT title FROM list_options WHERE option_id =  $optid AND list_id = '$listname'");
    ...
    //                            if($abnormalstring != '') echo ".</li>";
                                ...
                                if(!empty($val) && $val != '|0||'){
                                    ...
                                    //if($val != '|0||'){
                                        ...
                                        if($datatypeno == 32):
                                            $optid1='"'.$explodeval[3].'"';
                                            $getvalname = sqlStatement("SELECT title FROM list_options WHERE option_id =$optid1 AND list_id = '$listname'");
                                            while($setvalname=sqlFetchArray($getvalname)){
                                ...
                                if(!empty($val) && $val !== '|0|'){
                                    ...
                                    //if($val != '|0|'){
                                        for($i=0; $i< count($explodeval); $i++){
                                            $optid2='"'.$explodeval[$i].'"';
                                            $getvalname = sqlStatement("SELECT title FROM list_options WHERE option_id =$optid2 AND list_id = '$listname'");
                                           while($setvalname=sqlFetchArray($getvalname)){
