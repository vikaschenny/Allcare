...
var calendar = {
  ...
  init: function() {
   ...
   $j('tbody td').on('click', function(e) {
    ...
    function displayEvent() {
      $j('tbody.event-calendar td').on('click', function(e) {
        ...
        $j('#app').hide();
        $j('.day-event[date-year="' + yearEvent + '"][date-month="' + monthEvent + '"][date-day="' + dayEvent + '"]').show();
      });
    };
   ...
   $j('.save').click(function() {
     ...
     * Print button
     */
    $j(document).on("click",".print-btn",function(evt) {
        evt.preventDefault();
        window.print();
    });
 ...
 function displayEvent1() {
      //$j('tbody.event-calendar td').load(function(e) {
        ...
        var monthEvent =mm;
        var dayEvent =dd;
         //alert(dayEvent+"======="+monthEvent+"========="+yearEvent);
