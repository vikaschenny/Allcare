 ...
 function setappt(year,mon,mday,hours,minutes) {
  ...
  f.form_minute.value = ('' + (minutes + 100)).substring(1);
	...
	var formDate = document.forms[0].form_date;
        window.open('<?php echo $GLOBALS['web_root']; ?>/practice/appointments/find_provider_appt_popup.php' +
                '?providerid=' + s +
            ...
            <table border='0' width='100%' bgcolor='#DDDDDD' >
                <tr>
                    ...
                    <td nowrap>
                        ...
                        <input type='hidden' size='10' name='form_title' value='<?php echo attr($row['pc_title']); ?>' style='width:100%' title='<?php echo xla('Event title'); ?>' />
                    </td>
                    <td width='1%' nowrap>
                        &nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td nowrap>
                       <select name="facility" id="facility" multiple="multiple">
                            ...
                            ***************************************************************/
                            $facils = getUserFacilities($_SESSION['portal_userid']);
                ...
                <tr>
                    <td nowrap><b><?php echo xlt('Provider'); ?>:</b></td>
                    <td>
                        <?php
                        if  ($GLOBALS['select_multi_providers']) {
                    ...
                    <td nowrap id='tdrepeat1'><?php echo xlt('Repeats'); ?></td>
                    <td nowrap>

                        <select name='form_repeat_freq' title='<?php echo xla('Every, every other, every 3rd, etc.'); ?>'>
                            <?php
                            foreach (array(1 => xl('every'), 2 => xl('2nd'), 3 => xl('3rd'), 4 => xl('4th'), 5 => xl('5th'), 6 => xl('6th')) as $key => $value)
                            {
                ...
                <tr>
                    ...
                    <td nowrap>
                        <input type="hidden" value="!n" name="form_apptstatus" id="form_apptstatus">
                        <input type="hidden" value="0" name="form_prefcat" id="form_prefcat">
                    </td>
                    <td nowrap id='tdrepeat2'> <?php echo xlt('until'); ?></td>
                    <td nowrap>
...
<script language='JavaScript'>
    ...
    <script language="javascript">
        ...
        function validate(valu) {
            ...
            if (f.form_repeat.checked && (! f.form_enddate.value || f.form_enddate.value < f.form_date.value)) {
