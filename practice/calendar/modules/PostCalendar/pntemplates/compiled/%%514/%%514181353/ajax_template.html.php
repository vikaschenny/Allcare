<?php /* Smarty version 2.3.1, created on 2016-10-12 04:49:50
         compiled from default/views/day/ajax_template.html */ ?>
<?php $this->_load_plugins(array(
array('function', 'assign', 'default/views/day/ajax_template.html', 359, false),
array('function', 'pc_sort_events', 'default/views/day/ajax_template.html', 364, false),
array('modifier', 'date_format', 'default/views/day/ajax_template.html', 359, false),
array('modifier', 'string_format', 'default/views/day/ajax_template.html', 360, false),)); ?>
...
//  top.restoreSession();
 ...
 function newEvt(startampm, starttimeh, starttimem, eventdate, providerid, catid) {
     window.open('add_edit_event.php?startampm=' + startampm +
   '&starttimeh=' + starttimeh + '&userid=' + providerid + '&starttimem=' + starttimem +
   '&date=' + eventdate + '&catid=' + catid+ '&patientid=','_blank', "width=600,height=500");
 ...
 function goPid(pid) {
     //alert("pid2");
     //window.parent.sendDemographicsUrl("https://qa2allcare.texashousecalls.com/practice/patients_eligibility.php");
//  top.restoreSession();
<?php 
 // hema commented starts
...
<form name='theform' id='theform' action='index.php?module=PostCalendar&func=view&tplview=default&pc_category=&pc_topic=' method='post' >
