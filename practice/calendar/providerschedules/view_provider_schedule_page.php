...
//                $( "#columnorder" ).disableSelection();
            ...
            function get_provider_schedule_ajax(){
                ...
                var selectedtitle = [];
                $('#pc_title :selected').each(function(i, selected){
                    selectedtitle[i] = $(selected).val();
                });
                var pc_title         = selectedtitle;
...
/*            #columnorder { list-style-type: none; margin: 0; border: 2px solid #ccc; overflow: auto;max-height: 250px;
   ...
   $getdatafilter = sqlStatement("SELECT mpr_pc_keywords_andor,mpr_pc_category,mpt_pc_category,mpr_pc_providers,mpr_pc_facilities FROM tbl_providerportal_filters WHERE userid = '".$_SESSION['portal_userid']."' and screen_name = 'maintain_provider_schedule'");
                              ...
                              <div class="col-sm-12">
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-6 input-group-sm">
                                            <a href="#" data-toggle="tooltip" title="Can search Schedule comments (or) Provider name (or) Provider Id"><span class="glyphicon glyphicon-info-sign"></span></a>
                                      </div>
                                      <label for="pc_title" class="col-sm-2 control-label">Provider Category:</label>
                                      <div class="col-sm-3">
                                          <select id="pc_title" class="form-control" multiple="multiple" name="pc_title">
                                      ...
                                      <div class="col-sm-1">
                                          <a href="#" data-toggle="tooltip" title="Select the Provider Category of the provider schedule."><span class="glyphicon glyphicon-info-sign"></span></a>
                                      </div>
                                      <label for="pc_category" class="col-sm-2 control-label">Appointment Category:</label>
                                      <div class="col-sm-3">
                                      ...
                                      <div class="col-sm-1">
                                          <a href="#" data-toggle="tooltip" title="Select the Appointment Category of the provider schedule."><span class="glyphicon glyphicon-info-sign"></span></a>
                                      </div>
...
//                                                }
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-6">
                                          <a href="#" data-toggle="tooltip" title="Will get provider schedules from this date."><span class="glyphicon glyphicon-info-sign"></span></a>
                                      </div>
                                      ...
                                      <div class="col-sm-3">
                                       ...
                                       <div class="col-sm-1">
                                          <a href="#" data-toggle="tooltip" title="Will get provider schedules till this date."><span class="glyphicon glyphicon-info-sign"></span></a>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-6">
                                          <a href="#" data-toggle="tooltip" title="Select the Providers."><span class="glyphicon glyphicon-info-sign"></span></a>
                                      </div>
                                      ...
                                      <div class="col-sm-1">
                                          <a href="#" data-toggle="tooltip" title="Select the facility of Provider Schedule."><span class="glyphicon glyphicon-info-sign"></span></a>
                                      </div>
                                  </div>
<!--                                  <div class="form-group">
        ...
        <div id='provider_schedule_div'>
            ...
            <div id="provider_searchdata_div"></div>
        </div>
