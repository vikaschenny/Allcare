...
<form method='post' name='theform' id='theform' action='add_edit_provider_event.php?eid=<?php echo attr($eid) ?>' />
...
?>
       <li <?php echo $provider_class;?>>
        <a href='add_edit_provider_event.php?prov=true&eid=<?php echo attr($eid);?>&startampm=<?php echo attr($startm);?>&starttimeh=<?php echo attr($starth);?>&userid=<?php echo attr($uid);?>&starttimem=<?php echo attr($starttm);?>&date=<?php echo attr($dt);?>&catid=<?php echo attr($cid);?>'>
