...
//                $( "#columnorder" ).disableSelection();
                ...
                $(document).on("change","#vcolumns",function(){
                    $(this).find("option").each(function(index,element){
                        var selectedcolm = table.column($(this).val());
                        if($(this).prop("selected"))
                            selectedcolm.visible(true);
                        else
                             selectedcolm.visible(false);
                    });
            ...
            function get_provider_schedule_ajax(){
                ...
                var orderdata = [];
//                $('#columnorder li').each(function(){
//                    orderdata.push($(this).data("column"))
//                });
                $.ajax({
                    url:"patient_appointment_search.php",
                    method:"POST",
                    data:{
                        keyword             : keyword,
                    ...
                    success:function(result){
                       ...
                       table = $('#provider_schedule_div #search-table').DataTable({"pageLength": 100});
                        
                        $('#provider_searchdata_div select[multiple] option').each(function(index,value){
                            var selectedcolm = table.column($(this).val());
                            if(selectedcolm.visible()==true)
                              $(this).prop("selected",true);
                        });
                        
                        $('#provider_searchdata_div select[multiple]').multiselect({
                            columns: 2,
                            selectAll:true,
                            texts: {
                       ...
                       $("#search-table_wrapper").children().first().children().attr("class","col-sm-4");
                       $('#provider_searchdata_div #vcontenar').insertAfter($("#search-table_wrapper").children().first().children().first());
                    },
...
/*            #columnorder { list-style-type: none; margin: 0; border: 2px solid #ccc; overflow: auto;max-height: 250px;
                padding: 7px; }
            #columnorder li { margin: 0 3px 3px 3px; padding: 0.03em; 
                padding-left: 1.5em; font-size: 17px; height: 26px; }
            #columnorder .default {
                background: #cedc98;
   ...
   $mpt_pc_keywords_andor   = '';
   $mpt_pc_category         = '';
   $mpt_pc_visittype        = '';
   $mpt_pc_providers        = '';
   $mpt_pc_facilities       = '';

   $getdatafilter = sqlStatement("SELECT mpt_pc_keywords_andor,mpt_pc_category,mpt_pc_visittype,mpt_pc_providers,mpt_pc_facilities FROM tbl_providerportal_filters WHERE userid = '".$_SESSION['portal_userid']."' and screen_name = 'search_patient_appointments'");
   while($setdatafilter = sqlFetchArray($getdatafilter)){
       $mpt_pc_keywords_andor   = $setdatafilter['mpt_pc_keywords_andor'];
       $mpt_pc_category         = $setdatafilter['mpt_pc_category'];
       $mpt_pc_visittype        = $setdatafilter['mpt_pc_visittype'];
       $mpt_pc_providers        = $setdatafilter['mpt_pc_providers'];
       $mpt_pc_facilities       = $setdatafilter['mpt_pc_facilities'];
   }

   $mpt_pc_keywords_andor2  = explode(",",$mpt_pc_keywords_andor);
   $mpt_pc_category2        = explode(",",$mpt_pc_category);
   $mpt_pc_visittype2       = explode(",",$mpt_pc_visittype);
   $mpt_pc_providers2       = explode(",",$mpt_pc_providers);
   $mpt_pc_facilities2      = explode(",",$mpt_pc_facilities);
                          ...
                          <div class="row">
                              <div class="col-sm-12">
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label" for="keywordtext">Search String:</label>
                                      ...
                                      <div class="col-sm-6 input-group-sm">
                                            <a href="#" data-toggle="tooltip" title="Can search patient name (or) patient id (or) appointment comments (or) Provider name (or) Provider Id"><span class="glyphicon glyphicon-info-sign"></span></a>
                                      </div>
                                      ...
                                      <div class="col-sm-3">
                                        <select id="pc_category" class="form-control" multiple="multiple" name="pc_category">
                                            <?php
                                              $get_catgories = sqlStatement("SELECT pc_catid,pc_catname FROM openemr_postcalendar_categories WHERE pc_cattype='0' ORDER BY pc_catname");
                                              while($set_catgories = sqlFetchArray($get_catgories)){
                                                  echo "<option value = '".$set_catgories['pc_catid']."'";
                                                  if( in_array ( $set_catgories['pc_catid'], $mpt_pc_category2) == true )
                                                      echo " selected ";
                                      ...
                                      <div class="col-sm-1">
                                          <a href="#" data-toggle="tooltip" title="Select the Visit Category of the Patient appointment."><span class="glyphicon glyphicon-info-sign"></span></a>
                                      </div>
                                      <label for="pc_visittype" class="col-sm-2 control-label">Visit Type:</label>
                                      <div class="col-sm-4">
                                          <select id="pc_visittype" class="form-control" multiple="multiple" name="pc_visittype">
                                              <?php
                                                ...
                                                while($set_visittype = sqlFetchArray($get_visittype)){
                                                    echo "<option value = '".$set_visittype['option_id']."'";
                                                    if( in_array ( $set_visittype['option_id'], $mpt_pc_visittype2) == true )
                                                        echo " selected ";
                                                    echo ">  ".$set_visittype['title']."</option>";
                                                }
                                            ?>
                                          </select>
                                      </div>
                                      <div class="col-sm-6">
                                          <a href="#" data-toggle="tooltip" title="Select the Visit Type of the Patient appointment as listed in List Table."><span class="glyphicon glyphicon-info-sign"></span></a>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-6">
                                          <a href="#" data-toggle="tooltip" title="Will get appointments from this date."><span class="glyphicon glyphicon-info-sign"></span></a>
                                      </div>
                                      ...
                                      <div class="col-sm-1">
                                          <a href="#" data-toggle="tooltip" title="Will get appointments till this date."><span class="glyphicon glyphicon-info-sign"></span></a>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                           ...
                                           <select id="pc_providers" class="form-control" multiple='multiple' name="pc_providers">
                                              ...
                                              <?php
                                                ...
                                                while($set_providers = sqlFetchArray($get_providers)){
                                                    ...
                                                    if( in_array ( $set_providers['id'], $mpt_pc_providers2) == true )
                                                        echo " selected ";
                                      ...
                                      <div class="col-sm-6">
                                          <a href="#" data-toggle="tooltip" title="Select the Providers of the Patient appointment."><span class="glyphicon glyphicon-info-sign"></span></a>
                                      </div>
                                           ...
                                           <select id="pc_facilities" class="form-control" multiple='multiple' name="pc_facilities">
                                              <!--<option value="" selected>All Facilities</option>-->
                                                <?php
                                                    ...
                                                    if( in_array ( $set_facilities['id'], $mpt_pc_facilities2) == true )
                                                        echo " selected ";
                                      ...
                                      <div class="col-sm-1">
                                          <a href="#" data-toggle="tooltip" title="Select the facility of Patient appointment."><span class="glyphicon glyphicon-info-sign"></span></a>
                                      </div>
                                  </div>
<!--                                  <div class="form-group">
                                        <div class="text-center"><b>Column order</b></div>
                                      <div class="col-sm-4 col-sm-offset-4">
                                          <ul id="columnorder">
                                            <li class="default" data-column="Provider">Provider</li>
                                            <li class="default" data-column="Date">Date</li>
                                            <li class="default" data-column="Patient Name">Patient Name</li>
                                            <li class="default" data-column="Start Time">Start Time</li>
                                            <li class="default" data-column="End Time">End Time</li>
                                            <li class="default" data-column="Facility">Facility</li>
                                            <li class="default" data-column="Category">Category</li>
                                            <li class="default" data-column="Facility">Facility</li>
                                            <li class="default" data-column="All Day">All Day</li>
                                         </ul>
                                      </div>
                                  </div>-->
                                  <div class="form-group">
...
<!--            <div class='text-right'>
                <a data-modalsize='modal-md' data-frameheight="350" data-bodypadding='0' data-href='../add_edit_custom_provider_event.php?prov=true&eid=&startampm=&starttimeh=&userid=&starttimem=&date=&catid=' data-toggle='modal' data-target='#modalwindow' class="btn btn-default btn-sm" id="createproviderschedule" style="color:black; " title="Add New Provider Schedule"><span class="glyphicon"> </span>  Add Patient Appointment</a>
            </div>-->
        </form>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header" style="background-color:#46a1b4; border-radius: 5px 5px 0px 0px;">
                        ...
                        <h4 class="modal-title" id="myModalLabel" >Add Patient Appointment</h4>
                    </div>
