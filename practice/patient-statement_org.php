...
//Function reads a text file and converts to pdf.
   ...
   $pdf->Output('openemr_statements.pdf', 'D');
...
<script type='text/javascript'>
    $(document).ready(function() {
        ...
        $('<input type="submit" value="PDF Download Selected Statements" name="form_pdf" class="bootrapbtn">').insertAfter("#patientstatement_wrapper #patientstatement_length");
...
<table cellspacing='0' width='100%' id="patientstatement" class="table table-striped table-bordered nowrap" style="">
    <thead>
 <tr>
  <th>
   <?php xl('Payer','e'); ?>
