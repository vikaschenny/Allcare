     ...
     <div class= "hidden-print col-lg-3 col-sm-4 col-xs-12 text-center">
         ...
         <div class="row">
             <div class="col-xs-12">
                 ...
                 <a class="btn btn-primary btn-block" href="javascript:void()" data-title="Search Patient Appointments" data-frameheight="450" data-modalsize='modal-lg' data-bodypadding='0' data-frameheight="480" data-href='calendar/patientappointments/view_patient_appointments_page.php' data-toggle='modal' data-target='#modalwindow' title="Click to search patient appointments" data-backdrop="static" data-keyboard="false">Search Patient Appointments</a>
                 <a class="btn btn-primary btn-block" href="javascript:void()" data-title="Maintain Provider Schedule" data-frameheight="450" data-modalsize='modal-lg' data-bodypadding='0' data-frameheight="480" data-href='calendar/providerschedules/view_provider_schedule_page.php' data-toggle='modal' data-target='#modalwindow' title="Click to search provider calendar schedule" data-backdrop="static" data-keyboard="false">Maintain Provider Schedule</a>
                 <a class="btn btn-primary btn-block" href="javascript:void()" data-title="Create Paitent" data-frameheight="450" data-modalsize='modal-lg' data-bodypadding='0' data-frameheight="480" data-href='create_patient/new_comprehensive.php' data-toggle='modal' data-target='#modalwindow' title="Click to Create Paitent" data-backdrop="static" data-keyboard="false">Create Patient</a>
                 <a class="btn btn-primary btn-block" href="javascript:void()" data-title="Add Patient Insurance" data-frameheight="450" data-modalsize='modal-lg' data-bodypadding='0' data-frameheight="480" data-href='patient_file/summary/select_patient.php' data-toggle='modal' data-target='#modalwindow' title="Click to Add Patient Insurance" data-backdrop="static" data-keyboard="false">Add Patient Insurance</a> 
                 <a class="btn btn-primary btn-block" href="javascript:void()" title="Click to search provider calendar schedule" onclick="window.open('//qaallcareaws.texashousecalls.com/practice/scheduling/calendar/add_edit_event.php','name=appt','width=595,height=350')">Create Appointment</a>
                 <a class="btn btn-primary btn-block" href="javascript:void()" data-title="Create Encounter" data-frameheight="450" data-modalsize='modal-lg' data-bodypadding='0' data-frameheight="480" data-href='create_encounter/new.php' data-toggle='modal' data-target='#modalwindow' title="Click to create encounter" data-backdrop="static" data-keyboard="false">Create Encounter</a>
                 <a class="btn btn-primary btn-block" href="scheduling/scheduling_pop_up.php" title="Click to Scheduling" target="_blank">Scheduling</a>
             </div>
         </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#modalwindow').on("show.bs.modal", function(event){
                ...
                if(target.data('apptstatus') != '@' && target.data('apptstatus') != undefined){
                    event.preventDefault();
                    alert("Before checkout, you need to create encounter...");
                }
