    ...
    <div id="wrapper" class="">
        <div id="sidebar-wrapper">
            ...
            <ul class="sidebar-nav" id="sidebar">
              ...
              <li><a onclick=DoPost_patient(this,'<?php echo $base_url ?>patient-statement.php?provider=<?php echo $provider; ?>')  class="active">Patient Statement Batch<span class="sub_icon glyphicon glyphicon-link"></span></a></li>
        ...
        <div id="page-content-wrapper">
            <div class="page-content inset">
                <div class="row">
                  <div class="col-md-12">
                    <div id="content">
<form method='post' action='patient-statement.php' enctype='multipart/form-data'><br/>
