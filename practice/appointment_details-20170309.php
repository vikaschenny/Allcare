         ...
         $count++;
          ...
          <table width="100%">
                ...
                <tr>
                    ...
                    <td style="text-align: right;">                                                
                        <a class='various hidden-print editins' data-title="Edit Insurance" data-frameheight="500" data-modalsize='modal-lg' data-bodypadding='0' data-href='patient_file/summary/insurancedata_full.php' data-toggle='modal' data-target='#modalwindow'><img src='images/ins_edit.png' alt='Edit Insurance' data-toggle="tooltip" data-placement="bottom" title=" Edit Insurance" width='25px' ></a>
                        <a class='various hidden-print Benefits' data-title="Benefits" data-frameheight="325" data-modalsize='modal-md' data-bodypadding='0' data-href='create_patient/edit_custom_insurance.php?provider=<?php echo $provider; ?>&pid=<?php echo $pid; ?>' data-toggle='modal' data-target='' ><img src='images/benefits.png' alt='Benefits' data-toggle="tooltip" data-placement="bottom" title=" Benefits" width='31px'></a>
                        <a class='various hidden-print eligibility' data-title="Eligibility" data-frameheight="325" data-modalsize='modal-lg' data-bodypadding='0' data-href='verify_eligibility.php' data-toggle='modal' data-target='' ><img src='images/eligibility.png' alt='Eligibility' data-toggle="tooltip" data-placement="bottom" title=" Eligibility" width='25px'></a>
                    </td>
                </tr>
                <?php 
                ...
                <tr>
                    ...
                    <td style="vertical-align: top;padding-bottom: 6px;padding-top: 3px;">
                        : <?php echo $row['Copay']; ?><a class='various hidden-print copay' data-title="Copay" data-frameheight="325" data-modalsize='modal-md' data-bodypadding='0' data-href='patient_file/summary/insurancedata_full.php' data-toggle='modal' data-target='#modalwindow'><img src='images/copay.png' alt='Copay' data-toggle="tooltip" data-placement="bottom" title=" Copay" width='8px' ></a>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top">
                    ...
                    <td style="vertical-align: top padding-bottom: 6px;">
                        : <?php echo $patientbalance; ?><a class='various hidden-print blance' data-title="Patient Balance" data-frameheight="325" data-modalsize='modal-md' data-bodypadding='0' data-href='patient_file/summary/insurancedata_full.php' data-toggle='modal' data-target='#modalwindow'><img src='images/paitent_blance.png' alt='Patient Balance' data-toggle="tooltip" data-placement="bottom" title=" Patient Balance" width='15px' ></a>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top">
