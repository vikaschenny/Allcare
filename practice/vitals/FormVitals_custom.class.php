...
class FormVitals extends ORDataObject {
	...
	function FormVitals($id= "", $pid1,$encounter1,$pending,$finalized,$isSingleView,$isFromCharts,$_prefix = "")	{
                $sql=sqlStatement("select date from form_encounter where pid='".$pid1."' and encounter='".$encounter1."'");
  ...
  function set_date($dt) {
	...
	function set_oxygen_saturation($o) {
        ...
        function get_O2source() {
		return $this->O2source;
	}
	function set_O2source($o2source) {
		$this->O2source = $o2source;
	}
         
        function get_O2_flow_rate() {
		return $this->O2_flow_rate;
	}
	function set_O2_flow_rate($o2flow) {
		$this->O2_flow_rate = $o2flow;
	}
        function get_pain_scale() {
		return $this->pain_scale;
	}
	function set_pain_scale($ps) {
		$this->pain_scale = $ps;
	}
	
        function get_options_pending(){
		$ret = array("pending" => xl('Pending'));
                
		return $ret;
	}
        function get_options_finalized(){
		$ret = array("finalized" => xl('Finalized'));
		return $ret;
	}
