...
echo "<form method='post' name='my_form' id='my_form'" .
  "action='save_codes.php?id=" . attr($formid) ."'>\n";
    ...
    <input type='textbox' name='cpt_search' value="" id='cpt_search' ><a class="button icon search" id="cpt_search_button" name='cpt_search_button' >Search</a><!--<input type="button" id='cpt_search_button' name='cpt_search_button' value='Search'>--><br>
    <?php
...
//            echo "<option value ='".$setcpts['code']."'>".$setcpts['code']." ".$setcpts['Description']."</option>";
        ...
        ?>
    </select><a class="button danger icon remove" id="cptbtnclear" onclick="cleardropdown('cpt')">Clear Dropdown</a><!--<input type="button" id="cptbtnclear" onclick="cleardropdown('cpt')" value="Clear Dropdown" />-->
    <br><br>
