...
//                        var funcal = $("#hiddenpverify"+id).val();
                ...
                function patient_insurance(pid){
                    window.open('patient_file/summary/insurancedata_full.php?pid='+pid,"","width=1000, height=600,scrollbars=1,resizable=1");
                }
                ...
                <div class= "row">
                    <div class= "col-lg-12 col-sm-12 col-xs-12" style=''>
                        ...
                        // Element data seperator		
                            ...
                            $typeofservice      = !empty($_POST['form_typeofservice'])?$_POST['form_typeofservice']:array('30');
...
<!--                                                            <a href='#' class='css_button' onclick='return validate_elig("");'>
                        ...
                        <?php
                                if ($res3){
                                        practiceportal_show_elig($res3,$X12info,$segTer,$compEleSep);
                                }
                        ?>
                    </div>
                </div>
