...
<html>
    <head>
        ...
        <script type="text/javascript" src="<?php echo "//".$_SERVER['SERVER_NAME'].'/practice/'; ?>assets/js/bootstrap.min.js"></script>
    ...
    <body>   
       <!--<a href="javascript:void(0)" class="folder" ><strong>Start</strong></a>-->
        <aside class="sidemenu in">
            <h4>Menu</h4>
            <div class="listitems" style="height:180% !important;">
                <ul>
                </ul>
            </div>
        </aside>
        <div class="list-container uyd-grid">
            <div class="nav-header" style="width:80% !important;">
