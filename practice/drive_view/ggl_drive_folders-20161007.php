...
$sel_link=sqlStatement("select * from tbl_allcare_userfolder_links where user_id=".$id1);
...
<html>
 ...
 <script type='text/javascript'>
    ...
    <body onunload="unShareFile()">
		...
		<div class= "row">
                    <div class= "col-xs-12" style='padding-top:100px !important;'>
