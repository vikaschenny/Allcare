...
//                                         $.ajax({
//                                             type: "POST",
//                                             url:"//"+'<?php echo $_SERVER['HTTP_HOST']; ?>'+"/practice/drive_view/drivesync_auth.php",
//                                             data : {status:1,email:'<?php echo $email_id; ?>'},
...
//                                            } 
//                                         });    
                                        window.location.href ="//"+'<?php echo $_SERVER['HTTP_HOST']; ?>'+"/practice/drive_view/drivesync_auth.php?status=1&email=<?php echo $email_id; ?>";
...
//                        $curl = curl_init();
//                        $form_url = "https://devint.coopsuite.com/DriveSync/oauth/$email_id";
                     ...
                     <script type="text/javascript">
                         ...
                         if(auth==''){
                             $.ajax({
                              ...
                              //window.location.href = "https://"+'<?php echo $_SERVER['HTTP_HOST']; ?>'+"/api/DriveSync/oauth2/"+'<?php echo $email_id; ?>';
                         }else {
                             alert('sucess');
//                             $.ajax({
//                                 type: "POST",
