...
for($i = 0; $i < count($delete_id); $i++) {
    ...
    newEvent("delete", $_SESSION['portal_username'], 'Default', 1, "Custom messages: id ".$delete_id[$i]);
}

$access=sqlStatement("select userid,custom_msg_access from tbl_user_custom_attr_1to1 where userid=".$_SESSION['portal_userid']);
...
$total = getMsgsByUser($active,$show_all,$_SESSION['portal_username'],true);
?>
<html>
    <head>
        <style>
    ...
    <body style="background-color:#F0F8FF">
        ...
        <table rules="rows" >
            ...
            $count = 0;
            $result = getMsgsByUser($active,$show_all,$_SESSION['portal_username'],false,$sortby,$sortorder,$begin,$listnumber);
