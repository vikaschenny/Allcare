...
//                                                                      AND o.pc_eventDate = DATE_FORMAT( fe.date,  '%Y-%m-%d' )where o.pc_aid =$id group by fe.pid";
                                            ...
                                            <div id="ourtable">
                                                <div id="ourrow">
                                                    <div id="td1"> 
                                                        <h3 ><a href="<?php echo $base_url ?>patient_data.php?order=<?php echo $order; ?>&provider=<?php echo $provider; ?>&id=my_patients">My Patients</a></h3>
                                                        <h3 ><a href="<?php echo $base_url ?>patient_data.php?order=<?php echo $order; ?>&provider=<?php echo $provider; ?>&id=all_patients">All Patients</a></h3>
                                                        <h3 ><a href="<?php echo $base_url ?>patient_data.php?order=<?php echo $order; ?>&provider=<?php echo $provider; ?>&id=by_facility">Patients By Facility</a></h3>
                                                        <h3 ><a href="<?php echo $base_url ?>patient_data.php?order=<?php echo $order; ?>&provider=<?php echo $provider; ?>&id=by_appointment">Patients By Appointments</a></h3>
                                                        <h3 ><a href="<?php echo $base_url ?>patient-center-batch.php">Patient Center Batch</a></h3>
                                                        <h3 ><a href="<?php echo $base_url ?>patient-statement.php">Patient Statement Batch</a></h3>
                                                    </div>
                                                </div>
                                            </div>
