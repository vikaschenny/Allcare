...
function organisation($option){
    $lorg=sqlStatement("SELECT  organization FROM users " .
                       "WHERE active = 1 AND ( info IS NULL OR info NOT LIKE '%Inactive%' ) " .
                       "AND id='$option'");
    $lorg_data=sqlFetchArray($lorg);
    return $lorg_data['organization'];
}
?>
    ...
    $sql_pdata  = sqlStatement("SELECT ope.*,pc_startTime,p.fname,p.lname ,lo.title as stat,p.*
     ...
     $d1=explode("-",$date);
     $d2=sprintf("%02d", $d1[0]).sprintf("%02d", $d1[1]).sprintf("%02d", $d1[2]);
     $count = 0;
     ...
     while($row=sqlFetchArray($sql_pdata)){
         ...
         // Get encounter id
         $encDate = $date." 00:00:00";
         $encQuery = sqlStatement("SELECT encounter FROM form_encounter WHERE pid = ".$row['pid']." AND date = '".$encDate."' ORDER BY encounter DESC LIMIT 1");
         $encRow = sqlFetchArray($encQuery);
         $encId = $encRow['encounter'];
         
         $visitTypeQuery = sqlStatement("SELECT * FROM tbl_allcare_visittypemapping avt INNER JOIN
                                         list_options lp ON avt.visit_type = lp.option_id
                                         WHERE avt.visit_category = ".$row['pc_catid']." AND lp.list_id='AllcareVisitTypes'");
         $visitTypeRow = sqlFetchArray($visitTypeQuery);
         $cptArr = explode("|",$visitTypeRow['cpt_code']);
         $auditvisitTypeArr = explode("$$",$visitTypeRow['audit_visit_category']);
         $cpt = $cptArr[1];
         $auditvisitType = $auditvisitTypeArr[1];
         
         $get_insurance_data = sqlStatement("SELECT (SELECT name FROM insurance_companies WHERE id = i.provider) as 
                                            insurancename,plan_name,policy_number FROM insurance_data i WHERE 
                                            pid = '".$row['pid']."' AND type='Primary' ORDER BY i.date DESC LIMIT 0,1");
         $getInsDetails  = sqlFetchArray($get_insurance_data);
         $getInsName = $getInsDetails['insurancename'];
         $getplanName = $getInsDetails['plan_name'];
                ...
                <tr>
                    <td colspan="2">
                        <div class="customgroup hidden-print btn-group">
                            <a class="btn btn-primary btncostime" data-href="patient_check_in.php?pid=<?php echo $row['pid']; ?>&catid=<?php echo $row['pc_catid']; ?>&cpt=<?php echo $cpt; ?>&insname=<?php echo $getInsName; ?>&plname=<?php echo $getplanName; ?>&aid=<?php echo $row['pc_aid']; ?>&audType=<?php echo $auditvisitType; ?>&pname=<?php echo $row['fname']." ". $row['lname']; ?>&dos=<?php echo $date; ?>&encId=<?php echo $encId; ?>" data-title="Check-In" data-frameheight="450" data-modalsize='modal-lg' data-bodypadding='0' class="appname" data-toggle='modal' data-target='#modalwindow' style="cursor: pointer;">Check-In</a>
                            <a class="btn btn-primary btncostime" data-apptstatus="<?php echo $sFetch['pc_apptstatus']; ?>" data-href="patient_check_out.php?dos=<?php echo $d2; ?>&pc_eid=<?php echo $encId; ?>&pid=<?php echo $row['pid']; ?>" data-title="Check-Out" data-frameheight="450" data-modalsize='modal-lg' data-bodypadding='0' class="appname" data-toggle='modal' data-target='#modalwindow'  style="cursor: pointer;">Check-Out</a>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="text-align: right;">
                        ...
                        ?>
                        <a class='various hidden-print editapp' data-title="Mark As Arrived" data-frameheight="460" data-modalsize='modal-lg' data-bodypadding='0' data-href='mark_as_arrived.php?dos=<?php echo $d2; ?>&pc_eid=<?php echo $eid; ?>&patientid=<?php echo $row['pid']; ?>' data-toggle='modal' data-target='#modalwindow' ><img src='images/editapp_success.png' alt='mark arrived' data-toggle="tooltip" data-placement="bottom" title="Arrived" width='25px'></a>
                        <?php
                        else:
                        ?>
                        ...
                        ?>
                        <a class='various hidden-print createapp' data-title="Create Appointment" data-frameheight="325" data-modalsize='modal-md' data-bodypadding='0' data-href='edit_appointment.php?date=<?php echo $d2; ?>&provider=<?php echo $id; ?>&pid=<?php echo $row['pid']; ?>' data-toggle='modal' data-target='#modalwindow'><img src='images/createapp.png' alt='create appointment' data-toggle="tooltip" data-placement="bottom" title=" Create Appointment" width='25px' ></a>
...
<!--                        <a class='various hidden-print editins' data-title="Edit Insurance" data-frameheight="500" data-modalsize='modal-lg' data-bodypadding='0' data-href='create_patient/edit_custom_insurance.php?provider=<?php echo $provider; ?>&pid=<?php echo $pid; ?>' data-toggle='modal' data-target='#modalwindow'><img src='images/ins_edit.png' alt='Edit Insurance' data-toggle="tooltip" data-placement="bottom" title=" Edit Insurance" width='25px' ></a>-->
                        <a class='various hidden-print editins' data-title="Edit Insurance" data-frameheight="500" data-modalsize='modal-lg' data-bodypadding='0' data-href='patient_file/summary/insurancedata_full.php?pid=<?php echo $row['pid']; ?>' data-toggle='modal' data-target='#modalwindow'><img src='images/ins_edit.png' alt='Edit Insurance' data-toggle="tooltip" data-placement="bottom" title=" Edit Insurance" width='25px' ></a>
                        <a class='various hidden-print Benefits' data-title="Benefits" data-frameheight="450" data-modalsize='modal-md' data-bodypadding='0' data-href='patient_file/summary/ajaxgetallplans.php' data-toggle='modal' data-target='#modalwindow' ><img src='images/benefits.png' alt='Benefits' data-toggle="tooltip" data-placement="bottom" title=" Benefits" width='31px'></a>
                        <a class='various hidden-print eligibility' data-title="Eligibility" data-frameheight="450" data-modalsize='modal-lg' data-bodypadding='0' data-href='individual_patient_eligibility.php?pid=<?php echo $row['pid']; ?>' data-toggle='modal' data-target='#modalwindow' ><img src='images/eligibility.png' alt='Eligibility' data-toggle="tooltip" data-placement="bottom" title=" Eligibility" width='25px'></a>
                    </td>
                </tr>
                <?php 
                foreach (array('primary','secondary','tertiary') as $instype) {
                    $get_insurance_data = sqlStatement("SELECT (SELECT name FROM insurance_companies WHERE id = i.provider) as insurancename,plan_name,policy_number FROM insurance_data i WHERE pid = '".$row['pid']."' AND type='$instype' ORDER BY i.date DESC LIMIT 0,1");
                ...
                <tr>
                    ...
                    <td style="vertical-align: top;padding-bottom: 6px;padding-top: 3px;">
                        : <?php echo $row['Copay']; ?><a class='various hidden-print copay' data-title="Copay" data-frameheight="450" data-modalsize='modal-lg' data-bodypadding='0' data-href='patient_payment.php?pid=<?php echo $pid; ?>&encId=<?php echo $encId;?>' data-toggle='modal' data-target='#modalwindow'><img src='images/copay.png' alt='Copay' data-toggle="tooltip" data-placement="bottom" title=" Copay" width='8px' ></a>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top">
                    ...
                    <td style="vertical-align: top padding-bottom: 6px;">
                        : <?php echo $patientbalance; ?><a class='various hidden-print blance' data-title="Patient Balance" data-frameheight="450" data-modalsize='modal-lg' data-bodypadding='0' data-href='patient_payment.php?pid=<?php echo $pid; ?>&encId=<?php echo $encId;?>' data-toggle='modal' data-target='#modalwindow'><img src='images/paitent_blance.png' alt='Patient Balance' data-toggle="tooltip" data-placement="bottom" title=" Patient Balance" width='15px' ></a>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top">
                ...
                <tr>
                    ...
                    <td style="vertical-align: top;padding-top: 3px;">
                        : <?php echo $row['street']."<a href='#'  class='mapV address hidden-print' data-toggle='modal' data-target='#showmap' id='".$row['pid']."'><img src='images/map-marker-icon.png' width='20' height='20' data-toggle='tooltip' data-placement='bottom' title=' Show map'></a>"; ?>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top">
                        : <?php 
                            if($row['providerID']!=''){
                                $qry=sqlStatement("select concat(fname,' ',lname) as name  from users where id='".$row['providerID']."'");
                                $pro_data=sqlFetchArray($qry);
                                echo $pro_data['name']; 
                            }
                          ?>
                    </td>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top">
                        :  <?php 
                            if($row['patient_facility']!=''){
                                $fac=sqlStatement("select * from facility where id=".$row['patient_facility']);
                                $fac_data=sqlFetchArray($fac);
                                echo $fac_data['name']; 
                            }
                           ?>
                    </td>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top">
                        :   <?php 
                            if($row['living_facility']!=''){
                                $lfac=sqlStatement("select * from list_options where list_id='Living_Facility' and option_id='".$row['living_facility']."'");
                                $lfac_data=sqlFetchArray($lfac);
                                echo $lfac_data['title']; 
                            }
                            ?>
                    </td>
                </tr>
                    ...
                    <td style="vertical-align: top">
                        :  <?php 
                            if($row['referral_source']!=''){
                                 $refsrc=sqlStatement("select * from list_options where list_id='refsource' and option_id='".$row['referral_source']."'");
                                 $refsrc_data=sqlFetchArray($refsrc);
                                 echo $refsrc_data['title']; 
                            }
                           ?>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top">
                        : <?php 
                            if($row['living_facility_org']!=''){
                                $lorg_data=organisation($row['living_facility_org']);
                                echo $lorg_data; 
                            }
                ...
                <tr>
                    ...
                    <td style="vertical-align: top">
                        : <?php 
                            if($row['referlink']!=''){
                                $rorg_data=organisation($row['referlink']);
                                echo $rorg_data; 
                            }
                           ?>
                    </td>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top">
                        :  <?php
                            if($row['hhagency']!=''){
                                $hh_data=organisation($row['hhagency']);
                                echo $hh_data; 
                            }
                            ?>
                    </td>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top">
                        : <?php 
                            if($row['cs_medication']!=''){
                                $cs_val='';
                                $med=explode("|",$row['cs_medication']);
                                $med_str=implode("','",$med);
                                $cs_med=sqlStatement("select * from list_options where list_id='CS_Medication_List' and option_id IN ('$med_str')");
                                while($csdata=sqlFetchArray($cs_med)){
                                    $cs_val.=$csdata['title'].',<br>'; 
                                }
                                echo trim($cs_val,',<br>');
                            }
                           ?>
...
<script>
    $(function(){
        ...
        var pdata = addr.split("||||");
        $('.mapV').each(function(index,value){
           $(this).data("hdnAddressBack1",pdata[index]);  
        }); 
    });
</script>