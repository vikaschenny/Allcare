...
INNER JOIN tbl_pos_types pt ON pt.id = p2.pos_id
 and p2.pid=".$GLOBALS['pid']." group by p2.pos_id order by pt.title asc limit 0,1 ";
...
function ins_search(ins) {
	insurance_index = ins;
        window.open('../practice/pp_ins_search.php?provider=<?php echo $provider; ?>&refer=<?php echo $_SESSION['refer']; ?>', '_blank', 300, 300);
	return false;
}
		  ...
		  <td valign=top width="430">
		   <table border="0">
			 ...
			 <tr>
			  ...
			  <td>
                              <a href='' onclick='return ins_search(<?php echo $i?>)'>
<!--                           <a href="../practice/pp_ins_search.php?provider=<?php echo $provider; ?>&refer=<?php echo $_SESSION['refer']; ?>" class="iframe medium_modal css_button" onclick="ins_search(<?php echo $i?>)">-->
				...
				?>
                              ...
                              <input type='hidden' name="i<?php echo $i?>provider_change" id="i<?php echo $i?>provider_change" value='<?php echo $result3{"provider"}; ?>'>
			  </td>
			 </tr>
			...
			<tr>
			 ...
			 <td>
			  <input type='entry' size='16' id='i<?php echo $i ?>effective_date' name='i<?php echo $i ?>effective_date'
			   ...
			   title='yyyy-mm-dd' />
                          <img src='../../interface/pic/show_calendar.gif' align='absbottom' width='24' height='22' id='img_i<?php echo $i ?>effective_date' border='0' alt='[?]' style='cursor:pointer' title='<?php xl('Click here to choose a date','e'); ?>'>
			 </td>
			</tr>
