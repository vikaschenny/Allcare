  ...
  <script>
       ...
       function getpatientcheckinfo(element,url,event) {
           ...
           $(element).addClass("active");
            ...
            if(url == 'benefits'){
                var postedurl = "patient_file/summary/ajaxgetallplans.php";
                var data      = '';
            }
            if(url == 'eligibility'){
                //var postedurl = "verify_eligibility.php";
                var postedurl = "individual_patient_eligibility.php";
                var data      = '';
            }
            if(url == 'eligibilityresponse'){
                //var postedurl = "verify_eligibility.php";
                var postedurl = "patients_eligibility_response.php";
                var data      = '';
            }
            if(url == 'estimation'){
                //var postedurl = "verify_eligibility.php";
                var postedurl = "calculated_patients_estimation.php?pid=<?php echo $pid; ?>&catid=<?php echo $catid; ?>&cpt=<?php echo $cpt; ?>&insname=<?php echo $insname; ?>&plname=<?php echo $plname; ?>&aid=<?php echo $aid; ?>&audType=<?php echo $audType; ?>&pname=<?php echo $pname; ?>&dos=<?php echo $dos; ?>";
                var data      = '';
            }
...
//                var postedurl = 'billing/patient-statement.php?form_pid=<?php echo $pid; ?>';
            ...
            if(url == 'payment'){
                ...
                var postedurl = 'patient_payment.php?pid=<?php echo $pid; ?>&encId=<?php echo $encId;?>';
                var data      = '';
            }
...
<div id="wrapper">
    <div id="sidebar-wrapper">
        ...
        <ul class="sidebar-nav" id="sidebar">
            ...
            <li><a onclick = 'getpatientcheckinfo(this,"eligibilityresponse",event)'>Eligibility Response<span class="sub_icon glyphicon glyphicon-link"></span></a></li>
            <li><a onclick = 'getpatientcheckinfo(this,"estimation",event)'>Estimation<span class="sub_icon glyphicon glyphicon-link"></span></a></li>
            <li><a style="position: relative;" onclick = 'getpatientcheckinfo(this,"payment",event)'><div>Patient Statement & Payments</div><span class="sub_icon glyphicon glyphicon-link" style="position: absolute; right: 0;"></span></a></li>
