...
//            echo "<div class='newwindow'><a href='javascript:;' onclick=win1('Issues/stats_full_custom.php?active=all&category=$grouptitle&encounter=$encounter&pid=$pid&formid=$lbf_form_id&location=provider_portal&provider=$provider&isSingleView=1') ><span>".str_replace("_"," ", ucwords($group))."</span></a></div>";
            ...
            echo "<div class='newwindow' id='$group'><a href='$group/new_custom.php?encounter=$encounter&pid=$pid&id=$static_form_id".$checkstring."&provider=".$_SESSION['portal_username']."&location=provider_portal&isSingleView=1&isFromCharts=$isFromCharts' onclick=win1(this) ><span>". ucwords(str_replace("_"," ",$group))."</span></a></div>";
...
//            echo "<div class='newwindow'><a href='javascript:;' onclick=win1('$group/new.php?encounter=$encounter&pid=$pid&id=$static_form_id&formid=$lbf_form_id&provider=$provider&location=provider_portal&isSingleView=1') ><span>".str_replace("_"," ", ucwords($group))."</span></a></div>";
            echo "<div class='newwindow' id='$group'><a href='$group/new.php?encounter=$encounter&pid=$pid&id=$static_form_id&formid=$lbf_form_id&provider=".$_SESSION['portal_username']."&location=provider_portal&isSingleView=1&isFromCharts=$isFromCharts' onclick=win1(this) ><span>". ucwords(str_replace("_"," ",$group))."</span></a></div>";
...
//            echo "<div class='newwindow'><a href='javascript:;' onclick=win1('codes/feesheet_custom.php?pid=$pid&encounter=$encounter&provider=$provider&location=provider_portal&isSingleView=1') ><span>".str_replace("_"," ", ucwords($group))."</span></a></div>";
            echo "<div class='newwindow' id='$group'><a href='codes/feesheet_custom.php?pid=$pid&encounter=$encounter&provider=".$_SESSION['portal_username']."&location=provider_portal&isSingleView=1&isFromCharts=$isFromCharts' onclick=win1(this) ><span>". ucwords(str_replace("_"," ",$group))."</span></a></div>";
        }
        else if($group == 'ros'){
            $group = "allcare_ros";
...
//            echo "<div class='newwindow'><a href='javascript:;' onclick=win1('$group/view_custom.php?formname=$group&encounter=$encounter&pid=$pid&id=$ros_form_id&provider=$provider&location=provider_portal&isSingleView=1') ><span>".$form_name."</span></a></div>";
            echo "<div class='newwindow' id='$group'><a href='$group/view_custom.php?formname=$group&encounter=$encounter&pid=$pid&id=$ros_form_id&provider=".$_SESSION['portal_username']."&location=provider_portal&isSingleView=1&isFromCharts=$isFromCharts' onclick=win1(this) ><span>".$form_name."</span></a></div>";
        }
            ...
            echo "<div class='newwindow' id='$group'><a href='$group/new_custom.php?formname=$group&edit=custom_pe&encounter=$encounter&pid=$pid&id=$allcare_physical_exam_form_id&menu_val=&provider=".$_SESSION['portal_username']."&location=provider_portal&isSingleView=1&isFromCharts=$isFromCharts' onclick=win1(this) ><span>". ucwords(str_replace("_"," ",$group))."</span></a></div>";
        }
