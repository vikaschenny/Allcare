...
$insuredID = $_REQUEST['insuredID'];
$defaultFacility = $_REQUEST['defaultFacility'];
$from=$_REQUEST['form_from_date'];
$to=$_REQUEST['form_tol_date'];
$patlistselect = $_REQUEST['patlistselect'];
...
//                                                                      AND o.pc_eventDate = DATE_FORMAT( fe.date,  '%Y-%m-%d' )where o.pc_aid =$id group by fe.pid";
                                            ...
                                            <div id="ourtable">
                                                <div id="ourrow">
                                                    <div id="td1"> 
                                                       <h3 ><a  href='javascript:;' onclick=DoPost_patient('<?php echo $base_url ?>patient_data.php?order=<?php echo $order; ?>&provider=<?php echo $provider; ?>&id=my_patients')>My Patients</a></h3>
                                                        <h3 ><a  href='javascript:;' onclick=DoPost_patient('<?php echo $base_url ?>patient_data.php?order=<?php echo $order; ?>&provider=<?php echo $provider; ?>&id=all_patients')>All Patients</a></h3>
                                                        <h3 ><a  href='javascript:;' onclick=DoPost_patient('<?php echo $base_url ?>patient_data.php?order=<?php echo $order; ?>&provider=<?php echo $provider; ?>&id=by_facility')>Patients By Facility</a></h3>
                                                        <h3 ><a  href='javascript:;' onclick=DoPost_patient('<?php echo $base_url ?>patient_data.php?order=<?php echo $order; ?>&provider=<?php echo $provider; ?>&id=by_appointment')>Patients By Appointments</a></h3>
                                                        <?php  $sql_vis=sqlStatement("SELECT provider_plist_links from tbl_user_custom_attr_1to1 where userid='".$id['id']."'");
                                                               ...
                                                               if(!empty($row1_vis)){
                                                                    ...
                                                                    if(in_array('patient_center',$links)){ ?>
                                                                          <h3 ><a href='javascript:;' onclick=DoPost_patient('<?php echo $base_url ?>patient-center-batch.php?provider=<?php echo $provider; ?>')>Patient Center Batch</a></h3>
                                                                    <?php }
                                                                    if(in_array('patient_stat',$links)){ ?>
                                                                         <h3 ><a href='javascript:;' onclick=DoPost_patient('<?php echo $base_url ?>patient-statement.php?provider=<?php echo $provider; ?>')>Patient Statement Batch</a></h3>
                                                                    <?php }
                                                                } ?>
                                                    </div>
                                                     <div id="td2"> 
