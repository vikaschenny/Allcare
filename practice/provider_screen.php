...
if(empty($id)){
     header('Location: ../practice/login_test.php?site=default');
}
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#iframe').contents().find("head").append($("<style type='text/css'>  .body_top { background-color: #638fd0; margin: 8px; background: -webkit-radial-gradient(circle, white, #638fd0);}  </style>"));
        });
   });
</script>
<title>
...
<iframe frameborder="1" src="provider_menu_list.php?provider_id=<?php echo $_POST['authUser']; ?>" width="100%" height="115px" scrolling="no" bgcolor="#C9D3DE"> </iframe> 
<iframe frameborder="1" src="incomplete_encounter_count.php?provider_id=<?php echo $_POST['authUser']; ?>" width="100%" height="100%" scrolling="yes" bgcolor="#C9D3DE" name="content" id="iframe"> </iframe> 
