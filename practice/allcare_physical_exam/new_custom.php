    ...
    if (! $_POST['form_refresh']&&$location=='') {
        if($isSingleView == 1 && $isFromCharts == 0){
            echo "<script>window.close();
                window.opener.location.href = '../../../practice/single_view_form.php?encounter=$encounter&pid=$pid1';</script>";
            ...
            echo "<script>window.close();
                window.opener.location.href = '../../../practice/provider_incomplete_charts.php?checkencounter=$encounter';</script>";
        }
        exit;
