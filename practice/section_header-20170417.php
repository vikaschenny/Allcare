        ...
        <div style="background-color:#e7e7e7 !important; height:39px; padding-top:4px; padding-right:20px;">
            <div class="pull-right userlogout">
                ...
                while($row = sqlFetchArray($query)){
                    $practicecentral = $row['title'];
                }
                if($practicecentral == 1):
                ?>
                <select id="practiceid">
                    <option disabled="disabled">Select Practice ID</option>
                </select>
                <?php
                endif;
                ?>
...
<script>
    ...
    $(function(){
        ...
        ajaxcall("practiceload.php",{uemail:'<?php echo $_SESSION['portal_useremail'];?>',type:'uemail'},"post",function(data){
                    var dt = $.parseJSON(data);
                    var dtarr = [];
                    var datahtml = "<option disabled='disabled'>Select Practice ID</option>";
                    console.log(data);
        ...
        $("#practiceid").change(function(event){
            ...
            var pracUrl = '';
            ajaxcall("practiceload.php",{practiceid:prac[3],type:'practiceid'},"post",function(data){
                 pracUrl = data;
  ...
  <body>
      ...
      ?>
      <section style="padding-top:100px !important; min-height: 100%;" class='container-fluid'>
