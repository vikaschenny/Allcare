...
function echoLine($iname, $date, $charges, $ptpaid, $inspaid, $duept,$encounter=0,$copay=0,$patcopay=0) {
  ...
  echo " <tr id='tr_".attr($var_index)."' style='outline: thin solid'>\n";
  ...
  echo "  <td align='right'><input type='text' name='".attr($iname)."'  id='paying_".attr($var_index)."' " .
  ...
  echo "  <td class='detail' align='right'><table><tr><td class='detail' align='right'>Copay<input type='text' name='".attr($iname)."'  id='paying_".attr($copay)."' " .
    " value='" .  '' . "' onchange='coloring();calctotal()'  autocomplete='off' " .
    "onkeyup='calctotal()'  style='width:50px'/></td></tr><tr><td class='detail' align='right'>Deductable<input type='text' name='".attr($iname)."'  id='paying_".attr($copay)."' " .
    " value='" .  '' . "' onchange='coloring();calctotal()'  autocomplete='off' " .
    "onkeyup='calctotal()'  style='width:50px'/></td></tr></table></td>";
  echo "  <td class='detail' align='right'><table><tr><td class='detail' align='right'>Copay<input type='text' name='".attr($patcopay)."'  id='paying_".attr($copay)."' " .
    " value='" .  '' . "' onchange='coloring();calctotal()'  autocomplete='off' " .
    "onkeyup='calctotal()'  style='width:50px'/></td></tr><tr><td class='detail' align='right'>Deductable<input type='text' name='".attr($patcopay)."'  id='paying_".attr($copay)."' " .
    " value='" .  '' . "' onchange='coloring();calctotal()'  autocomplete='off' " .
    "onkeyup='calctotal()'  style='width:50px'/></td></tr><tr><td class='detail' align='right'>Self Pay<input type='text' name='".attr($patcopay)."'  id='paying_".attr($copay)."' " .
    " value='" .  '' . "' onchange='coloring();calctotal()'  autocomplete='off' " .
    "onkeyup='calctotal()'  style='width:50px'/></td></tr><tr><td class='detail' align='right'>No Secondary<input type='text' name='".attr($patcopay)."'  id='paying_".attr($copay)."' " .
    " value='" .  '' . "' onchange='coloring();calctotal()'  autocomplete='off' " .
    "onkeyup='calctotal()'  style='width:50px'/></td></tr><tr><td class='detail' align='right'>Others<input type='text' name='".attr($patcopay)."'  id='paying_".attr($copay)."' " .
    " value='" .  '' . "' onchange='coloring();calctotal()'  autocomplete='off' " .
    "onkeyup='calctotal()'  style='width:50px'/></td></tr></table></td>";
//  echo "  <td class='detail' align='center' id='td_patient_copay_$var_index' >" . htmlspecialchars(bucks($patcopay), ENT_QUOTES) . "</td>\n";
...
<table border='0' cellspacing='0' cellpadding="0">
 ...
 <tr id="tr_radio1" style="display:none"><!-- For radio Insurance -->
  <td class='text' valign="top"  >
   <?php echo htmlspecialchars(xl('Payment to'), ENT_QUOTES); ?>:
  </td>
 ...
 <tr id="tr_radio2"><!-- For radio self -->
  <td class='text' valign="top" >
   <?php echo htmlspecialchars(xl('Payment towards'), ENT_QUOTES); ?>:
  </td>
  <td class='text' colspan="2" ><input type="radio" name="radio_type_of_payment" id="radio_type_of_payment1" value="copay" checked="checked" onClick="make_visible_row();cursor_pointer();"/><?php echo htmlspecialchars(xl('Co Pay'), ENT_QUOTES); ?><input type="radio" name="radio_type_of_payment" id="radio_type_of_payment2" value="invoice_balance"  onClick="make_visible_row();"/><?php echo htmlspecialchars(xl('Past Balance'), ENT_QUOTES); ?><br/><input type="radio" name="radio_type_of_payment" id="radio_type_of_payment4" value="pre_payment" onClick="make_hide_row();"/><?php echo htmlspecialchars(xl('Pre Pay'), ENT_QUOTES); ?><input type="radio" name="radio_type_of_payment" id="radio_type_of_payment1" value="deductable" checked="checked" onClick="make_visible_row();cursor_pointer();"/><?php echo htmlspecialchars(xl('Deductable'), ENT_QUOTES); ?></td>
 </tr>
...
<table border='0' id="table_display" cellpadding='0' cellspacing='0' width='900'>
 <tr bgcolor="#cccccc" id="tr_head">
  ...
  <td class="dehead" width="70">
   <?php echo htmlspecialchars( xl('CPT'), ENT_QUOTES) ?>
  </td>
  <td class="dehead" width="65">
   <?php echo htmlspecialchars( xl('Billing Note'), ENT_QUOTES) ?>
  </td>
  <td class="dehead" width="70">
   <?php echo htmlspecialchars( xl('Billing Reason'), ENT_QUOTES) ?>
  </td>
  ...
  <td class="dehead" align="right" width="250" id="td_head_patient_co_pay" >
   <?php echo htmlspecialchars( xl('Current Visit'), ENT_QUOTES) ?>
  </td>
	<td class="dehead" align="right" width="300" id="td_head_co_pay" >
   <?php echo htmlspecialchars( xl('Past Balance'), ENT_QUOTES) ?>
  </td>
