...
?>
    ...
    <div style='float:left;margin-right:10px'>
      ...
      <a href="../summary/demographics.php" ><?php echo htmlspecialchars( getPatientName($patient_id), ENT_NOQUOTES); ?></a></span>
    </div>
    <div>
        <a href="pnotes_full_add.php?<?php echo $urlparms; ?>" class="css_button iframe"><span><?php echo xlt('Add'); ?></span></a>
        <a href="demographics.php" <?php if (!$GLOBALS['concurrent_layout']) echo "target='Main'"; ?> class="css_button" >
    ...
    <?php } else { ?>
      <a href="pnotes_full.php?<?php echo $urlparms; ?>" class="link" ><span><?php echo xlt('Show All'); ?></span></a>
    <?php } ?>
    |
    <?php if ($active == '1') { ?>
      <span><?php echo xlt('Show Active'); ?></span>
    <?php } else { ?>
      <a href="pnotes_full.php?form_active=1&<?php echo $urlparms; ?>" class="link" ><span><?php echo xlt('Show Active'); ?></span></a>
    <?php } ?>
    |
    <?php if ($active == '0') { ?>
      <span><?php echo xlt('Show Inactive'); ?></span>
    <?php } else { ?>
      <a href="pnotes_full.php?form_inactive=1&<?php echo $urlparms; ?>" class="link" ><span><?php echo xlt('Show Inactive'); ?></span></a>
    <?php } ?>
    </div>
