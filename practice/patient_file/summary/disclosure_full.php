...
<div style='float: left; margin-right: 10px'><?php echo htmlspecialchars(xl('for'),ENT_NOQUOTES); ?>&nbsp;
	<span class="title"><a href="../summary/demographics.php" ><?php echo htmlspecialchars(getPatientName($pid),ENT_NOQUOTES); ?></a></span>
</div>
<div>
...
<div>
	...
	class="css_button" > <span><?php echo htmlspecialchars(xl('View Patient'),ENT_NOQUOTES); ?></span></a>
</div>
<br>
<br>
<?php
