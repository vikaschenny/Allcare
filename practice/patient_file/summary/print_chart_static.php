...
//provider
            ...
            while ($settitles = sqlFetchArray($gettitles)) {
                ...
                if (mysql_num_rows($getselectedvales) == 0) {
                    ...
                    <script>
                        ...
                        obj.push({"id": "<?php echo $setgroupnames['group_name']; ?>", "value": "none"});
                    </script>
                    <?php
                }
                    ...
                    if (!empty($getgroupval)) {
                        ...
                        if ($add == 0) {
                            ...
                            <script>
                                ...
                                obj.push({"id": "<?php echo "1" . $idName . $j; ?>", "value": "none"});
                                document.getElementById('<?php echo $setgroupnames['group_name']; ?>').style.display = "none";
                                obj.push({"id": "<?php echo $setgroupnames['group_name']; ?>", "value": "none"});
                            </script> 
                            <?php
    ...
    function display_insurance($patient_id) {
        ...
        if ($datacheck == '') {
            ?>
            <script>
                obj.push({"id": "show_div_insurance", "value": "none"});
            </script>           
            <style type="text/css">
                #show_div_insurance{
                    display:none;
    ...
    function display_medications($eid, $pid, $groupName, $layout_type) {
        ...
        if (count($data2) > 0):
            ...
            <script>
                ...
                obj.push({"id": "show_div_med<?php echo $eid; ?>", "value": "block"});
            </script> 
            <?php
        else:
...
//                    echo "<li><b> Seen by: </b> ".$set_rendering_provider['provider_name']."</li>";
            ...
            <script>
                ...
                obj.push({"id": "show_div_vitals<?php echo $encounter; ?>", "value": "block"});
            </script> 
                ...
                if ($sub == 0) {
                    ...
                    if ($checkval == 1) {
                        ...
                        ?><script>
                                            ...
                                            obj.push({"id": "constitutional<?php echo $encounter; ?>", "value": "block"});
                        </script>
                        <?php
                        $checkingval = 1;
                    }
                ...
                if ($sub == 0) {
                    ...
                    foreach ($rowROSFields as $key => $value) {
                        if ($key == 'change_in_vision' || $key == 'glaucoma_history' || $key == 'eye_pain' || $key == 'irritation' || $key == 'redness' || $key == 'excessive_tearing' || $key == 'double_vision' || $key == 'blind_spots' || $key == 'photophobia' || $key == 'glaucoma' || $key == 'cataract' || $key == 'injury' || $key == 'ha' || $key == 'coryza' || $key == 'obstruction') {
                            if ($key == "glaucoma_history") {
                                $key = "Glaucoma Family History";
                            }
                            if ($key == "irritation") {
                                $key = "Eye Irritation";
                            }
                    ...
                    if ($checkval == 1) {
                        ...
                        ?><script>
                                            ...
                                            obj.push({"id": "eyes<?php echo $encounter; ?>", "value": "block"});
                        </script>
                        <?php
                        $checkingval = 1;
                    }
                ...
                if ($sub == 0) {
                    ...
                    if ($checkval == 1) {
                        ...
                        ?><script>
                                            ...
                                            obj.push({"id": "ent<?php echo $encounter; ?>", "value": "block"});
                        </script>
                        <?php
                        $checkingval = 1;
                    }
                ...
                if ($sub == 0) {
                    ...
                    if ($checkval == 1) {
                        ...
                        ?><script>
                                            ...
                                            obj.push({"id": "neck<?php echo $encounter; ?>", "value": "block"});
                        </script>
                        <?php
                        $checkingval = 1;
                    }
                ...
                if ($sub == 0) {
                    ...
                    if ($checkval == 1) {
                        ...
                        ?><script>
                                            ...
                                            obj.push({"id": "breast<?php echo $encounter; ?>", "value": "block"});
                        </script>
                        <?php
                        $checkingval = 1;
                    }
                ...
                if ($sub == 0) {
                    ...
                    if ($checkval == 1) {
                        ...
                        ?><script>
                                            ...
                                            obj.push({"id": "respiratory<?php echo $encounter; ?>", "value": "block"});
                        </script>
                        <?php
                        $checkingval = 1;
                    }
                ...
                if ($sub == 0) {
                    ...
                    foreach ($rowROSFields as $key => $value) {
                        if ($key == 'chest_pain' || $key == 'palpitation' || $key == 'syncope' || $key == 'pnd' || $key == 'doe' || $key == 'orthopnea' || $key == 'peripheal' || $key == 'edema' || $key == 'legpain_cramping' || $key == 'history_murmur' || $key == 'arrythmia' || $key == 'heart_problem') {
                            ...
                            if ($key == "legpain_cramping") {
                                $key = "Leg Pain/Cramping";
                            }
                            if ($value == 'YES'):
                                echo ucwords(str_replace('_', ' ', $key)) . " YES<br>";
                                $checkval = 1;
                    ...
                    if ($checkval == 1) {
                        ...
                        ?><script>
                                            ...
                                            obj.push({"id": "cardiovascular<?php echo $encounter; ?>", "value": "block"});
                        </script>
                        <?php
                        $checkingval = 1;
                    }
                ...
                if ($sub == 0) {
                    ...
                    if ($checkval == 1) {
                        ...
                        ?><script>
                                            ...
                                            obj.push({"id": "gastrointestinal<?php echo $encounter; ?>", "value": "block"});
                        </script>
                        <?php
                        $checkingval = 1;
                    }
                ...
                if ($sub == 0) {
                    ...
                    if ($checkval == 1) {
                        ...
                        ?><script>
                                            ...
                                            obj.push({"id": "genitourinary<?php echo $encounter; ?>", "value": "block"});
                        </script>
                        <?php
                        $checkingval = 1;
                    }
                ...
                if ($sub == 0) {
                    ...
                    if ($checkval == 1) {
                        ...
                        ?><script>
                                            ...
                                            obj.push({"id": "genitourinarymale<?php echo $encounter; ?>", "value": "block"});
                        </script>
                        <?php
                        $checkingval = 1;
                    }
                ...
                if ($sub == 0) {
                    ...
                    if ($checkval == 1) {
                        ...
                        ?><script>
                                            ...
                                            obj.push({"id": "genitourinaryfemale<?php echo $encounter; ?>", "value": "block"});
                        </script>
                        <?php
                        $checkingval = 1;
                    }
                ...
                if ($sub == 0) {
                    ...
                    if ($checkval == 1) {
                        ...
                        ?><script>
                                            ...
                                            obj.push({"id": "musculoskeletal<?php echo $encounter; ?>", "value": "block"});
                        </script>
                        <?php
                        $checkingval = 1;
                    }
                ...
                if ($sub == 0) {
                    ...
                    if ($checkval == 1) {
                        ...
                        ?><script>
                                            ...
                                            obj.push({"id": "extremities<?php echo $encounter; ?>", "value": "block"});
                        </script>
                        <?php
                        $checkingval = 1;
                    }
                ...
                if ($sub == 0) {
                    ...
                    if ($checkval == 1) {
                        ...
                        ?><script>
                                            ...
                                            obj.push({"id": "neurologic<?php echo $encounter; ?>", "value": "block"});
                        </script>
                    <?php
                    $checkingval = 1;
                }
            ...
            if ($sub == 0) {
                ...
                if ($checkval == 1) {
                    ...
                    ?><script>
                                            ...
                                            obj.push({"id": "skin<?php echo $encounter; ?>", "value": "block"});
                        </script>
                        <?php
                        $checkingval = 1;
                    }
                ...
                if ($sub == 0) {
                    ...
                    if ($checkval == 1) {
                        ...
                        ?><script>
                                            ...
                                            obj.push({"id": "psychiatric<?php echo $encounter; ?>", "value": "block"});
                        </script>
                        <?php
                        $checkingval = 1;
                    }
                ...
                if ($sub == 0) {
                    ...
                    if ($checkval == 1) {
                        ...
                        ?><script>
                                            ...
                                            obj.push({"id": "endocrine<?php echo $encounter; ?>", "value": "block"});
                        </script>
                        <?php
                        $checkingval = 1;
                    }
...
//                }
                ...
                if ($sub == 0) {
                    ...
                    foreach ($rowROSFields as $key => $value) {
                        if ($key == 'anemia' || $key == 'fh_blood_problems' || $key == 'bleeding_problems' || $key == 'allergies' || $key == 'frequent_illness' || $key == 'hiv' || $key == 'hai_status' || $key == 'hay_fever' || $key == 'positive_ppd') {
                            if ($key == "fh_blood_problems") {
                                $key = "FH Blood Problems";
                            }
                            if ($key == "hiv") {
                                $key = "HIV";
                            }
                    ...
                    if ($checkval == 1) {
                        ...
                        ?><script>
                                            ...
                                            obj.push({"id": "hai<?php echo $encounter; ?>", "value": "block"});
                        </script>
                        <?php
                        $checkingval = 1;
                    }
            ...
            if ($checkingval == 1) {
                ...
                <script>
                    ...
                    obj.push({"id": "show_div_ros<?php echo $encounter; ?>", "value": "block"});
                </script> 
                <?php
            }
        } else {
...
//            endif;
            ...
            <script>
                ...
                obj.push({"id": "show_div_physical_exam<?php echo $encounter; ?>", "value": "block"});
            </script> 
                ...
                if ($datacheck == '') {
                    ...
                    ?>
                        <script>
                            ...
                            obj.push({"id": "show_div_cc<?php echo $encounterid; ?>", "value": "block"});
                        </script> 
                        <?php
                    }
                }
                ...
                for ($i = 0; $i < count($setformid); $i++) {
                        ...
                        if (!empty($getCCdataResult2['field_value'])) {
                            ...
                            if (!empty($getCCdataResult2)):
                                if (strcmp($fkey, 'Progress Note Status') == 0):
                                    ...
                                    echo nl2br($getCCdataResult2['field_value']);
                                endif;
                            endif;
                            echo "</li>";
                        }
                    ...
                    if ($datacheck == '') {
                        ...
                        <script>
                            ...
                            obj.push({"id": "show_div_progress<?php echo $encounterid; ?>", "value": "block"});
                        </script> 
                        <?php
                    }
                }
    ...
    function display_hpi($encounterid, $groupName) {
        global $tempvalue;
...
//            echo "<h2>HPI Data</h2>";
                    ...
                    if (!empty($sethistorypast['field_value'])) { 
                        echo "<br><b> Past Medical History:</b>" . $sethistorypast['field_value'];
                        $check = 1;
                    }
...
//            }  
                    ...
                    if ($datacheck == '' && $check == '') {
                        ...
                        <script>
                            ...
                            obj.push({"id": "show_div_hpi<?php echo $encounterid; ?>", "value": "block"});
                        </script> 
                        <?php
                    }
                }
                ...
                for ($i = 0; $i < count($setformid); $i++) {
                        ...
                        if (!empty($getassessmentdataResult2['field_value'])) {
                            ...
                            if (!empty($getassessmentdataResult2)):
                                if (strcmp($fkey, 'Assessment Note Status') == 0):
                                    ...
                                    echo nl2br($getassessmentdataResult2['field_value']);
                                endif;
                            endif;
                            echo "</li>";
                        }
                    ...
                    if ($datacheck == '') {
                        ...
                        <script>
                            ...
                            obj.push({"id": "show_div_assess<?php echo $encounterid; ?>", "value": "block"});
                        </script> 
                ...
                for ($i = 0; $i < count($setformid); $i++) {
                        ...
                        if (!empty($getplandataResult2['field_value'])) {
                            ...
                            if (!empty($getplandataResult2)):
                                if (strcmp($fkey, 'Plan Note Status') == 0):
                                    ...
                                    echo nl2br($getplandataResult2['field_value']);
                                endif;
                            endif;
                            echo "</li>";
                        }
                    ...
                    if ($datacheck == '') {
                        ...
                        <script>
                            ...
                            obj.push({"id": "show_div_plan<?php echo $encounterid; ?>", "value": "block"});
                        </script> 
                    <?php
                }
            }

            $get_quality_care = sqlStatement("SELECT field_value FROM lbf_data WHERE field_id = 'quality_of_care' AND form_id = '$formid'");
            $set_quality_care = sqlFetchArray($get_quality_care);
            $explode_quality = array();

            if (!empty($set_quality_care['field_value'])) {

                $explode_quality = explode("|", $set_quality_care['field_value']);
            }

            if (count($explode_quality) > 0):
                echo "<br><li><b> Quality Of Care </b></li>";
                for ($i = 0; $i < count($explode_quality); $i++) {
                    $get_quality_care_title = sqlStatement("SELECT title FROM list_options WHERE option_id = $explode_quality[$i] AND list_id = 'Quality_Of_Care'");
                    $set_quality_care_title = sqlFetchArray($get_quality_care_title);
                    echo "<li>" . ($i + 1) . "." . $set_quality_care_title['title'] . ".</li>";
                }
            endif;
        else:
        //echo " No Plan Note for this date of service";
            ...
            foreach ($data2 as $key => $value) {
                ...
                if ($datacheck == '') {
                    ...
                    ?> <script>
                                            ...
                                            obj.push({"id": "show_div_mproblem<?php echo $eid; ?>", "value": "block"});
                        </script> <?php
                    }
                }
            } else {
    ...
    function display_allergy($encounterid, $layout_type, $groupName) {
        ...
        if ($encounterid != 0) {
            ...
            $allegrysqlquery .= " SELECT DISTINCT l.id, l.title AS Title, 
                                    ...
                                    FROM lists AS l
                                    WHERE l.type =  'allergy'
                                    AND l.pid =" . $_SESSION['pid'] . " AND l.id NOT IN ( SELECT DISTINCT list_id FROM issue_encounter WHERE pid =" . $_SESSION['pid'] . " ) 
                                    ORDER BY is_Issue_Active ASC , begdate DESC";
        }
                ...
                foreach ($dataallergy as $key => $value) {
                    ...
                    if ($datacheck == '') {
                        ...
                        <script>
                            ...
                            obj.push({"id": "show_div_allergy<?php echo $encounterid; ?>", "value": "block"});
                        </script>    
                        <?php
                        $tempvalue = 0;
                    }
                ...
                foreach ($datasurgery as $key => $value) {
                    ...
                    if ($datacheck == '') {
                        ...
                        <script>
                            ...
                            obj.push({"id": "show_div_surgery<?php echo $encounterid; ?>", "value": "block"});
                        </script>
                        <?php
                        $tempvalue = 0;
                    }
                ...
                foreach ($datadental as $key => $value) {
                    ...
                    if ($datacheck == '') {
                        ...
                        <script>
                            ...
                            obj.push({"id": "show_div_dental<?php echo $encounterid; ?>", "value": "block"});
                        </script>
                        <?php
                    }
                }
                ...
                for ($i = 0; $i < count($setformid); $i++) {
                    ...
                    if ($datacheck == '') {
                        ...
                        <script>
                            ...
                            obj.push({"id": "show_div_f2f<?php echo $encounter1; ?>", "value": "block"});
                        </script>
                        <?php
                    }
                }
...
//                echo " No Face to Face Data for this patient";
                ...
                foreach ($datadme as $key => $value) {
                    ...
                    if ($datacheck == '') {
                        ...
                        <script>
                            ...
                            obj.push({"id": "show_div_dme<?php echo $encounterid; ?>", "value": "block"});
                        </script>
                        <?php
                        $tempvalue = 0;
                        echo "<li>&nbsp;</li>";
    ...
    function display_prescription($layout_type) {
        global $tempvalue;
        $pressql = sqlStatement("SELECT  * FROM  `prescriptions` WHERE  `patient_id` =" . $GLOBALS['pid'] . " order by active desc ,date_added desc ");
                ...
                foreach ($datapre as $value) {
                    ...
                    if ($datacheck == '') {
                        ...
                        <script>
                            ...
                            obj.push({"id": "show_div_prescript0", "value": "block"});
                        </script>
        ...
        if ($orderid !== '') {
            if ($layout_type == 'list') {
                ...
                ?><script>
                                    ...
                                    obj.push({"id": "show_div_procedure<?php echo $encounter; ?>", "value": "block"});
                    </script>
                ...
                $orow = sqlQuery("SELECT " .
                        ...
                        "LEFT JOIN users AS u ON u.id = po.provider_id " .
                        "LEFT JOIN form_encounter AS fe ON fe.pid = po.patient_id AND fe.encounter = po.encounter_id " .
                        "WHERE po.procedure_order_id = ?", array($orderid));
                ?>
    ...
    function display_cert_recert($encounterid, $groupName) {
        ...
        $getCC = sqlStatement("SELECT field_id,title FROM layout_options WHERE form_id = 'LBF2' AND group_name LIKE '%Certification_Recertification' order by seq");
        while ($getCCResult = sqlFetchArray($getCC)) {
            for ($i = 0; $i < count($listselected); $i++) {
                if ($listselected[$i] == $getCCResult['field_id']):
                    $fieldid[$getCCResult['title']] = $getCCResult['field_id'];
...
//                        endif;
                    ...
                    if ($datacheck == '') {
                        ...
                        <script>
                            ...
                            obj.push({"id": "show_div_cert_recert<?php echo $encounterid; ?>", "value": "block"});
                        </script> 
                        <?php
                    }
                }
    ...
    function display_cpo($encounterid, $groupName) {
        ...
        while ($getCCResult = sqlFetchArray($getCC)) {
            for ($i = 0; $i < count($listselected); $i++) {
                if ($listselected[$i] == $getCCResult['field_id']):
                    ${$getCCResult['field_id']} = $getCCResult['field_id'];
                    ${"title" . $getCCResult['field_id']} = $getCCResult['title'];
                    $fieldid[$getCCResult['title']] = $getCCResult['field_id'];
                endif;
            }
        }
...
//                $cpoarray = unserialize($value);
                    $cpo_data2 = preg_replace_callback('!s:(\d+):"(.*?)";!', function($match) {
                            ...
                            if (!empty($value1)) {
                                if (${$key1} == 'cpotype') {
                                    if ($key1 == 'cpotype') {
                                        ...
                                        echo "<li><b>" . ${"title" . $key1} . ":" . "</b>" . $crow['title'] . "</li>";
                                    }
                                    ...
                                    if ($key1 == 'timeinterval') {
                                        ...
                                        echo "<li><b>" . ${"titlecpo_" . $key1} . ":" . "</b>" . $time2['title'] . "</li>";
                                    } elseif ($key1 == 'users') {
                                        $users = sqlStatement("SELECT CONCAT(fname,' ',lname) AS name FROM users WHERE id='$value1'");
                                        $urow_data = sqlFetchArray($users);
                                        // echo "<pre>"; print_r($urow_data); echo "</pre>";
                                        echo "<li><b>" . ${"titlecpo_" . $key1} . ":" . "</b>" . $urow_data['name'] . "</li>";
                                    } else {
                                        echo "<li><b>" . ucwords(str_replace('_', ' ', ${"titlecpo_" . $key1})) . ":" . "</b>" . $value1 . "</li>";
                                    }
                                }
                            }
                        }
            ...
            <script>
                ...
                obj.push({"id": "show_div_cpo<?php echo $encounterid; ?>", "value": "block"});
            </script>
            <?php
            $tempvalue = 0;
        }else {
    ...
    function display_ccm($encounterid, $groupName) {
        global $tempvalue;
        $getCC = sqlStatement("SELECT field_id,title FROM layout_options WHERE form_id = 'LBF2' AND group_name LIKE '%CCM'");
        $getselectedvales = sqlStatement("SELECT field_id as selectedfield FROM tbl_chartui_mapping WHERE screen_name = '$groupName' AND form_id = 'LBF2' AND group_name LIKE '%CCM' AND option_value = 'YES'");
        while ($setselectedvalues = sqlFetchArray($getselectedvales)) {
            $listselected[] = $setselectedvalues['selectedfield'];
        }
        while ($getCCResult = sqlFetchArray($getCC)) {
        ...
        $date3 = sqlStatement("select cp.ccm_data, cp.provider_id  from tbl_form_ccm cp INNER JOIN form_encounter fe on fe.pid=cp.pid INNER JOIN forms f on fe.encounter = f.encounter AND f.form_id=cp.id  where cp.pid=" . $GLOBALS['pid'] . " AND fe.encounter='$encounterid' AND form_name='ccm' and deleted=0 group by cp.id ");
        $fdate2 = sqlFetchArray($date3);
        if (!empty($fdate2)) {
            foreach ($fdate2 as $key => $value) {
                if ($key == 'ccm_data') {
//                $ccmarray = unserialize($value);
                    $ccm_data2 = preg_replace_callback('!s:(\d+):"(.*?)";!', function($match) {
                        return ($match[1] == strlen($match[2])) ? $match[0] : 's:' . strlen($match[2]) . ':"' . $match[2] . '";';
                    }, $value);
                    ...
                    for ($i = 0; $i < count($ccmarray); $i++) {
                        foreach ($ccmarray[$i] as $key1 => $value1) {
                            if (!empty($value1)) {
                                if (${$key1} == 'ccmtype') {
                                    if ($key1 == 'ccmtype') {
                                        $ctype = sqlStatement("select title from list_options where list_id='CCM_types' AND option_id='$value1'");
                                        $crow = sqlFetchArray($ctype);
                                        echo "<li><b>" . ${"title" . $key1} . ":" . "</b>" . $crow['title'] . "</li>";
                                    }
                                    ...
                                    if ($key1 == 'timeinterval') {
                                        $time = sqlStatement("select title from list_options where list_id='Time_Interval' AND option_id='$value1'");
                                        $time2 = sqlFetchArray($time);
                                        echo "<li><b>" . ${"titleccm_" . $key1} . ":" . "</b>" . $time2['title'] . "</li>";
                                    } elseif ($key1 == 'users') {
                                        $users = sqlStatement("SELECT CONCAT(fname,' ',lname) AS name FROM users WHERE id='$value1'");
                                        $urow_data = sqlFetchArray($users);
                                        // echo "<pre>"; print_r($crow_data); echo "</pre>";
                                        echo "<li><b>" . ${"titleccm_" . $key1} . ":" . "</b>" . $urow_data['name'] . "</li>";
                                    } else {
                                        echo "<li><b>" . ucwords(str_replace('_', ' ', ${"titleccm_" . $key1})) . ":" . "</b>" . $value1 . "</li>";
                                    }
                                }
                            }
                        }
            ...
            ?>
            <script>
                document.getElementById('show_div_ccm<?php echo $encounterid; ?>').style.display = "block";
                obj.push({"id": "show_div_ccm<?php echo $encounterid; ?>", "value": "block"});
            </script>
        <?php
        $tempvalue = 0;
    }else {
        //echo "<li>"."No CCM Log for this date of service."."</ii>";
        //if($min == 1)
        //$tempvalue = 1 ;
    }
}
...
<html>
    <head>
        <title>Medical Record</title>
            <style>
                ...
                #fancy_close{
                    background: rgba(0, 0, 0, 0) url("../../../library/js/fancybox-1.3.4/fancy_close.png") no-repeat scroll left top;
                    cursor: pointer;
                    display: none;
                    height: 30px;
                    position: absolute;
    ...
    <body>   
        <div>
         <?php
            // FOR LAYOUT data created from who as start page info
            $who_type = $rowChartOutputTrans['who_type'];
            $form_notes = $rowChartOutputTrans['notes'];
            if ($who_type != '' || $form_notes != '') {
                    display_div_function('Patient Information', 0);

                    if ($who_type == 'provider') {
                        $provider = $rowChartOutputTrans['provider'];
                        ...
                        echo "<table border='0'>";
                        echo "<tr><td><h3> To</h3> </td></tr><tr><td>";
                        echo "<table  border='0' style='padding-left:50px;'>";
                        echo "<tr><td><b>Name:</b></td><td>" . $pro_res['title'] . " " . $pro_res['fname'] . " " . $pro_res['lname'] . " " . $pro_res['mname'] . "</td></tr>";
                        if ($pro_res['specialty'] != '') {
                            echo "<tr><td><b>Specialty:</b></td><td>" . $pro_res['specialty'] . "</td></tr>";
                        }
                        if ($pro_res['phone'] != '') {
                            echo "<tr><td><b>Home Phone:</b></td><td>" . $pro_res['phone'] . "</td></tr>";
                        }
                        if ($pro_res['phonecell'] != '') {
                            echo "<tr><td><b>Mobile:</b></td><td>" . $pro_res['phonecell'] . "</td></tr>";
                        }
                        if ($pro_res['phonew1'] != '') {
                            echo "<tr><td><b>Work Phone:</b></td><td>" . $pro_res['phonew1'] . "</td></tr>";
                        }
                        if ($pro_res['email'] != '') {
                            echo"<tr><td><b>Email:</b></td><td>" . $pro_res['email'] . "</td></tr>";
                        }
                        if ($pro_res['fax'] != '') {
                            echo "<tr><td><b>Fax:</b></td><td>" . $pro_res['fax'] . "</td></tr>";
                        }
                        if ($pro_res['street'] != '') {
                            echo "<tr><td><b>Street:</b></td><td>" . $pro_res['street'] . "</td></tr>";
                        }
                        if ($pro_res['city'] != '') {
                            echo "<tr><td><b>City:</b></td><td>" . $pro_res['city'] . "</td></tr>";
                        }
                        echo "</table>";
                        echo "</td></tr>";
                        echo "</table>";
                    } else if ($who_type == 'facility') {
                        $facility = $rowChartOutputTrans['facility'];
                        ...
                        echo "<table  border='0' style='padding-left:50px;'>";
                        if ($fres['name'] != '') {
                            echo "<tr><td><b>Name:</b></td><td>" . $fres['name'] . "</td></tr>";
                        }
                        if ($fres['phone'] != '') {
                            echo "<tr><td><b>Mobile:</b></td><td>" . $fres['phone'] . "</td></tr>";
                        }
                        if ($fres['email'] != '') {
                            echo "<tr><td><b>Email:</b></td><td>" . $fres['email'] . "</td></tr>";
                        }
                        if ($fres['fax'] != '') {
                            echo "<tr><td><b>Fax:</b></td><td>" . $fres['fax'] . "</td></tr>";
                        }
                        if ($fres['street'] != '') {
                            echo "<tr><td><b>Street:</b></td><td>" . $fres['street'] . "</td></tr>";
                        }
                        if ($fres['city'] != '') {
                            echo "<tr><td><b>City:</b></td><td>" . $fres['city'] . "</td></tr>";
                        }
                        if ($fres['state'] != '') {
                            echo "<tr><td><b>State:</b></td><td>" . $fres['state'] . "</td></tr>";
                        }
                        if ($fres['postal_code'] != '') {
                            echo "<tr><td><b>Postal Code:</b></td><td>" . $fres['postal_code'] . "</td></tr>";
                        }
                        if ($fres['country_code'] != '') {
                            echo"<tr><td><b>Country Code:</b></td><td>" . $fres['country_code'] . "</td></tr>";
                        }
                        echo "</table>";
                        echo "</td></tr>";
                        echo "</table>";
                    } else if ($who_type == 'pharmacy') {
                        $pharmacy = $rowChartOutputTrans['pharmacy'];
                        ...
                        echo "<table  border='0' style='padding-left:50px;'>";
                        if ($phres['name'] != '') {
                            echo"<tr><td><b>Name:</b></td><td>" . $phres['name'] . "</td></tr>";
                        }
                        if ($phres['email'] != '') {
                            echo "<tr><td><b>Email:</b></td><td>" . $phres['email'] . "</td></tr>";
                        }
                        if ($phres['city'] != '') {
                            echo "<tr><td><b>City:</b></td><td>" . $phres['city'] . "</td></tr>";
                        }
                        if ($phres['state'] != '') {
                            echo "<tr><td><b>State:</b></td><td>" . $phres['state'] . "</td></tr>";
                        }
                        if ($phres['zip'] != '') {
                            echo "<tr><td><b>Postal Code:</b></td><td>" . $phres['zip'] . "</td></tr>";
                        }
                        if ($phres['country'] != '') {
                            echo "<tr><td><b>Country Code:</b></td><td>" . $phres['country'] . "</td></tr>";
                        }
                        echo "</table>";
                        echo "</td></tr>";
                        echo "</table>";
                    } else if ($who_type == 'payer') {
                        $payer = $rowChartOutputTrans['payer'];
                        ...
                        echo "<table  border='0' style='padding-left:50px;'>";
                        if ($ires['name'] != '') {
                            echo "<tr><td><b>Name:</b></td><td>" . $ires['name'] . "</td></tr>";
                        }
                        if ($ires['x12_default_partner_id'] != '') {
                            ...
                            echo "<tr><td><b>x12 Default Partner:</b></td><td>" . $xres['name'] . "</td></tr>";
                        }
                        echo "</table>";
                        echo "</td></tr>";
                        echo "</table>";
                    } else if ($who_type != '' && $who_type != '0') {
                        $org = $rowChartOutputTrans['refer_to'];
                        ...
                        if (!empty($type_sql_row))
                            echo "<tr><td><b> Type: </b></td><td> " . $type_sql_row['title'] . "</td></tr>";
                        if (!empty($addressbook_info ['organization']))
                            echo "<tr><td><b>Organization:</b></td><td> " . $addressbook_info ['organization'] . " </td></tr>";

                        if (!empty($addressbook_info ['fname']) || !empty($addressbook_info ['lname']) || !empty($addressbook_info ['mname'])) {
                            echo "<tr><td><b>Name:</b></td><td> " . $addressbook_info ['title'] . " ";

                            if (!empty($addressbook_info ['fname']))
                                echo $addressbook_info ['fname'] . " ";

                            if (!empty($addressbook_info ['mname']))
                                echo $addressbook_info ['mname'] . " ";

                            if (!empty($addressbook_info ['lname']))
                                echo $addressbook_info ['lname'] . " </td></tr>";
                        }

                        if (!empty($addressbook_info ['phone']))
                            echo "<tr><td><b> Home Phone: </b></td><td> " . $addressbook_info ['phone'] . "</td></tr>";

                        if (!empty($addressbook_info ['phonecell']))
                            echo "<tr><td><b>Mobile:</b></td><td> " . $addressbook_info ['phonecell'] . " </td></tr>";

                        if (!empty($addressbook_info ['phonew1']))
                            echo "<tr><td><b> Work Phone: </b></td><td> " . $addressbook_info ['phonew1'] . " </td></tr>";

                        if (!empty($addressbook_info ['email']))
                            echo "<tr><td><b>Email:</b></td><td> " . $addressbook_info ['email'] . " </td></tr>";

                        if (!empty($addressbook_info ['fax']))
                            echo "<tr><td><b>Fax:</b></td><td> " . $addressbook_info ['fax'] . " </td></tr>";

                        if (!empty($addressbook_info ['street']))
                            echo "<tr><td><b>Street:</b></td><td> " . $addressbook_info ['street'] . " </td></tr>";

                        if (!empty($addressbook_info ['city']))
                            echo "<tr><td><b>City:</b></td><td>" . $addressbook_info ['city'] . " </td></tr>";
                        echo "</table>";
                        echo "</td></tr>";
                        echo "<tr></tr>";
                        if (!empty($addressbook_info ['fax'])) {
                            echo "<tr><td><h3> Fax Number </h3> </td></tr><tr><td>";
                            echo "<table  border='0' style='padding-left:50px;'>";
                            echo "<tr><td> " . $addressbook_info ['fax'] . " </td></tr>";
                            echo "</table>";
                            echo "</td></tr>";
                            echo "<tr></tr>";
                        }
            ...
            static_patient_data($group, $result1, $pid, $minValue, $rowChartOutputTrans);
            ksort($result1);
            $j = 1;
            $groupName = $group;
            ...
            while ($eidval = sqlFetchArray($geteid)) {
                ...
                foreach ($result1 as $key => $value) {
                    ...
                    if ($value == 'mobile_hpi' || $value == 'homehealth_hpi' || $value == 'payeraudit_hpi' || $value == 'referral_hpi' || $value == 'appeal_hpi') {
                        if ($rowChartOutputTrans[$value] == "YES") {
                            ...
                            if (substr($setpagebr5['group_name'], 1) == 'History of Present illness') {
                                ...
                                echo " <div id='" . $idName . $j . "'  style='clear:both;'>";
                                echo "<ul class='" . $idName . $j . "' >";
                                display_hpi($eidval['encounter'], $groupName);
                                echo "<ul/></div></div>";
                                $i++;
                            } 
                            echo "</div>";
                    ...
                    if ($value == 'mobile_ccm' || $value == 'homehealth_ccm' || $value == 'payeraudit_ccm' || $value == 'referral_ccm' || $value == 'appeal_ccm') {
                        if ($rowChartOutputTrans[$value] == "YES") {
                            echo "<div id='show_div_ccm" . $eidval['encounter'] . "' style='display:none'>";
                            $setpagebr5 = '';
                            echo "<div style='clear:both;'>";
                            $getpagebr5 = sqlStatement("SELECT DISTINCT(group_name) as group_name,page_break  FROM tbl_chartui_mapping WHERE screen_name = '$groupName' AND group_name LIKE '%CCM'");
                            $setpagebr5 = sqlFetchArray($getpagebr5);
                            if (substr($setpagebr5['group_name'], 1) == 'CCM') {
                                $idName = str_replace(" ", "-", $groupName . "-" . 'CCM');
                                if ($setpagebr5['page_break'] == 'YES' || $i == 1 || $tempvalue == 1) {
                                    display_div_function($display_title, $eidval['encounter']);
                                } else {
                                    echo "<h2> $display_title: </h2>";
                                ...
                                echo " <div id='" . $idName . $j . "'  style='clear:both;'>";
                                echo "<ul class='" . $idName . $j . "' >";
                                display_ccm($eidval['encounter'], $groupName);
                                echo "<ul/></div></div>";
                                $i++;
                            }
                            echo "</div>";
                ...
                if (!empty($eidval['elec_signedby']) && !empty($eidval['elec_signed_on']) && $eidval['elec_signed_on'] != '0000-00-00 00:00:00') {
                    $getSignImg = "SELECT signature_image,  CONCAT(fname,' ', lname) as fname,
            (SELECT provider_credentials FROM tbl_patientuser where userid = '" . $eidval['elec_signedby'] . "' order by id desc limit 0,1 ) as designation
            FROM users
            WHERE id='" . $eidval['elec_signedby'] . "' and username!=''";
                    $resSignImg = sqlStatement($getSignImg);
                    $rowSignImg = sqlFetchArray($resSignImg);
                    $newval = "//".$_SERVER['HTTP_HOST']."/interface/pic/user_sign/" . $rowSignImg['signature_image'];
                    ...
                    $esigned = explode(" ", $eidval['elec_signed_on']);
                    if (!empty($esigned)) {
                        $esign = $esigned[0];
                        if ($esigned[1] != '00:00' && $esigned[1] != '')
                            $esign.= " at " . $esigned[1];
                    }
                    echo "<br/><br/>Electronically Signed by <b>" . ucwords($rowSignImg['fname']) . $desg . "</b> on <b>" . $esign . "</b>.";
       ...
       <footer style='clear:both;' align="right">
        <p><?php
            ...
            echo "Printed on " . $date->format('d-M-Y H:i:s a') . ".";
            ?>
        </p>
        </footer>
    </body>
...
<?php
    ...
    function patientdata_not_related_to_encounters($rowChartOutputTrans, $result1, $minValue, $groupName) {
        $j = 0;
        foreach ($result1 as $key => $value) {
            $display_title = '';
            $get_display_field_label = sqlStatement("SELECT title FROM layout_options WHERE form_id = 'CHARTOUTPUT' AND field_id = '" . $value . "'");
                        ...
                        if ($rowChartOutputTrans[$value] == "YES") {
                            ...
                            if (sqlNumRows($result) == 0) {
                                ...
                                <script>
                                            ...
                                            obj.push({"id":"show_div_immunizations", "value":"none"});    </script> 
                                <?php
                            } else {
    ...
    function static_patient_data($groupName, $result1, $pid, $minValue, $rowChartOutputTrans) {
        ...
        $getcred1 = "SELECT provider_credentials AS pcred FROM tbl_patientuser WHERE userid='$provider' AND provider_credentials!='' order by id desc limit 0,1 ";
        ...
        patientdata_not_related_to_encounters($rowChartOutputTrans, $result_array, $minValue, $groupName);
    }
    ...
    function display_div_function($gname, $encounter) {
        ...
        echo "<br><div class='headerstyle' style='width:980px;height:110px;border:1px solid #000;clear:both;'><table width='980px' height:'110px'><tr><td class='firsttd' align='left' width='70%' height= ><b>$name: $gname</b><br>Patient Record Number:$pid</td><td width='70%'><span><b>$facilityname</b><br><font size='2'>$location<br>$contact</font></b></span></td></tr></table></div><br>";
        if ($encounter != 0) {
            ...
            if (!empty($set_rendering_provider)) {
                $getprovider_credentials = sqlStatement("SELECT provider_credentials FROM tbl_patientuser WHERE userid = " . $set_rendering_provider['id']) ."order by id desc limit 0,1 ";
    ...
    function getListItem($listid, $value) {
        $lrow = sqlQuery("SELECT title FROM list_options " .
                "WHERE list_id = ? AND option_id = ?", array($listid, $value));
...
//global $wpdb;
    ...
    $sql_post = sqlStatement("select refresh_token from drive_users where email='" . $row['notes'] . "' and domain='web'");
    $post_id = sqlFetchArray($sql_post);
    $auth_id = $post_id['refresh_token'];
    $trans = $_REQUEST['coid'];
    ...
    if($prow['patient_file']!=''){
        if (is_numeric(strpos($prow['patient_file_format'], "dos"))) {

        $query = $prow['patient_file'] . " where c.pid=" . $patient_id . " and c.id=" . $trans;
        } else {
            $query = $prow['patient_file'] . " where p.pid=" . $patient_id;
        }

        $fsql = sqlStatement("$query");
        $frow = sqlFetchArray($fsql);
        $folder_name = str_replace(" ", "", $frow['patient_file']);
    }
...
$(document).ready(function(){
        ...
        var page = '<?php echo $folder_name; ?>' + '.html';
        var styleshtml = "";
        // alert(page);
        var drivehtml = $('body').html();
        for (var i = 0; i < 100; i++){
            var startindex = drivehtml.indexOf("<style");
            var endindex = drivehtml.indexOf("</style>");
            var sstartindex = drivehtml.indexOf("<script");
            var sendindex = drivehtml.indexOf("</scrip");
            '<script'
            var cutstring = drivehtml.substring(startindex, endindex + 8);
            var sccutstring = drivehtml.substring(sstartindex, sendindex + 9);
            styleshtml += cutstring;
            if (startindex != - 1 && endindex != - 1)
            drivehtml = drivehtml.replace(cutstring, "");
            if (sstartindex != - 1 && sendindex != - 1)
            drivehtml = drivehtml.replace(sccutstring, "");
                //console.log(cutstring);
        }

        var extrastyles = "";
        $.each(obj, function(index, objval){
            var style = "#" + objval.id + "{ display:" + objval.value + " !important;}"
            extrastyles += style;
        });
    drivehtml = "<html><head>" + "<style>@page { size 8.5in 11in; margin: 1cm; }\n\
        * { font-family: Arial, Helvetica, sans-serif;} table{width:100% !important;} .tdborder {font-size: 15; text-align:left;border:none;border-bottom-style: solid;border-top-style: solid;border-width: 1px;}\n\
    .firsttd{    font-size: 15;}.secondtd{    font-size: 12;}.thirdtd{    font-size: 12;}.byelement{    color: gray;}\n\
    ul{list-style-type: none; padding:0px;    -webkit-padding-start: 0px !important;}li { padding-right:40px; }ul{float:left;}\n\
    .labres tr.head   { font-size:10pt; text-align:center; }.labres tr.detail { font-size:10pt; }\n\
    .labres a, .labres a:visited, .labres a:hover { color:#0000cc; }\n\
    .labres table { border-style: solid; border-width: 1px 0px 0px 1px; border-color: black;}\n\
    .labres td, .labres th { border-style: solid; border-width: 0px 1px 1px 0px; border-color: black;}\n\
    .under { border-style: solid; border-width: 0 0 1px 0; border-color: #999999;}\n\
    .tbl_vitals {border:1px solid #C3E7F5;background-color: #E0E0E0; }\n\
    .tbl_vitals_th{border:0px 1px 1px 0px solid  #C3E7F5;;text-align:center; background-color:  #E0E0E0;}\n\
    .tbl_vitals_td {border:0px 1px 1px 0px solid  ;text-align:center; background:#FFFFFF;}\n\
    .tbl_vitals {border:1px solid #C3E7F5;background-color: #E0E0E0; }\n\
    .tbl_vitals_th{border:0px 1px 1px 0px solid  #C3E7F5;;text-align:center; background-color:  #E0E0E0;}\n\
    .tbl_vitals_td {border:0px 1px 1px 0px solid  ;text-align:center; background:#FFFFFF;}\n\
    .tbl_surgery {border:1px solid #C3E7F5;background-color: #E0E0E0 ; }\n\
    .tbl_surgery_th{border:0px 1px 1px 0px solid  #C3E7F5;;text-align:center; background-color:  #E0E0E0;} \n\
    .tbl_surgery_td {border:0px 1px 1px 0px solid  ;text-align:center; background:#FFFFFF ;}\n\
    .tbl_pre {border:1px solid #C3E7F5;background-color: #E0E0E0; }.tbl_pre_th{border:0px 1px 1px 0px solid  #C3E7F5;text-align:center; background-color:  #E0E0E0;}\n\
    .tbl_pre_td {border:0px 1px 1px 0px solid  ;text-align:center; background:#FFFFFF;} .headerstyle td{font-size:24px !important;}.headerstyle font {font-size: 24px;} .firsttd{width:90% !important;} " + extrastyles + "</style></head>" + drivehtml + "</body></html>"
//var myWindow = window.open("", "MsgWindow", "width=200,height=100");
//myWindow.document.write(drivehtml);

function modalbox(check){
...
if (auth != ''){
    ...
    $.ajax({
        type: 'POST',
        url: "create_html.php",
        data:{data:drivehtml, page_name:page, pid:<?php echo $patient_id; ?>, authorize:true, encounter:'<?php echo $encounter_id; ?>',transid:'<?php echo $trans_form_id; ?>'},
        success: function(response)
        {
            ...
            if (response.indexOf('$') > - 1){
                ...
                if (confirm(res[1]) == true) {
                     $('#loading1').show(); 
                     $.ajax({
                        type: 'POST',
                        url: "create_html.php",
                        data:{data:drivehtml,  page_name:page, pid:<?php echo $patient_id; ?>, authorize:true, encounter:'<?php echo $encounter_id; ?>', modify:1,transid:'<?php echo $trans_form_id; ?>'},
                        success: function(response)
                        {
                            var res = response.split('@');
                           console.log(response);
                             //  prompt("Medical record pdf is saved in Google Drive with Folder ID:",  res[0]);
                            $('body').append("<div class='model-box'><div id='loading' style='display:none; '></div><div id='fancy_close' style='display: block;'></div><div class='drivlink'>Medical record pdf is saved in Google Drive with Folder Link:  <a href=" + res[0] + " target='_blank' >View Patient Folder</a></div><form method='post' id='msg' name='msg' action='wats_creation.php'> <?php if(in_array('move_file',$avail3)) { ?>    <input type='checkbox' name='custom' id='custom' value=''  /><label for='custom'>Do You want to move patient file to custom folder<label><?php } ?><br/> <?php if(in_array('wats',$avail3)) { ?>   <input type='checkbox' name='wats' id='wats' value=''  /><label for='wats'>Do You want to create wats ticket</label><?php } ?><div id='container'></div><input type='hidden' id='fileid' name='fileid' value='" + response + "'/><div class='mybtn'><input type='button' class='myButton' name='ok' id='ok'  value='ok'  style='display:none' disabled /></div></form> </div>");
                            $('#loading1').hide();
                            $('#custom').on('change', function() {
                                if (this.checked){
                                    mywindow = window.open("ggl_drive_folders.php?parent=0&file_id="+res[1].trim()+'&pid=<?php echo $patient_id; ?>'+'&category=patients', "mywindow", "location=1,status=1,scrollbars=1,width=800,height=800" );
                                }
                            });
                        },
                     ...
                     $.ajax({
                        type: 'POST',
                        url: "create_html.php",
                        data:{data:drivehtml,  page_name:page, pid:<?php echo $patient_id; ?>, authorize:true, encounter:'<?php echo $encounter_id; ?>', modify:0,transid:'<?php echo $trans_form_id; ?>'},
                        success: function(response)
                        {
                            var res = response.split('@');
                ...
                $('body').append("<div class='model-box'><div id='loading' style='display:none; '></div><div id='fancy_close' style='display: block;'></div><div class='drivlink'>Medical record pdf is saved in Google Drive with Folder Link:  <a href=" + res[0] + " target='_blank'>View Patient Folder</a></div><form method='post' id='msg' name='msg' action='wats_creation.php'><?php if(in_array('move_file',$avail3)) { ?> <input type='checkbox' name='custom' id='custom' value=''  /><label for='custom'>Do You want to move patient file to custom folder</label><?php } ?><br/> <?php if(in_array('wats',$avail3)) { ?>   <input type='checkbox' name='wats' id='wats' value=''  /><label for='wats'>Do You want to create wats ticket</label><?php } ?> <div id='container'></div><input type='hidden' id='fileid' name='fileid' value='" + response + "'/><div class='mybtn'><input type='button' name='ok' id='ok' class='myButton' value='ok'   style='display:none' disabled /></div></form> </div>");
                $('#loading1').hide();
                $('#custom').on('change', function() {
                    if (this.checked){
                        mywindow = window.open("ggl_drive_folders.php?parent=0&file_id="+res[1].trim()+'&pid=<?php echo $patient_id; ?>'+'&category=patients', "mywindow", "location=1,status=1,scrollbars=1, width=800,height=800");
