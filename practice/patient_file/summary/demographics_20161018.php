...
|
<a href="../summary/patient_insurance_history.php?pid=<?php echo $pid; ?>" class='iframe large_modal' onclick='top.restoreSession()'>
<?php echo htmlspecialchars(xl('Insurance History'),ENT_NOQUOTES); ?></a>
  </td>
 </tr>
</table> <!-- end header -->
