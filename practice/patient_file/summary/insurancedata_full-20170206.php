...
//                             echo "<pre>"; print_r($set_image); echo "</pre>";
                             echo '<a class="card" href="#" style="font-size:12px;">Card Front Image</a>
                              ...
                              if($set_image['frontimage'] == '')
                               ...
                               echo '  </div>';
//                               echo '| <a class="uploadfront" href="#" style="font-size:12px; ">Card Upload Card Front Image</a>
...
//                               echo '  </div>';
                                    echo '<br/>';
                             echo '<a class="card" href="#" style="font-size:12px;">Back Image</a>
