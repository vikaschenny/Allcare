          ...
          $.fn.liveserarch = function(){
             ...
             function fiterdata(sourse,key,practicecontenar, centeralcontenar){
                 ...
                 $.each(central,function(index,value){
                     ...
                     centeralhtml += "<li data-pid='"+value['id']+"'><div class='listval'>"+value['name']+"</div><span style='font-size:9px;color:red;'>"+notEnrolled+"</span></li>";
                 });
                   ...
                   $("#planbox footer").hide();
                    ...
                    $("#frontcard").uploadFile({
                        ...
                        customProgressBar: function(obj,s){
                            ...
                            //console.log(obj);
                            obj.prepend("<div class='ajax-file-upload-statusbar'><img src='"+placeholder+"' alt='Insturance Card Front Side' width='350px'/></div>");
                    ...
                    $("#dm").uploadFile({
                        ...
                        customProgressBar: function(obj,s){
                            ...
                            //console.log(obj);
                                obj.prepend("<div class='ajax-file-upload-statusbar'><img src='"+placeholder+"' alt='Insturance Card Back Side' width='350px'/></div>");
...
//               });
          ...
          $('.insurancecard').eq(0).showinscard({imageuplodurl:""});
