...
foreach ($ISSUE_TYPES as $key => $arr) {
	...
	if ($_POST['embeddedScreen']) {
		...
		$widgetButtonLink = "load_location(\"${GLOBALS['webroot']}/practice/eRx.php?page=medentry\")";
	    }
	    else
	    {
		$widgetButtonLabel = xl("Edit");
		$widgetButtonLink = "load_location(\"${GLOBALS['webroot']}/practice/patient_file/summary/stats_full.php?active=all&category=" . $key . "\")";
	    }
	    $widgetButtonClass = "";
...
<?php if ($_POST['embeddedScreen']) {
    ...
    $widgetButtonLabel = xl("Edit");
    $widgetButtonLink = "javascript:load_location(\"${GLOBALS['webroot']}/practice/patient_file/summary/immunizations.php\")";
    $widgetButtonClass = "";
    $linkMethod = "javascript";
    $bodyClass = "summary_item small";
    $widgetAuth = true;
...
<?php if ($_POST['embeddedScreen']) {
	...
	$widgetButtonLink = $GLOBALS['webroot'] . "/practice/eRx.php?page=compose";
	$widgetButtonClass = "";
    }
    else
    {
	...
	$widgetButtonLabel = xl("Edit");
	$widgetButtonLink = $GLOBALS['webroot'] . "/practice/patient_file/summary/rx_frameset.php";
...
if($erx_upload_complete == 1){
    ...
    $widgetButtonLabel = xl("Edit");
    $widgetButtonLink = "load_location(\"${GLOBALS['webroot']}/practice/patient_file/summary/stats_full.php?active=all&category=medication\")";
    $widgetButtonClass = "";
    $linkMethod = "javascript";
    $bodyClass = "summary_item small";
    $widgetAuth = true;
