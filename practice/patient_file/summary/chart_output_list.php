	...
	foreach($title as $label)
        ...
        if ($result = getChartOutputByPid($pid, $group_name)) {
            foreach ($result as $iter) {
                        ...
                        if($transaction==2) {
                            ...
                            "&patient_id=$pid&date_of_service=".$iter['date_of_service']."' class='css_button_small'><span>".
                                                htmlspecialchars( xl('Print'), ENT_NOQUOTES)."</span></a>";
                        }else {    
                            $tr_name='med';
                            echo "<a href='print_chart_static.php?coid=".$iter['id']."".            
                                "&patient_id=$pid"."&group=$group_name1&encounter_id=". $renc['encounter']."' class='css_button_small'><span>".
                                 htmlspecialchars( xl('Print'), ENT_NOQUOTES)."</span></a>";
                        }
                        echo "</td><td style='width:60px;'>";
                        print "<a href='chart_output.php?coid=".htmlspecialchars( $iter{"id"}, ENT_NOQUOTES).
                                "&inmode=edit&group_name2=$group_name2&group_name=$group_name1&type=$trans_type2' class='css_button_small'><span>".
                        ...
                        if (acl_check('admin', 'super')) {
                                echo "<a href='../deleter.php?coid=".
                                        ...
                                        "&patient_id=$pid' class='css_button_small'><span>".
		...
		echo "<td style='width:60px;'>"; 
                ...
                echo "<a href='template_forms/".$row1['notes']."?coid=".$iter1['id']."".            
                        "&patient_id=$pid&group=".$group_name1."&temp_id=".$iter1['form_template']."&print=1"."' class='css_button_small'><span>".
                         htmlspecialchars( xl('Print'), ENT_NOQUOTES)."</span></a>";
                echo "</td><td style='width:60px;'>";
		print "<a href='chart_output.php?coid=".htmlspecialchars( $iter1{"id"}, ENT_NOQUOTES).
			"&inmode=edit&group_name2=$group_name2&group_name=$group_name1&type=$trans_type1' class='css_button_small'><span>".
			htmlspecialchars( xl('Edit'), ENT_NOQUOTES)."</span></a>";
		echo "</td><td>";
                /*
                if (acl_check('admin', 'super')) {
			echo "<a href='../deleter.php?coid=".
				...
				"&patient_id=$pid&nonenc=1' class='css_button_small'><span>".
				htmlspecialchars( xl('Delete'), ENT_NOQUOTES)."</span></a>";
		}
		else {
			echo "&nbsp;";
               ...
               // echo "<pre>"; print_r($result); echo "</pre>";
                 foreach ($result as $iter) {
                    ...
                    if($transaction==2) {
                        ...
                        $tr_name='med';
                         echo "<a href='print_chart_static.php?coid=".$iter['id']."".            
                        "&patient_id=$pid"."&group=$group&encounter_id=". $renc['encounter']."' class='css_button_small'><span>".
                         htmlspecialchars( xl('Print'), ENT_NOQUOTES)."</span></a>";
                    }
                    echo "</td><td style='width:60px;'>";
                    print "<a href='chart_output.php?coid=".htmlspecialchars( $iter{"id"}, ENT_NOQUOTES).
                            "&inmode=edit&group_name2=$group2&group_name=$group&type=$trans_type2' class='css_button_small'><span>".
                            htmlspecialchars( xl('Edit'), ENT_NOQUOTES)."</span></a>";
                    echo "</td><td>";
                    /*
                    if (acl_check('admin', 'super')) {
        ...
        while ($frow2 = sqlFetchArray($fres2)) {
         ...
         if ($result1 = getNonEncChartByPid($pid, $group4)) {
                ...
                foreach ($result1 as $iter1) {
                        ...
                        $row1=sqlFetchArray($sql1);
                        echo "<a href='template_forms/".$row1['notes']."?coid=".$iter1['id']."".            
                                "&patient_id=$pid&group=".$group3."&temp_id=".$iter1['form_template']."&print=1"."' class='css_button_small'><span>".
                                 htmlspecialchars( xl('Print'), ENT_NOQUOTES)."</span></a>";
                        echo "</td><td style='width:60px;'>";
                        print "<a href='chart_output.php?coid=".htmlspecialchars( $iter1{"id"}, ENT_NOQUOTES).
                                "&inmode=edit&group_name2=$group4&group_name=$group3&type=$trans_type1' class='css_button_small'><span>".
                                htmlspecialchars( xl('Edit'), ENT_NOQUOTES)."</span></a>";
                        echo "</td><td>";
                        /*
                        if (acl_check('admin', 'super')) {
