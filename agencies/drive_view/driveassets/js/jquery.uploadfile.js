...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var uploadLabel = $('<div><div class="fileupload-buttonbar-text">Upload documents on your local device</div>' + s.uploadStr + '</div>');
        ...
        (function checkAjaxFormLoaded() {
            if($.fn.ajaxForm) {
                ...
                if(s.dragDrop) {
                    ...
                    $(obj).append($(s.dragDropStr));
                    $(uploadLabel).insertAfter($(obj));
                    setDragDropHandlers(obj, s, dragDrop);
                    $(s.wrapdivdrage).wrap($(obj));
                } else {
                    $(obj).append(uploadLabel);
                }
	   ...
	   this.startUpload = function () {
        ...
        function serializeAndUploadFiles(s, obj, files) {
            for(var i = 0; i < files.length; i++) {
				...
				pd.filename.html("<div class='filename'>"+fileNameStr+"</div><div class='status'>Uploading to Google Drive</div><div class='filesize'>"+getSizeStr(files[i].size)+"</div>");
        ...
        function createCustomInputFile (obj, group, s, uploadLabel) {
            ...
            $(fileInput).wrap("<span class='btn btn-primary fileinput-button'>Add files...</span>")
            $(form).find('.fileinput-button').prepend("<i class='glyphicon glyphicon-plus'></i>");
