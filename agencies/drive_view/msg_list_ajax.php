...
include_once("objects_function.php");
...
//    }
    ...
    $psql=sqlStatement("select DISTINCT(pid),p.* from patient_data p inner join tbl_patientagency a on p.pid=a.patientid where agencyid=".$_POST['agency_id']." order by lname ,fname" );
...
//                    }
            ...
            //priority
            $myrow['priority']=message_priority($myrow['priority']);
            ...
            //status
            $myrow['Status']=message_status($myrow['Status']);
