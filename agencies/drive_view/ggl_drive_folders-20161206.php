...
<!--        <link rel="stylesheet" type="text/css" href="driveassets/css/main.css"/>-->
            ...
            $(function(){
               ...
               // add out custome thumbnailLinks on files*/
                ...
                $('#myModal').on("show.bs.modal",function(event){
                    var modal = $(this);
                    modal.find(".modal-body").html('<iframe id="logdata" src="http://qa2allcare.texashousecalls.com/agencies/drive_view/logdetails.php?email=<?php echo $row['notes']; ?>&user=<?php echo $agency_name; ?>" style="border:0; width:100%; min-height:380px;"></iframe>')
                });
                getoptdata();
                function getoptdata(){
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer" style="padding:5px 15px;">
                                     <button type="button" class="btn btn-primary btn-sm" id="savebtn" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Sending Message">Send&upload</button>
                                </div>
                            </div> <!--/.modal-content -->
                        </div> <!--/.modal-dialog -->
                    </div> <!--/.modal -->
