        ...
        <script type='text/javascript'>
            ...
            $(function(){
                    $('#sidebar').append(function(){
                        var html = "";
                        var menuitems = JSON.parse('<?php echo json_encode($category_arr1) ?>');
                            ...
                            if(rootfoulder != folderinfodata['id']){
                                ...
                                ajaxcall(getparentdataurl,null,"get",function(parentdata){
                                    ajaxcall(getfolders,null,"get",function(foldersdata){
                                        ajaxcall(gerfilesurl+"",null,"get",function(filesdata){getfiles(filesdata,'[]');},ajaxdefaulterrorcallback);
