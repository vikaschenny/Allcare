...
$GLOBALS_METADATA = array(
  ...
  'Notifications' => array(
	...
	'email_notification1_hours' => array(
      xl('Email Notification1 Hours'),
      'num',                           // data type
      '',                               // default
      xl('Enter Email Notification1 Hours')
    ),
	
	'email_notification2_hours' => array(
      xl('Email Notification2 Hours'),
      'num',                           // data type
      '',                               // default
      xl('Enter Email Notification2 Hours')
    ),
	
	'email_notification3_hours' => array(
      xl('Email Notification3 Hours'),
      'num',                           // data type
      '',                               // default
      xl('Enter Email Notification3 Hours')
    ),
	
	'sms_notification1_hours' => array(
      xl('SMS Notification1 Hours'),
      'num',                           // data type
      '',                               // default
      xl('Enter SMS Notification1 Hours')
    ),
	
	'sms_notification2_hours' => array(
      xl('SMS Notification2 Hours'),
      'num',                           // data type
      '',                               // default
      xl('Enter SMS Notification2 Hours')
    ),
	
	'sms_notification3_hours' => array(
      xl('SMS Notification3 Hours'),
      'num',                           // data type
      '',                               // default
      xl('Enter SMS Notification3 Hours')
    ),
	...
	'twilio_auth_token' => array(
      ...
      'text',                           // data type
      '',                               // default
      xl('Enter Twilio Auth Token')
    ),
	
	'twilio_from_name' => array(
      xl('Twilio From Name'),
      'text',                           // data type
      '',                               // default
      xl('Enter Twilio From Name')
    ),
  ),
  ...
  'Schedulling' => array(        
        ...
        'GlobalSchedulling' => array(
      xl(''),
      'global_schedulling',                          // data type
      '',
      xl('GlobalSchedulling')
    ),
              
        ), 
    'Insurance' => array(        
       
        'GlobalInsurance' => array(
      xl(''),
      'global_insurance',                          // data type
      '',
      xl('GlobalInsurance')
    ),
    ...
    'Pharmacy' => array(
        ...
        'GlobalPharmacy' => array(
      xl(''),
      'global_pharmacy',                          // data type
      '',
      xl('GlobalPharmacy') 
    ),
    ...
    'User Attributes' => array(  
        'GlobalProvider' => array(
      xl(''),
      'global_provider',                          // data type
      '',
      xl('GlobalProvider')
    ),
    ...
    'Forms Configuration' => array(        
        ...
        'GlobalFormsConfiguration' => array(
      xl(''),
      'global_forms_configuration',                          // data type
      '',
      xl('GlobalFormsConfiguration')
    ),
