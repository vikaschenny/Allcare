...
echo "<br><b>Patient Attribute Name :".$existingPOSSRes['title']."</b>";
		  echo "<br><br>";
...
echo "<table border=0  class='label'><tr><td width=25% align=left class='fontbold'>Patient's Attribute Type :</td>";
  echo "<td align='left'>";  
