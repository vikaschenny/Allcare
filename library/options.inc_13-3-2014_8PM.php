...
?>
<!-- 
<link rel="stylesheet" type="text/css" href="../../super/DataTables-1.9.4/media/css/demo_page.css" media="screen" />
<link rel="stylesheet" type="text/css" href="../../super/DataTables-1.9.4/media/css/demo_table_jui.css" media="screen" />
<link rel="stylesheet" type="text/css" href="../../super/DataTables-1.9.4/extras/TableTools/media/css/TableTools.css" media="screen" />
<link rel="stylesheet" type="text/css" href="../../super/DataTables-1.9.4/examples/examples_support/themes/smoothness/jquery-ui-1.8.4.custom.css" media="screen" />


<script type="text/javascript" language="javascript" src="../../super/DataTables-1.9.4/media/js/jquery.js"></script>
<script type="text/javascript" language="javascript" src="../../super/DataTables-1.9.4/media/js/jquery.dataTables.js"></script>
<script type="text/javascript" language="javascript" src="../../super/DataTables-1.9.4/examples/examples_support/jquery-ui-tabs.js"></script>
<script type="text/javascript" language="javascript" src="../../super/DataTables-1.9.4/examples/examples_support/jquery.jeditable.js"></script>
...
INNER JOIN tbl_pos_types pt ON pt.id = p2.pos_id
 and p2.pid=".$GLOBALS['pid']." group by p2.pos_id order by p2.pos_id desc limit 0,1 ";
...
$existingPOSSQry =  sqlStatement($existingPOSSsql);
 ...
 if($existingPOSSRows>0)
 {
     ...
     $existingPOSSQry1 =  sqlStatement($existingPOSSsql);
     
      while ($existingPOSSRes = sqlFetchArray($existingPOSSQry)) 
         {
          echo "<b>".$existingPOSSRes['title']."</b>";
          echo "<br>";
     echo '<div id="tabs" style="font-size: 10pt;background:lightgrey;"><ul>';
	...
	echo '</tr></thead><tbody>';
		...
		$RecordsetFieldNames = substr($RecordsetFieldNames,0,strlen($RecordsetFieldNames)-1);
          ...
          /*   $RecSql = "select $RecordsetFieldNames from  tbl_allcare_patients1ton 
            where pos_id=".$existingPOSSRes['pos_id']." and pid=".$GLOBALS['pid']." and Recordset_ID=".$POS1to1Rec['Recordset_ID'];
                  */  
            ...
            where pos_id=".$existingPOSSRes['pos_id']." and pid=".$GLOBALS['pid']." and Recordset_ID=".$value."";
             ...
             //    print_r($rowRecSql);
                 ...
                 {                 
                    echo "<td class='editable_class' id='".$RecordsetFieldNamesArray[$field_number]."'>".$rowRecSql[$RecordsetFieldNamesArray[$field_number]]."</td>";
                    $field_number++;
                 }
                 echo "</tr>";
             }                    
